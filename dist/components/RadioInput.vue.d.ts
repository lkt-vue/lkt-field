...
import { RadioInputProps } from '../config/RadioInputProps.d.ts';
import { DefineComponent, ComponentOptionsMixin, PublicProps, ComponentProvideOptions } from 'vue';
declare const _default: DefineComponent<RadioInputProps, {
    doClear: () => void;
...
}, string, PublicProps, Readonly<RadioInputProps> & Readonly<{
