...
import { ToggleButtonGroupInputProps } from '../config/ToggleButtonGroupInputProps.d.ts';
import { DefineComponent, ComponentOptionsMixin, PublicProps, ComponentProvideOptions } from 'vue';
declare const _default: DefineComponent<ToggleButtonGroupInputProps, {
    doClear: () => void;
...
}, string, PublicProps, Readonly<ToggleButtonGroupInputProps> & Readonly<{
