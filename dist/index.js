import { defineComponent as xe, computed as J, resolveComponent as he, createBlock as Y, openBlock as F, mergeProps as ae, normalizeClass as ct, ref as K, watch as ie, unref as V, withCtx as ye, createCommentVNode as oe, createElementVNode as we, createVNode as de, createElementBlock as ue, Fragment as He, renderList as vt, toDisplayString as xt, normalizeStyle as kl, withDirectives as De, vModelCheckbox as To, onMounted as ot, normalizeProps as Me, resolveDynamicComponent as dt, withModifiers as Eo, nextTick as Ee, vModelText as St, markRaw as Vt, vShow as tt, createTextVNode as il, useSlots as sl, renderSlot as it, guardReactiveProps as ni, createSlots as It, mergeDefaults as Lo, isRef as We, vModelDynamic as xl } from "vue";
import { stripTags as ll, fill as Bo, lpad as At, generateRandomString as zo, formatNumber as Sl, trim as No, isEmail as Ro } from "lkt-string-tools";
import { httpCall as rl } from "lkt-http-client";
import { getCurrentLanguage as Ao, getAvailableLanguages as Io, __ as Cn, currentLanguage as Vo } from "lkt-i18n";
import { ButtonType as je, TooltipLocationY as Mt, TooltipLocationX as Ot, FieldType as G, LktColor as _n, FieldValidation as Se, ValidationStatus as _e, FieldReportLevel as Ze, extractPropValue as qe, LktSettings as mt, AnchorType as wn, TagType as Do, MultipleOptionsDisplay as gt, TableType as bt, TooltipType as Tl, fieldTypesWithOptions as Mo, booleanFieldTypes as pt, CalendarController as Oo, fieldsWithMultipleMode as Ho, FieldValidationType as ui, extractI18nValue as li, fieldTypesWithoutUndo as Fo, fieldTypesWithoutClear as Uo, ValidationCode as ut, textFieldTypes as Po, FieldAutoValidationTrigger as Qi, FieldReportType as El, getDefaultValues as Wo, Field as $o, ToastPositionX as Ll, FileEntityType as Ye, AccordionType as el, AccordionToggleMode as qo, TablePermission as ci, ItemCrudMode as Bl, ItemCrudView as Zo, FileEntity as zl, IconPosition as jo, MenuEntryType as Go } from "lkt-vue-kernel";
import { Field as Sc, Option as Tc } from "lkt-vue-kernel";
import { date as kn } from "lkt-date-tools";
import { DataState as lt } from "lkt-data-state";
import { openToast as Nl } from "lkt-toast";
import { closeModal as Ko, addModal as Yo } from "lkt-modal";
const ke = class ke {
};
ke.defaultEmptyValueSlot = "", ke.customValueSlots = {}, ke.customEditSlots = {}, ke.searchKeyForResource = "query", ke.optionSlots = {}, ke.defaultDateIcon = "lkt-icn-calendar-empty-outline", ke.defaultNumberFeaturedButton = "subtract", ke.undoText = "", ke.clearText = "", ke.i18nText = "", ke.switchEditionOnText = "", ke.switchEditionOffText = "", ke.showPasswordOnText = "", ke.showPasswordOffText = "", ke.dateReadFormat = "", ke.dateTimeReadFormat = "", ke.defaultDateReadFormat = "Y-m-d", ke.defaultDateTimeReadFormat = "Y-m-d H:i", ke.langDateReadFormat = {
  en: "Y-m-d",
  es: "d/m/Y"
}, ke.langDateTimeReadFormat = {
  en: "Y-m-d H:i",
  es: "d/m/Y H:i"
}, ke.acceptTypes = {
  file: "*/*",
  image: "image/*"
}, ke.validationIconOk = "", ke.validationIconKo = "", ke.validationIconInfo = "", ke.validationIconSlot = "", ke.validationMessages = {
  default: {
    "ok-http-response": "",
    "ko-http-response": "",
    "ko-num-between": "",
...
const xn = /* @__PURE__ */ xe({
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = J(() => ee.undoText), s = J(() => n.insideEllipsis ? "lkt-field--btn-undo lkt-field--info-split-btn" : "lkt-field--btn-undo lkt-field--info-btn"), u = () => l("click");
    return (f, o) => {
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = J(() => ee.clearText), s = J(() => n.insideEllipsis ? "lkt-field--info-split-btn" : "lkt-field--info-btn"), u = () => l("click");
    return (f, o) => {
      const b = he("lkt-button");
      return F(), Y(b, {
        text: e.insideEllipsis ? i.value : "",
  ...
  setup(e, { emit: t }) {
    ...
    ie(() => n.modelValue, (b) => i.value = b), ie(i, (b) => l("update:modelValue", b));
    const s = J(() => i.value ? ee.showPasswordOnText : ee.showPasswordOffText), u = J(() => i.value === !0 ? "lkt-icn-see" : "lkt-icn-not-see"), f = J(() => n.isFeatured ? "lkt-field--atn-btn" : n.insideEllipsis ? "lkt-field--info-split-btn" : "lkt-field--info-btn"), o = () => l("click");
    return (b, c) => {
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(n.modelValue);
    ie(() => n.modelValue, (b) => i.value = b), ie(i, (b) => l("update:modelValue", b));
    const s = J(() => i.value ? ee.switchEditionOnText : ee.switchEditionOffText), u = J(() => i.value === !0 ? "lkt-icon-see" : "lkt-icn-edit"), f = J(() => n.insideEllipsis ? "lkt-field--info-split-btn" : "lkt-field--info-btn"), o = () => l("click");
    return (b, c) => {
      const g = he("lkt-button");
      return F(), Y(g, {
        text: e.insideEllipsis ? s.value : "",
  ...
  setup(e, { emit: t }) {
    ...
    const s = K(n.showEditionCheck);
    return ie(() => n.showEditionCheck, (u) => s.value = u), ie(s, (u) => l("update:showEditionCheck", u)), (u, f) => {
...
}), Jo = { class: "lkt-grid-1" }, Rl = /* @__PURE__ */ xe({
  __name: "I18nButton",
  props: {
    type: {},
    insideEllipsis: { type: Boolean, default: !1 },
  ...
  setup(e, { emit: t }) {
    const l = e, n = Ao(), i = Io(), s = J(() => ee.i18nText), u = J(() => l.isFeatured ? "lkt-field--atn-btn" : l.insideEllipsis ? "lkt-field--info-split-btn" : "lkt-field--info-btn");
    return (f, o) => {
      const b = he("lkt-button");
      return V(i).length > 1 ? (F(), Y(b, ae({ key: 0 }, {
        type: V(je).Tooltip,
        text: e.insideEllipsis ? s.value : "",
        class: u.value,
        ...
        tooltip: {
          ...
          referrer: e.referrer,
          referrerMargin: 0,
          locationX: V(Ot).LeftCorner,
          locationY: V(Mt).Bottom
        }
      }, { title: s.value }), {
        tooltip: ye(() => [
          we("div", Jo, [
            de(Dt, ae({
              modelValue: e.translations[V(n)],
              "onUpdate:modelValue": o[0] || (o[0] = (c) => e.translations[V(n)] = c)
            }, {
              type: e.type,
            ...
            (F(!0), ue(He, null, vt(V(i), (c) => (F(), ue(He, { key: c }, [
              c !== V(n) ? (F(), Y(Dt, ae({
                key: 0,
...
}), Qo = (e, t, l) => (e = Number(e), t !== !1 && e < t && (e = t), l !== !1 && e > l && (e = l), e), En = (e) => !(Object.prototype.toString.call(e) === "[object Date]" && isNaN(e)), Ln = (e, t) => typeof e > "u" ? "" : (typeof e == "string" && (e = new Date(e)), En(e) ? kn(t, e) : ""), ea = /* @__PURE__ */ xe({
  __name: "DropdownButton",
  emits: [
    "click"
  ],
  setup(e, { emit: t }) {
    const l = t, n = J(() => ee.undoText), i = J(() => "lkt-field--info-btn"), s = () => l("click");
    return (u, f) => {
      const o = he("lkt-button");
      return F(), Y(o, {
        text: n.value,
...
}), ta = { class: "lkt-field-color--tooltip--rgba-container" }, ia = { class: "lkt-field-color--tooltip--numeric-input-container" }, la = { class: "like-lkt-field-label" }, di = /* @__PURE__ */ xe({
  __name: "RgbaRange",
  props: {
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(n.modelValue);
    return ie(() => n.modelValue, (s) => i.value = s), ie(i, (s) => l("update:modelValue", s)), (s, u) => (F(), ue("div", ta, [
      we("div", ia, [
        we("label", la, xt(e.label), 1),
        de(Dt, ae({
          modelValue: i.value,
...
}), na = (e, t, l, n) => new _n({ r: e, g: t, b: l, a: n }).toString(), Al = (e) => _n.fromHexColor(e), oa = (e) => e.getContrastFontColor(), aa = { class: "lkt-grid-1" }, sa = { class: "lkt-field-color--tooltip--rgba-container" }, ra = { class: "lkt-field-color--tooltip--hex-input-container" }, Bn = /* @__PURE__ */ xe({
  __name: "ColorInput",
  props: {
    modelValue: { default: "" }
  },
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = (L) => {
      ...
      i(g.value), l("change");
    }, f = K(255), o = K(255), b = K(255), c = K(255), g = K(n.modelValue);
    i(g.value), ie([f, o, b, c], s), ie(() => n.modelValue, (L) => g.value = L), ie(g, (L) => l("update:modelValue", L));
    const k = J(() => oa(Al(g.value))), S = J(() => g.value === "" || g.value === "#" ? {} : {
      background: g.value,
      "--lkt-btn-bg": g.value,
      color: k.value,
      ...
      return F(), Y(r, {
        ...
        tooltip: ye(({ doClose: d }) => [
          we("div", aa, [
            we("div", sa, [
              we("div", ra, [
                a[5] || (a[5] = we("label", { class: "like-lkt-field-label" }, "HEX", -1)),
                de(Dt, {
                  modelValue: g.value,
  ...
  setup(e) {
    const t = e, l = K(t.modelValue), n = J(() => typeof t.max == "boolean" || l.value.length < t.max ? ["inline-create"] : []);
    return (i, s) => {
      ...
      return F(), Y(u, {
        ...
        item: ye(({ item: f, index: o, isLoading: b, canCreate: c, canRead: g, canUpdate: k, canDrop: S, doDrop: x }) => [
          de(Bn, {
  ...
  if (typeof n < "u") {
    let s = parseInt(n);
    l.replace(/\D+/g, "").length < s ? e.push(Se.createMinNumbers(s, _e.Ko)) : t === Ze.All && e.push(Se.createMinNumbers(s, _e.Ok));
  }
  if (typeof i < "u") {
    let s = parseInt(i);
    l.replace(/\D+/g, "").length > s ? e.push(Se.createMaxNumbers(s, _e.Ko)) : t === Ze.All && e.push(Se.createMinNumbers(s, _e.Ok));
  }
}, da = (e, t, l, n, i) => {
  if (typeof n < "u") {
    let s = parseInt(n);
    l.replace(/[^A-Z]+/g, "").length < s ? e.push(Se.createMinUpperChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMinUpperChars(s, _e.Ok));
  }
  if (typeof i < "u") {
    let s = parseInt(i);
    l.replace(/[^A-Z]+/g, "").length > s ? e.push(Se.createMaxUpperChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMaxUpperChars(s, _e.Ok));
  }
}, fa = (e, t, l, n, i) => {
  if (typeof n < "u") {
    let s = parseInt(n);
    l.replace(/[A-Z]+/g, "").length < s ? e.push(Se.createMinLowerChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMinLowerChars(s, _e.Ok));
  }
  if (typeof i < "u") {
    let s = parseInt(i);
    l.replace(/[A-Z]+/g, "").length > s ? e.push(Se.createMaxLowerChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMaxLowerChars(s, _e.Ok));
  }
}, ha = (e, t, l, n, i) => {
  if (typeof n < "u") {
    let s = parseInt(n);
    l.replace(/\d+/g, "").length < s ? e.push(Se.createMinChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMinChars(s, _e.Ok));
  }
  if (typeof i < "u") {
    let s = parseInt(i);
    l.replace(/\d+/g, "").length > s ? e.push(Se.createMaxChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMaxChars(s, _e.Ok));
  }
}, pa = (e, t, l, n, i) => {
  if (typeof n < "u") {
    let s = parseInt(n);
    l.replace(/\d+/g, "").replace(/[a-zA-Z]+/g, "").length < s ? e.push(Se.createMinSpecialChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMinSpecialChars(s, _e.Ok));
  }
  if (typeof i < "u") {
    let s = parseInt(i);
    l.replace(/\d+/g, "").replace(/[a-zA-Z]+/g, "").length > s ? e.push(Se.createMaxSpecialChars(s, _e.Ko)) : t === Ze.All && e.push(Se.createMaxSpecialChars(s, _e.Ok));
  }
}, Il = (e, t = "default") => {
  if (!e) return "";
  let l = ee.validationMessages[t] && ee.validationMessages[t][e] ? ee.validationMessages[t][e] : "";
  return l || (l = ""), l;
}, ma = { class: "boolean-input" }, ga = ["innerHTML"], va = ["name", "id", "disabled", "readonly", "value", "checked"], ba = /* @__PURE__ */ xe({
  __name: "BooleanInput",
  props: {
    modelValue: { type: Boolean, default: !1 },
    name: {},
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(null), s = K(n.modelValue), u = K(s.value ? "true" : "false"), f = K(n.focusing), o = (c) => {
      f.value = !0, l("focus", c);
    }, b = (c) => {
      f.value = !1, l("blur", c);
    };
    return ie(() => n.modelValue, (c) => s.value = c), ie(s, (c) => l("update:modelValue", c)), (c, g) => (F(), ue("div", ma, [
      g[1] || (g[1] = we("div", { class: "boolean-input-label" }, [
        we("div", { class: "boolean-input--check-on" })
      ], -1)),
      e.label ? (F(), ue("div", {
        key: 0,
...
var fi = { exports: {} }, ya = fi.exports, Vl;
function Ca() {
...
var _a = /* @__PURE__ */ Ca();
const zn = /* @__PURE__ */ Le(_a);
var hi = { exports: {} }, wa = hi.exports, Dl;
function ka() {
...
var xa = /* @__PURE__ */ ka();
const Nn = /* @__PURE__ */ Le(xa);
var pi = { exports: {} }, Sa = pi.exports, Ml;
function Ta() {
...
var Ea = /* @__PURE__ */ Ta();
const Rn = /* @__PURE__ */ Le(Ea);
var mi = { exports: {} }, La = mi.exports, Ol;
function Ba() {
  return Ol || (Ol = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : La, function(t, l) {
      const n = {
        code: "de",
        toolbar: {
          default: "Standard",
...
var za = /* @__PURE__ */ Ba();
const An = /* @__PURE__ */ Le(za);
var gi = { exports: {} }, Na = gi.exports, Hl;
function Ra() {
...
var Aa = /* @__PURE__ */ Ra();
const Wi = /* @__PURE__ */ Le(Aa);
var vi = { exports: {} }, Ia = vi.exports, Fl;
function Va() {
...
var Ha = /* @__PURE__ */ Oa();
const Vn = /* @__PURE__ */ Le(Ha);
var yi = { exports: {} }, Fa = yi.exports, Pl;
function Ua() {
  return Pl || (Pl = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : Fa, function(t, l) {
      const n = {
        code: "fr",
        toolbar: {
          default: "Défaut",
...
var Pa = /* @__PURE__ */ Ua();
const Dn = /* @__PURE__ */ Le(Pa);
var Ci = { exports: {} }, Wa = Ci.exports, Wl;
function $a() {
...
var qa = /* @__PURE__ */ $a();
const Mn = /* @__PURE__ */ Le(qa);
var _i = { exports: {} }, Za = _i.exports, $l;
function ja() {
  return $l || ($l = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : Za, function(t, l) {
      const n = {
        code: "hu",
        toolbar: {
...
var Ga = /* @__PURE__ */ ja();
const On = /* @__PURE__ */ Le(Ga);
var wi = { exports: {} }, Ka = wi.exports, ql;
function Ya() {
...
var Xa = /* @__PURE__ */ Ya();
const Hn = /* @__PURE__ */ Le(Xa);
var ki = { exports: {} }, Ja = ki.exports, Zl;
function Qa() {
...
var es = /* @__PURE__ */ Qa();
const Fn = /* @__PURE__ */ Le(es);
var xi = { exports: {} }, ts = xi.exports, jl;
function is() {
...
var ls = /* @__PURE__ */ is();
const Un = /* @__PURE__ */ Le(ls);
var Si = { exports: {} }, ns = Si.exports, Gl;
function os() {
  return Gl || (Gl = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : ns, function(t, l) {
      const n = {
        code: "km",
        toolbar: {
          default: "លំនាំដើម",
...
var as = /* @__PURE__ */ os();
const Pn = /* @__PURE__ */ Le(as);
var Ti = { exports: {} }, ss = Ti.exports, Kl;
function rs() {
  return Kl || (Kl = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : ss, function(t, l) {
      const n = {
        code: "lv",
        toolbar: {
          default: "Noklusējuma",
...
var us = /* @__PURE__ */ rs();
const Wn = /* @__PURE__ */ Le(us);
var Ei = { exports: {} }, cs = Ei.exports, Yl;
function ds() {
...
var fs = /* @__PURE__ */ ds();
const $n = /* @__PURE__ */ Le(fs);
var Li = { exports: {} }, hs = Li.exports, Xl;
function ps() {
...
var ms = /* @__PURE__ */ ps();
const qn = /* @__PURE__ */ Le(ms);
var Bi = { exports: {} }, gs = Bi.exports, Jl;
function vs() {
  return Jl || (Jl = 1, (function(e) {
    (function(t, l) {
      e.exports = t.document ? l(t, !0) : function(n) {
    ...
    })(typeof window < "u" ? window : gs, function(t, l) {
      const n = {
        code: "pt_br",
        toolbar: {
          default: "Padrão",
...
var bs = /* @__PURE__ */ vs();
const Zn = /* @__PURE__ */ Le(bs);
var zi = { exports: {} }, ys = zi.exports, Ql;
function Cs() {
  return Ql || (Ql = 1, (function(e) {
    (function(t, l) {
      e.exports = t.document ? l(t, !0) : function(n) {
...
var _s = /* @__PURE__ */ Cs();
const jn = /* @__PURE__ */ Le(_s);
var Ni = { exports: {} }, ws = Ni.exports, en;
function ks() {
...
var xs = /* @__PURE__ */ ks();
const Gn = /* @__PURE__ */ Le(xs);
var Ri = { exports: {} }, Ss = Ri.exports, tn;
function Ts() {
...
var Es = /* @__PURE__ */ Ts();
const Kn = /* @__PURE__ */ Le(Es);
var Ai = { exports: {} }, Ls = Ai.exports, ln;
function Bs() {
  return ln || (ln = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : Ls, function(t, l) {
      const n = {
        code: "tr",
        toolbar: {
          default: "Varsayılan",
...
var zs = /* @__PURE__ */ Bs();
const Yn = /* @__PURE__ */ Le(zs);
var Ii = { exports: {} }, Ns = Ii.exports, nn;
function Rs() {
...
var As = /* @__PURE__ */ Rs();
const Xn = /* @__PURE__ */ Le(As);
var Vi = { exports: {} }, Is = Vi.exports, on;
function Vs() {
...
var Ds = /* @__PURE__ */ Vs();
const Jn = /* @__PURE__ */ Le(Ds);
var Di = { exports: {} }, Ms = Di.exports, an;
function Os() {
...
var Hs = /* @__PURE__ */ Os();
const Qn = /* @__PURE__ */ Le(Hs), Fs = { ckb: zn, cs: Nn, da: Rn, de: An, en: Wi, es: In, fa: Vn, fr: Dn, he: Mn, hu: On, it: Hn, ja: Fn, ko: Un, km: Pn, lv: Wn, nl: $n, pl: qn, pt_br: Zn, ro: jn, ru: Gn, se: Kn, tr: Yn, ua: Xn, ur: Jn, zh_cn: Qn }, sn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  ckb: zn,
  cs: Nn,
  da: Rn,
  ...
  add: function(e, t) {
    ...
    let i = this.setSubmenu(e), s = n.align._itemMenu = i.querySelector("ul");
    s.addEventListener("click", this.pickup.bind(e)), n.align._alignList = s.querySelectorAll("li button"), e.initMenuTarget(this.name, t, i), i = null, s = null;
  },
  setSubmenu: function(e) {
    ...
    for (let u = 0, f, o; u < i.length; u++)
      f = i[u], o = t.toolbar["align" + f.charAt(0).toUpperCase() + f.slice(1)], s += '<li><button type="button" class="se-btn-list se-btn-align" data-value="' + f + '" title="' + o + '" aria-label="' + o + '"><span class="se-list-icon">' + l["align_" + f] + "</span>" + o + "</button></li>";
  ...
  exchangeDir: function() {
    ...
    if (l && n) {
      const i = l.parentElement, s = n.parentElement;
      i.appendChild(n), s.appendChild(l);
    }
  },
  pickup: function(e) {
    ...
    for (let s = 0, u = i.length; s < u; s++)
      this.util.setStyle(i[s], "textAlign", l === n ? "" : l);
  ...
  setSubmenu: function(e) {
    ...
    let n, i, s, u, f = e.options.font, o = '<div class="se-list-inner"><ul class="se-list-basic"><li><button type="button" class="default_value se-btn-list" title="' + t.toolbar.default + '" aria-label="' + t.toolbar.default + '">(' + t.toolbar.default + ")</button></li>";
    for (s = 0, u = f.length; s < u; s++)
      n = f[s], i = n.split(",")[0], o += '<li><button type="button" class="se-btn-list" data-value="' + n + '" data-txt="' + i + '" title="' + i + '" aria-label="' + i + '" style="font-family:' + n + ';">' + i + "</button></li>";
  ...
  */
  ...
  setSubmenu: function(e) {
    ...
    let s = '<div class="se-list-inner"><ul class="se-list-basic"><li><button type="button" class="default_value se-btn-list" title="' + l.toolbar.default + '" aria-label="' + l.toolbar.default + '">(' + l.toolbar.default + ")</button></li>";
  ...
  */
  ...
  init: function(e, t) {
    ...
    if (i)
      for (let s = 0, u = i.length; s < u; s++)
        n.toLowerCase() === i[s].getAttribute("data-value").toLowerCase() ? this.util.addClass(i[s], "active") : this.util.removeClass(i[s], "active");
  ...
  */
  ...
  setSubmenu: function(e) {
    ...
    for (let s = 0, u = n.length; s < u; s++)
      i += '<li><button type="button" class="se-btn-list btn_line" data-command="horizontalRule" data-value="' + n[s].class + '" title="' + n[s].name + '" aria-label="' + n[s].name + '"><hr' + (n[s].class ? ' class="' + n[s].class + '"' : "") + (n[s].style ? ' style="' + n[s].style + '"' : "") + "/></button></li>";
  ...
  */
  ...
  editList: function(e, t, l) {
    ...
    if (S && (!o || u.tagName !== o.tagName || e !== o.tagName.toUpperCase()) && (!b || f.tagName !== b.tagName || e !== b.tagName.toUpperCase())) {
      ...
      for (let h = 0, p = i.length, v, m; h < p; h++)
        m = s.getRangeFormatElement(i[h], d), !(!m || !s.isList(m)) && (v ? v !== m ? (l && s.isListCell(m.parentNode) ? this.plugins.list._detachNested.call(this, a.f) : k = this.detachRangeFormatElement(a.f[0].parentNode, a.f, r, !1, !0), m = i[h].parentNode, L || (r = s.createElement(e)), v = m, a = { r: v, f: [s.getParentElement(i[h], "LI")] }) : a.f.push(s.getParentElement(i[h], "LI")) : (v = m, a = { r: v, f: [s.getParentElement(i[h], "LI")] }), h === p - 1 && (l && s.isListCell(m.parentNode) ? this.plugins.list._detachNested.call(this, a.f) : k = this.detachRangeFormatElement(a.f[0].parentNode, a.f, r, !1, !0)));
    } else {
      ...
      for (let y = 0, _ = i.length, C, w, z, T, B, N, q, M, U; y < _; y++) {
        if (w = i[y], w.childNodes.length === 0 && !s._isIgnoreNodeChange(w)) {
          s.removeItem(w);
          continue;
        }
        if (T = i[y + 1], B = w.parentNode, N = T ? T.parentNode : null, z = s.isListCell(w), U = s.isRangeFormatElement(B) ? B : null, q = z && !s.isWysiwygDiv(B) ? B.parentNode : B, M = z && !s.isWysiwygDiv(B) ? !T || s.isListCell(q) ? B : B.nextSibling : w.nextSibling, C = s.createElement("LI"), s.copyFormatAttributes(C, w), y === 0 && g.sc === w && (g.sc = C), y === _ - 1 && g.ec === w && (g.ec = C), s.isComponent(w)) {
          const D = /^HR$/i.test(w.nodeName);
          D || (C.innerHTML = "<br>"), C.innerHTML += w.outerHTML, D && (C.innerHTML += "<br>");
        } else {
          const D = w.childNodes;
          for (; D[0]; )
            C.appendChild(D[0]);
        }
        d.appendChild(C), (!T || q !== N || s.isRangeFormatElement(M)) && (h || (h = d), (!a || !T || q !== N) && !(T && s.isList(N) && N === B) && d.parentNode !== q && q.insertBefore(d, M)), s.removeItem(w), a && p === null && (p = d.children.length - 1), T && (s.getRangeFormatElement(N, m) !== s.getRangeFormatElement(B, m) || s.isList(N) && s.isList(B) && s.getElementDepth(N) !== s.getElementDepth(B)) && (d = s.createElement(e)), U && U.children.length === 0 && s.removeItem(U);
      }
  ...
  _detachNested: function(e) {
    const t = e[0], l = e[e.length - 1], n = l.nextElementSibling, i = t.parentNode, s = i.parentNode.nextElementSibling, u = i.parentNode.parentNode;
    for (let o = 0, b = e.length; o < b; o++)
      u.insertBefore(e[o], s);
    if (n && i.children.length > 0) {
      const o = i.cloneNode(!1), b = i.childNodes, c = this.util.getPositionIndex(n);
      for (; b[c]; )
        o.appendChild(b[c]);
      l.appendChild(o);
    }
  ...
  editInsideList: function(e, t) {
    ...
    let n = t[0].parentNode, i = t[l - 1], s = null;
    if (e) {
      ...
      for (let k = 0, S = l, x; k < S; k++)
        x = t[k], x.parentNode !== n && (this.plugins.list._insiedList.call(this, n, u, f, o, b), n = x.parentNode, u = this.util.createElement(n.nodeName)), f = x.previousElementSibling, o = x.nextElementSibling, u.appendChild(x);
      this.plugins.list._insiedList.call(this, n, u, f, o, b);
  ...
  add: function(e, t) {
    ...
    n.resizeDiv = f, n.splitMenu = f.querySelector(".se-btn-group-sub"), n.mergeButton = f.querySelector("._se_table_merge_button"), n.splitButton = f.querySelector("._se_table_split_button"), n.insertRowAboveButton = f.querySelector("._se_table_insert_row_a"), n.insertRowBelowButton = f.querySelector("._se_table_insert_row_b"), s.addEventListener("mousemove", this.onMouseMove_tablePicker.bind(e, n)), s.addEventListener("click", this.appendTable.bind(e)), f.addEventListener("click", this.onClick_tableController.bind(e)), u.addEventListener("click", this.onClick_tableController.bind(e)), e.initMenuTarget(this.name, t, i), l.element.relative.appendChild(f), l.element.relative.appendChild(u), i = null, s = null, f = null, u = null, n = null;
  },
  setSubmenu: function(e) {
  ...
  setCellInfo: function(e, t) {
    ...
    if (/THEAD/i.test(n.firstElementChild.nodeName) ? this.util.addClass(l.headerButton, "active") : this.util.removeClass(l.headerButton, "active"), t || l._physical_cellCnt === 0) {
      ...
      const i = l._trElements = n.rows, s = e.cellIndex;
      let u = 0;
      for (let c = 0, g = i[0].cells, k = i[0].cells.length; c < k; c++)
        u += g[c].colSpan;
      const f = l._rowIndex = l._trElement.rowIndex;
      l._rowCnt = i.length, l._physical_cellCnt = l._trElement.cells.length, l._logical_cellCnt = u, l._physical_cellIndex = s, l._current_colSpan = l._tdElement.colSpan - 1, l._current_rowSpan - l._trElement.cells[s].rowSpan - 1;
      let o = [], b = [];
  ...
  editTable: function(e, t) {
    const l = this.plugins.table, n = this.context.table, i = n._element, s = e === "row";
    if (s) {
      ...
      if (s)
        if (t)
          ...
          for (let c = 0, g = b.length; c < g; c++)
            l.setCellInfo.call(this, b[c], !0), l.editRow.call(this, t);
        }
      else {
        ...
        if (t) {
          ...
          l.setCellInfo.call(this, t === "left" ? f[0] : b || f[0], !0), l.editCell.call(this, t, u);
        } else {
          const b = [f[0]];
          for (let c = 1, g = f.length, k; c < g && (k = f[c], o === k.parentNode); c++)
            b.push(k);
          for (let c = 0, g = b.length; c < g; c++)
            l.setCellInfo.call(this, b[c], !0), l.editCell.call(this, t);
        }
      }
      t || l.init.call(this);
    } else
      l[s ? "editRow" : "editCell"].call(this, t);
    if (!t) {
      const u = i.children;
  ...
  editRow: function(e, t) {
    const l = this.context.table, n = !e, i = e === "up", s = l._rowIndex, u = n || i ? s : s + l._current_rowSpan + 1, f = n ? -1 : 1, o = l._trElements;
    let b = l._logical_cellCnt;
    for (let c = 0, g = s + (n ? -1 : 0), k; c <= g; c++) {
    ...
    if (n) {
      ...
      const c = l._element.insertRow(u);
  ...
  editCell: function(e, t) {
    const l = this.context.table, n = this.util, i = !e, s = e === "left", u = l._current_colSpan, f = i || s ? l._logical_cellIndex : l._logical_cellIndex + u + 1, o = l._trElements;
    let b = [], c = [], g = 0;
    const k = [], S = [];
    for (let x = 0, L = l._rowCnt, a, r, d, h, p, v; x < L; x++) {
      ...
      for (let m = 0, y, _ = d.length, C, w, z; m < _ && (y = d[m], !!y); m++)
        if (C = y.rowSpan - 1, w = y.colSpan - 1, i) {
          ...
          C > 0 && b.push({
            ...
            index: z,
            row: -1
          }), z >= r && z + w <= r + u ? k.push(y) : z <= r + u && z + w >= r ? y.colSpan -= n.getOverlapRangeAtIndex(f, f + u, z, z + w) : C > 0 && (z < r || z + w > r + u) && S.push({
            cell: y,
            i: x,
            rs: x + C
          }), v += w;
    ...
    if (i) {
      ...
      for (let a = 0, r = k.length, d; a < r; a++)
        d = k[a].parentNode, n.removeItem(k[a]), d.cells.length === 0 && (x || (x = n.getArrayIndex(o, d)), L = n.getArrayIndex(o, d), n.removeItem(d));
      for (let a = 0, r = S.length, d; a < r; a++)
        d = S[a], d.cell.rowSpan = n.getOverlapRangeAtIndex(x, L, d.i, d.rs);
      this.controllersOff();
    } else
  ...
  splitCells: function(e) {
    const t = this.util, l = e === "vertical", n = this.context.table, i = n._tdElement, s = n._trElements, u = n._trElement, f = n._logical_cellIndex, o = n._rowIndex, b = this.plugins.table.createCells.call(this, i.nodeName, 0, !0);
    if (l) {
      const c = i.colSpan;
      if (b.rowSpan = i.rowSpan, c > 1)
        ...
        let g = [], k = [];
        for (let S = 0, x = n._rowCnt, L, a; S < x; S++) {
          L = s[S].cells, a = 0;
      ...
      if (b.colSpan = i.colSpan, c > 1) {
        ...
        const k = n._physical_cellIndex, S = u.cells;
  ...
  mergeCells: function() {
    const e = this.plugins.table, t = this.context.table, l = this.util, n = e._ref, i = e._selectedCells, s = i[0];
    let u = null, f = null, o = n.ce - n.cs + 1, b = n.re - n.rs + 1, c = "", g = null;
    for (let k = 1, S = i.length, x, L; k < S; k++) {
      x = i[k], g !== x.parentNode && (g = x.parentNode), L = x.children;
      for (let a = 0, r = L.length; a < r; a++)
        l.isFormatElement(L[a]) && l.onlyZeroWidthSpace(L[a].textContent) && l.removeItem(L[a]);
      c += x.innerHTML, l.removeItem(x), g.cells.length === 0 && (u ? f = g : u = g, b -= 1);
    }
    if (u) {
      const k = t._trElements, S = l.getArrayIndex(k, u), x = l.getArrayIndex(k, f || u), L = [];
      for (let a = 0, r; a <= x; a++) {
        ...
        for (let d = 0, h = r.length, p, v; d < h; d++)
          p = r[d], v = p.rowSpan - 1, v > 0 && a + v >= S && (p.rowSpan -= l.getOverlapRangeAtIndex(S, x, a, a + v));
      }
      for (let a = 0, r = L.length; a < r; a++)
        l.removeItem(L[a]);
    }
    s.innerHTML += c, s.colSpan = o, s.rowSpan = b, this.controllersOff(), e.setActiveButton.call(this, !0, !1), e.call_controller_tableEdit.call(this, s), l.addClass(s, "se-table-selected-cell"), this.focusEdge(s);
  },
  ...
  setTableStyle: function(e) {
    ...
    let n, i, s, u;
    e.indexOf("width") > -1 && (n = t.resizeButton.firstElementChild, i = t.resizeText, t._maxWidth ? (s = t.icons.reduction, u = t.minText, t.columnFixedButton.style.display = "block", this.util.removeClass(l, "se-table-size-auto"), this.util.addClass(l, "se-table-size-100")) : (s = t.icons.expansion, u = t.maxText, t.columnFixedButton.style.display = "none", this.util.removeClass(l, "se-table-size-100"), this.util.addClass(l, "se-table-size-auto")), this.util.changeElement(n, s), this.util.changeTxt(i, u)), e.indexOf("column") > -1 && (t._fixedColumn ? (this.util.removeClass(l, "se-table-layout-auto"), this.util.addClass(l, "se-table-layout-fixed"), this.util.addClass(t.columnFixedButton, "active")) : (this.util.removeClass(l, "se-table-layout-fixed"), this.util.addClass(l, "se-table-layout-auto"), this.util.removeClass(t.columnFixedButton, "active")));
  },
  ...
  _setMultiCells: function(e, t) {
    const l = this.plugins.table, n = l._selectedTable.rows, i = this.util, s = l._selectedTable.querySelectorAll(".se-table-selected-cell");
    ...
    for (let c = 0, g = n.length, k, S; c < g; c++) {
      k = n[c].cells, S = 0;
  ...
  onClick_tableController: function(e) {
    ...
    const l = t.getAttribute("data-command"), n = t.getAttribute("data-value"), i = t.getAttribute("data-option"), s = this.plugins.table;
    if (typeof s._closeSplitMenu == "function" && (s._closeSplitMenu(), l === "onsplit") || !l) return;
    e.preventDefault();
    const u = this.context.table;
    switch (l) {
      case "insert":
      case "delete":
        s.editTable.call(this, n, i);
        break;
      case "header":
  ...
  */
  active: function(e) {
    ...
    if (!e)
      ...
      return this.util.changeTxt(l, t), l.setAttribute("data-value", s), l.setAttribute("data-class", u), !0;
    }
    return !1;
  },
  /**
  ...
  */
  ...
  pickUp: function(e) {
    e.preventDefault(), e.stopPropagation();
    let t = e.target, l = null, n = null, i = null, s = "";
    for (; !l && !/UL/i.test(t.tagName); ) {
      if (l = t.getAttribute("data-command"), n = t.getAttribute("data-value"), s = t.getAttribute("data-class"), l) {
        i = t.firstChild;
        break;
      }
      t = t.parentNode;
      ...
      if (l === "range") {
        ...
        if (l === "free") {
          ...
          for (let r = 0, d = a.length, h, p; r < d; r++)
            h = a[r], (h.nodeName.toLowerCase() !== n.toLowerCase() || (h.className.match(/(\s|^)__se__format__[^\s]+/) || [""])[0].trim() !== s) && !c.isComponent(h) && (p = i.cloneNode(!1), c.copyFormatAttributes(p, h), p.innerHTML = h.innerHTML, h.parentNode.replaceChild(p, h)), r === 0 && (g = p || h), r === d - 1 && (k = p || h), p = null;
  ...
  */
  on: function() {
    ...
    for (let i = 0, s = l.length, u, f, o; i < s; i++) {
...
var Mi = { exports: {} }, tr = Mi.exports, rn;
function ir() {
...
const oi = /* @__PURE__ */ Le(lr), nr = {
  ...
  moveItem: function(e, t) {
    ...
    for (let s = 0; s < n; s++)
      s === i ? this.util.addClass(l[s], "active") : this.util.removeClass(l[s], "active");
    e.item = e.items[i];
  },
  ...
  name: "anchor",
  add: function(e) {
    e.addModule([nr]), e.context.anchor = {
      caller: {},
  ...
  setDialogForm: function(e) {
    const t = e.lang, l = e.options.linkRel, n = (e.options.linkRelDefault.default || "").split(" "), i = e.icons, s = e.util.createElement("DIV");
    ...
    if (l.length > 0) {
      ...
      for (let f = 0, o = l.length, b; f < o; f++)
        b = l[f], u += '<li><button type="button" class="se-btn-list' + (n.indexOf(b) > -1 ? " se-checked" : "") + '" data-command="' + b + '" title="' + b + '" aria-label="' + b + '"><span class="se-svg">' + i.checked + "</span>" + b + "</button></li>";
      u += "</ul></div></div></div>";
    }
  ...
  onClick_relList: function(e, t) {
    ...
    if (!n) return;
    const i = e.currentRel, s = this.util.toggleClass(l, "se-checked"), u = i.indexOf(n);
    s ? u === -1 && i.push(n) : u > -1 && i.splice(u, 1), e.relPreview.title = e.relPreview.textContent = i.join(" ");
  },
  setRel: function(e, t) {
    ...
    for (let s = 0, u = i.length, f; s < u; s++)
      f = i[s].getAttribute("data-command"), n.indexOf(f) > -1 ? this.util.addClass(i[s], "se-checked") : this.util.removeClass(i[s], "se-checked");
  ...
  createHeaderList: function(e, t, l) {
    ...
    const i = new this._w.RegExp("^" + l.replace(/^#/, ""), "i"), s = [];
    let u = "";
    for (let f = 0, o = n.length, b; f < o; f++)
      b = n[f], i.test(b.textContent) && (s.push(b), u += '<li class="se-select-item" data-index="' + f + '">' + b.textContent + "</li>");
  ...
  updateAnchor: function(e, t, l, n, i) {
    ...
    s ? e.rel = s : e.removeAttribute("rel"), e.href = t, i ? e.children.length === 0 && (e.textContent = "") : e.textContent = l;
  },
  createAnchor: function(e, t) {
    if (e.linkValue.length === 0) return null;
    const l = e.linkValue, n = e.anchorText, i = n.value.length === 0 ? l : n.value, s = e.linkAnchor || this.util.createElement("A");
    return this.plugins.anchor.updateAnchor.call(this, s, l, i, e, t), e.linkValue = e.preview.textContent = e.urlInput.value = e.anchorText.value = "", s;
  },
...
var Oi = { exports: {} }, ar = Oi.exports, un;
function sr() {
...
var rr = /* @__PURE__ */ sr();
const ul = /* @__PURE__ */ Le(rr);
var Hi = { exports: {} }, ur = Hi.exports, cn;
function cr() {
  return cn || (cn = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : ur, function(t, l) {
      const n = {
        name: "resizing",
        /**
         * @description Constructor
...
var dr = /* @__PURE__ */ cr();
const io = /* @__PURE__ */ Le(dr);
var Fi = { exports: {} }, fr = Fi.exports, dn;
function hr() {
...
var pr = /* @__PURE__ */ hr();
const cl = /* @__PURE__ */ Le(pr), mr = {
  name: "image",
  display: "dialog",
  add: function(e) {
    e.addModule([oi, to, ul, io, cl]);
  ...
  setDialog: function(e) {
    ...
    if (t.imageFileInput && (i += '<div class="se-dialog-form"><label>' + l.dialogBox.imageBox.file + '</label><div class="se-dialog-form-files"><input class="se-input-form _se_image_file" type="file" accept="' + t.imageAccept + '"' + (t.imageMultipleFile ? ' multiple="multiple"' : "") + '/><button type="button" class="se-btn se-dialog-files-edge-button se-file-remove" title="' + l.controller.remove + '" aria-label="' + l.controller.remove + '">' + e.icons.cancel + "</button></div></div>"), t.imageUrlInput && (i += '<div class="se-dialog-form"><label>' + l.dialogBox.imageBox.url + '</label><div class="se-dialog-form-files"><input class="se-input-form se-input-url _se_image_url" type="text" />' + (t.imageGalleryUrl && e.plugins.imageGallery ? '<button type="button" class="se-btn se-dialog-files-edge-button __se__gallery" title="' + l.toolbar.imageGallery + '" aria-label="' + l.toolbar.imageGallery + '">' + e.icons.image_gallery + "</button>" : "") + '</div><pre class="se-link-preview"></pre></div>'), i += '</div><div class="se-dialog-form"><label>' + l.dialogBox.imageBox.altText + '</label><input class="se-input-form _se_image_alt" type="text" /></div>', t.imageResizing) {
      ...
      i += '<div class="se-dialog-form">', s || !t.imageHeightShow ? i += '<div class="se-dialog-size-text"><label class="size-w">' + l.dialogBox.size + "</label></div>" : i += '<div class="se-dialog-size-text"><label class="size-w">' + l.dialogBox.width + '</label><label class="se-dialog-size-x">&nbsp;</label><label class="size-h">' + l.dialogBox.height + "</label></div>", i += '<input class="se-input-control _se_image_size_x" placeholder="auto"' + (s ? ' type="number" min="1"' : 'type="text"') + (s ? ' max="100"' : "") + ' /><label class="se-dialog-size-x"' + f + ">" + (s ? "%" : "x") + '</label><input type="text" class="se-input-control _se_image_size_y" placeholder="auto"' + u + (s ? ' max="100"' : "") + f + "/><label" + u + f + '><input type="checkbox" class="se-dialog-btn-check _se_image_check_proportion" checked/>&nbsp;' + l.dialogBox.proportion + '</label><button type="button" title="' + l.dialogBox.revertButton + '" aria-label="' + l.dialogBox.revertButton + '" class="se-btn se-dialog-btn-revert" style="float: right;">' + e.icons.revert + "</button></div>";
    }
  ...
  destroy: function(e) {
    ...
    this.util.removeItem(l), this.plugins.image.init.call(this), this.controllersOff(), s !== this.context.element.wysiwyg && this.util.removeItemAllParents(s, function(u) {
  ...
  register: function(e, t) {
    const l = t.result;
    for (let n = 0, i = l.length, s; n < i; n++)
      if (s = { name: l[n].name, size: l[n].size }, e.isUpdate) {
        this.plugins.image.update_src.call(this, l[n].url, e.element, s);
        break;
      } else
        this.plugins.image.create_image.call(this, l[n].url, e.anchor, e.inputWidth, e.inputHeight, e.align, s, e.alt);
    this.closeLoading();
  },
  setup_reader: function(e, t, l, n, i, s, u, f) {
    try {
      if (u === 0) {
      ...
      for (let c = 0, g, k; c < u; c++)
        g = new o(), k = e[c], g.onload = (function(S, x, L, a, r) {
          b[r] = { result: S.result, file: a }, --this.context.image.base64RenderIndex === 0 && (this.plugins.image.onRender_imgBase64.call(this, x, b, L, t, l, n, i, s), this.closeLoading());
  ...
  onRender_imgBase64: function(e, t, l, n, i, s, u, f) {
    const o = this.plugins.image.update_src, b = this.plugins.image.create_image;
    for (let c = 0, g = t.length; c < g; c++)
      e ? (this.context.image._element.setAttribute("data-file-name", t[c].file.name), this.context.image._element.setAttribute("data-file-size", t[c].file.size), o.call(this, t[c].result, l, t[c].file)) : b.call(this, t[c].result, n, i, s, u, t[c].file, f);
  },
  ...
  create_image: function(e, t, l, n, i, s, u) {
  ...
  update_image: function(e, t, l) {
    ...
    let i = n._element, s = n._cover, u = n._container, f = !1;
    s === null && (f = !0, i = n._element.cloneNode(!0), s = this.plugins.component.set_cover.call(this, i)), u === null ? (s = s.cloneNode(!0), i = s.querySelector("img"), f = !0, u = this.plugins.component.set_container.call(this, s, "se-image-container")) : f && (u.innerHTML = "", u.appendChild(s), n._cover = s, n._element = i, f = !1);
    let o;
    const b = this.util.isNumber(n.inputX.value) ? n.inputX.value + n.sizeUnit : n.inputX.value, c = this.util.isNumber(n.inputY.value) ? n.inputY.value + n.sizeUnit : n.inputY.value;
    /%$/.test(i.style.width) ? o = b !== u.style.width || c !== u.style.height : o = b !== i.style.width || c !== i.style.height, i.alt = n._altText;
    let g = !1;
    n._captionChecked ? n._caption || (n._caption = this.plugins.component.create_caption.call(this), s.appendChild(n._caption), g = !0) : n._caption && (this.util.removeItem(n._caption), n._caption = null, g = !0);
    let k = null;
    const S = this.plugins.anchor.createAnchor.call(this, n.anchorCtx, !0);
    if (S)
      n._linkElement !== S || f && !u.contains(S) ? (n._linkElement = S.cloneNode(!1), s.insertBefore(this.plugins.image.onRender_link.call(this, i, n._linkElement), n._caption), k = n._element) : n._linkElement.setAttribute("data-image-link", "image");
    else if (n._linkElement !== null) {
      const L = i;
      if (L.setAttribute("data-image-link", ""), s.contains(n._linkElement)) {
        const a = L.cloneNode(!0);
        s.removeChild(n._linkElement), s.insertBefore(a, n._caption), n._element = i = a;
      }
    }
    let x = null;
    if (f) {
      const L = n._element.parentNode;
      if (x = this.util.isRangeFormatElement(L) || this.util.isWysiwygDiv(L) ? n._element : L || n._element, this.util.getParentElement(n._element, this.util.isNotCheckingNode))
        x = k ? S : n._element, x.parentNode.replaceChild(u, x);
      else if (this.util.isListCell(x)) {
        const a = this.util.getParentElement(n._element, function(r) {
          return r.parentNode === x;
        });
        x.insertBefore(u, a), this.util.removeItem(n._element), this.util.removeEmptyNode(a, null, !0);
      } else if (this.util.isFormatElement(x)) {
        const a = this.util.getParentElement(n._element, function(r) {
          return r.parentNode === x;
        });
        x = this.util.splitElement(x, a), x.parentNode.insertBefore(u, x), this.util.removeItem(n._element), this.util.removeEmptyNode(x, null, !0), x.children.length === 0 && (x.innerHTML = this.util.htmlRemoveWhiteSpace(x.innerHTML));
      } else if (this.util.isFormatElement(x.parentNode)) {
        const a = x.parentNode;
        a.parentNode.insertBefore(u, x.previousSibling ? a.nextElementSibling : a), n.__updateTags.map(function(r) {
          return x.contains(r);
        }).length === 0 && this.util.removeItem(x);
      } else
        x = this.util.isFigures(x.parentNode) ? x.parentNode : x, x.parentNode.replaceChild(u, x);
      i = u.querySelector("img"), n._element = i, n._cover = s, n._container = u;
    }
    k && (f ? (this.util.removeItem(k), this.util.getListChildren(S, function(L) {
      return /IMG/i.test(L.tagName);
    }).length === 0 && this.util.removeItem(S)) : this.util.removeItem(S)), (g || !n._onlyPercentage && o) && !e && (/\d+/.test(i.style.height) || this.context.resizing._rotateVertical && n._captionChecked) && (/%$/.test(n.inputX.value) || /%$/.test(n.inputY.value) ? this.plugins.resizing.resetTransform.call(this, i) : this.plugins.resizing.setTransformSize.call(this, i, this.util.getNumber(n.inputX.value, 0), this.util.getNumber(n.inputY.value, 0))), n._resizing && (i.setAttribute("data-proportion", n._proportionChecked), o && this.plugins.image.applySize.call(this)), this.plugins.image.setAlign.call(this, null, i, null, null), e && this.plugins.fileManager.setInfo.call(this, "image", i, this.functions.onImageUpload, null, !0), t && this.selectComponent(i, "image"), l || this.history.push(!1);
  },
  ...
  onModifyMode: function(e, t) {
    ...
    let n = l._element.getAttribute("data-size") || l._element.getAttribute("data-origin"), i, s;
    n ? (n = n.split(","), i = n[0], s = n[1]) : t && (i = t.w, s = t.h), l._origin_w = i || e.style.width || e.width || "", l._origin_h = s || e.style.height || e.height || "";
  },
  /**
   * @Required @Override fileManager, resizing
   */
  ...
  setSize: function(e, t, l, n) {
    const i = this.context.image, s = /^(rw|lw)$/.test(n) && /\d+/.test(i._element.style.height);
    /^(th|bh)$/.test(n) && /\d+/.test(i._element.style.width) || (i._element.style.width = this.util.isNumber(e) ? e + i.sizeUnit : e, this.plugins.image.cancelPercentAttr.call(this)), s || (i._element.style.height = this.util.isNumber(t) ? t + i.sizeUnit : /%$/.test(t) ? "" : t), i._align === "center" && this.plugins.image.setAlign.call(this, null, null, null, null), l || i._element.removeAttribute("data-percentage"), this.plugins.resizing._module_saveCurrentSize.call(this, i);
  },
  /**
   * @Override resizing
   */
  ...
  setDialog: function(e) {
    ...
    if (t.videoFileInput && (i += '<div class="se-dialog-form"><label>' + l.dialogBox.videoBox.file + '</label><div class="se-dialog-form-files"><input class="se-input-form _se_video_file" type="file" accept="' + t.videoAccept + '"' + (t.videoMultipleFile ? ' multiple="multiple"' : "") + '/><button type="button" data-command="filesRemove" class="se-btn se-dialog-files-edge-button se-file-remove" title="' + l.controller.remove + '" aria-label="' + l.controller.remove + '">' + e.icons.cancel + "</button></div></div>"), t.videoUrlInput && (i += '<div class="se-dialog-form"><label>' + l.dialogBox.videoBox.url + '</label><input class="se-input-form se-input-url" type="text" /><pre class="se-link-preview"></pre></div>'), t.videoResizing) {
      ...
      i += '<div class="se-dialog-form"><div class="se-dialog-size-text"><label class="size-w">' + l.dialogBox.width + '</label><label class="se-dialog-size-x">&nbsp;</label><label class="size-h"' + b + ">" + l.dialogBox.height + '</label><label class="size-h"' + c + ">(" + l.dialogBox.ratio + ')</label></div><input class="se-input-control _se_video_size_x" placeholder="100%"' + (f ? ' type="number" min="1"' : 'type="text"') + (f ? ' max="100"' : "") + '/><label class="se-dialog-size-x"' + g + ">" + (f ? "%" : "x") + '</label><input class="se-input-control _se_video_size_y" placeholder="' + t.videoRatio * 100 + '%"' + (f ? ' type="number" min="1"' : 'type="text"') + (f ? ' max="100"' : "") + b + '/><select class="se-input-select se-video-ratio" title="' + l.dialogBox.ratio + '" aria-label="' + l.dialogBox.ratio + '"' + c + ">", b || (i += '<option value=""> - </option>');
      for (let k = 0, S = s.length; k < S; k++)
        i += '<option value="' + s[k].value + '"' + (u.toString() === s[k].value.toString() ? " selected" : "") + ">" + s[k].name + "</option>";
      i += '</select><button type="button" title="' + l.dialogBox.revertButton + '" aria-label="' + l.dialogBox.revertButton + '" class="se-btn se-dialog-btn-revert" style="float: right;">' + e.icons.revert + '</button></div><div class="se-dialog-form se-dialog-form-footer"' + o + g + '><label><input type="checkbox" class="se-dialog-btn-check _se_video_check_proportion" checked/>&nbsp;' + l.dialogBox.proportion + "</label></div>";
    }
  ...
  destroy: function(e) {
    ...
    let i = l.previousElementSibling || l.nextElementSibling;
    const s = l.parentNode;
    this.util.removeItem(l), this.plugins.video.init.call(this), this.controllersOff(), s !== this.context.element.wysiwyg && this.util.removeItemAllParents(s, function(u) {
      return u.childNodes.length === 0;
  ...
  submitAction: function(e) {
    ...
    if (typeof this.functions.onVideoUploadBefore == "function") {
      const u = this.functions.onVideoUploadBefore(l, s, this, (function(f) {
    ...
    this.plugins.video.upload.call(this, s, l);
  },
  error: function(e, t) {
  ...
  create_video: function(e, t, l, n, i, s, u) {
    ...
    const g = this.plugins.resizing._module_getSizeX.call(this, f) !== (l || f._defaultSizeX) || this.plugins.resizing._module_getSizeY.call(this, f) !== (n || f._videoRatio), k = !u || g;
  ...
  _update_videoCover: function(e) {
    ...
    let n = this.util.isRangeFormatElement(l) || this.util.isWysiwygDiv(l) ? e : l || e;
    const i = e;
    ...
    try {
      const f = n.querySelector("figcaption");
      let o = null;
      ...
      if (c && (t._align = c.style.textAlign || c.style.float), this.plugins.video.setAlign.call(this, null, e, s, u), this.util.getParentElement(i, this.util.isNotCheckingNode))
        ...
        const g = this.util.getParentElement(i, function(k) {
          return k.parentNode === n;
        });
        n.insertBefore(u, g), this.util.removeItem(i), this.util.removeEmptyNode(g, null, !0);
      } else if (this.util.isFormatElement(n)) {
        const g = this.util.getParentElement(i, function(k) {
          return k.parentNode === n;
        });
        n = this.util.splitElement(n, g), n.parentNode.insertBefore(u, n), this.util.removeItem(i), this.util.removeEmptyNode(n, null, !0), n.children.length === 0 && (n.innerHTML = this.util.htmlRemoveWhiteSpace(n.innerHTML));
      } else
        n.parentNode.replaceChild(u, n);
      o && n.parentNode.insertBefore(o, u.nextElementSibling);
    } catch (f) {
   ...
   */
  setSize: function(e, t, l, n) {
    const i = this.context.video, s = /^(rw|lw)$/.test(n), u = /^(th|bh)$/.test(n);
    u || (e = this.util.getNumber(e, 0)), s || (t = this.util.isNumber(t) ? t + i.sizeUnit : t || ""), e = e ? e + i.sizeUnit : "", u || (i._element.style.width = e), s || (i._cover.style.paddingBottom = i._cover.style.height = t), !u && !/%$/.test(e) && (i._cover.style.width = e, i._container.style.width = ""), !s && !/%$/.test(t) ? i._element.style.height = t : i._element.style.height = "", l || i._element.removeAttribute("data-percentage"), this.plugins.resizing._module_saveCurrentSize.call(this, i);
  },
  /**
   * @Override resizing
   */
  ...
  submitAction: function(e) {
    ...
    if (typeof this.functions.onAudioUploadBefore == "function") {
      const u = this.functions.onAudioUploadBefore(l, s, this, (function(f) {
    ...
    this.plugins.audio.upload.call(this, s, l);
  },
  error: function(e, t) {
  ...
  register: function(e, t) {
    const l = t.result;
    for (let n = 0, i = l.length, s, u; n < i; n++)
      e.isUpdate ? u = e.element : u = this.plugins.audio._createAudioTag.call(this), s = { name: l[n].name, size: l[n].size }, this.plugins.audio.create_audio.call(this, u, l[n].url, s, e.isUpdate);
    this.closeLoading();
  },
  setupUrl: function(e) {
    try {
  ...
  updateCover: function(e) {
    ...
    try {
      if (this.util.getParentElement(i, this.util.isNotCheckingNode))
        ...
        n.insertBefore(u, f), this.util.removeItem(i), this.util.removeEmptyNode(f, null, !0);
      } else if (this.util.isFormatElement(n)) {
        const f = this.util.getParentElement(i, function(o) {
          return o.parentNode === n;
        });
        n = this.util.splitElement(n, f), n.parentNode.insertBefore(u, n), this.util.removeItem(i), this.util.removeEmptyNode(n, null, !0), n.children.length === 0 && (n.innerHTML = this.util.htmlRemoveWhiteSpace(n.innerHTML));
      } else
        n.parentNode.replaceChild(u, n);
    } catch (f) {
...
}, fn = "https://katex.org/docs/supported.html", br = {
  name: "math",
  display: "dialog",
  add: function(e) {
    e.addModule([oi]);
  ...
  setDialog: function(e) {
    ...
    let i = n[0].value;
    l.className = "se-dialog-content", l.style.display = "none";
    let s = '<form><div class="se-dialog-header"><button type="button" data-command="close" class="se-btn se-dialog-close" title="' + t.dialogBox.close + '" aria-label="' + t.dialogBox.close + '">' + e.icons.cancel + '</button><span class="se-modal-title">' + t.dialogBox.mathBox.title + '</span></div><div class="se-dialog-body"><div class="se-dialog-form"><label>' + t.dialogBox.mathBox.inputLabel + ' (<a href="' + fn + '" target="_blank">KaTeX</a>)</label><textarea class="se-input-form se-math-exp" type="text"></textarea></div><div class="se-dialog-form"><label>' + t.dialogBox.mathBox.fontSizeLabel + '</label><select class="se-input-select se-math-size">';
    for (let u = 0, f = n.length, o; u < f; u++)
      o = n[u], o.default && (i = o.value), s += '<option value="' + o.value + '"' + (o.default ? " selected" : "") + ">" + o.text + "</option>";
    return s += '</select></div><div class="se-dialog-form"><label>' + t.dialogBox.mathBox.previewLabel + '</label><p class="se-math-preview"></p></div></div><div class="se-dialog-footer"><button type="submit" class="se-btn-primary" title="' + t.dialogBox.submitButton + '" aria-label="' + t.dialogBox.submitButton + '"><span>' + t.dialogBox.submitButton + "</span></button></div></form>", e.context.math.defaultFontSize = i, l.innerHTML = s, l;
  },
  /** modify controller button */
  ...
  submit: function(e) {
    ...
    const t = (function() {
      ...
      if (i.className = "__se__katex " + i.className, i.setAttribute("contenteditable", !1), i.setAttribute("data-exp", this.util.HTMLEncoder(n)), i.setAttribute("data-font-size", l.fontSizeElement.value), i.style.fontSize = l.fontSizeElement.value, this.context.dialog.updateModal) {
        const s = this.util.getParentElement(l._mathExp, ".katex");
...
var Ui = { exports: {} }, yr = Ui.exports, hn;
function Cr() {
  return hn || (hn = 1, (function(e) {
    ...
    })(typeof window < "u" ? window : yr, function(t, l) {
      const n = {
        name: "fileBrowser",
        _xmlHttp: null,
        _loading: null,
...
const wr = /* @__PURE__ */ Le(_r), kr = {
...
}, xr = { blockquote: Us, align: Ps, font: Ws, fontSize: $s, fontColor: qs, hiliteColor: Zs, horizontalRule: js, list: Gs, table: Ks, formatBlock: Ys, lineHeight: Xs, template: Js, paragraphStyle: Qs, textStyle: er, link: or, image: mr, video: gr, audio: vr, math: br, imageGallery: kr }, Sr = {
  buttonList: [
    ["undo", "redo"],
  ...
  getIncludePath: function(e, t) {
    let l = "";
    const n = [], i = t === "js" ? "script" : "link", s = t === "js" ? "src" : "href";
    let u = "(?:";
    ...
    if (l === "" && (l = n.length > 0 ? n[0][s] : ""), l.indexOf(":/") === -1 && l.slice(0, 2) !== "//" && (l = l.indexOf("/") === 0 ? location.href.match(/^.*?:\/\/[^\/]*/)[0] + l : location.href.match(/^[^\?]*\/(?:)/)[0] + l), !l) throw "[SUNEDITOR.util.getIncludePath.fail] The SUNEDITOR installation path could not be automatically detected. (name: +" + name + ", extension: " + t + ")";
    return l;
  },
  /**
   * @deprecated
    ...
    return this.getParentElement(e, (function(s) {
      if (s === t && (i = !1), i && !this.isWysiwygDiv(s)) {
        if (l && s.nodeType === 3) {
          ...
          for (; o && o.nodeType === 3; )
            f = o.textContent.replace(this.zeroWidthRegExp, ""), l.s += f.length, s.textContent = f + s.textContent, u = o, o = o.previousSibling, this.removeItem(u);
          let b = s.nextSibling;
          for (; b && b.nodeType === 3; )
            f = b.textContent.replace(this.zeroWidthRegExp, ""), l.e += f.length, s.textContent += f, u = b, b = b.nextSibling, this.removeItem(u);
        }
        n.push(s);
      }
      return !1;
  ...
  getNodeFromPath: function(e, t) {
    let l = t, n;
    for (let i = 0, s = e.length; i < s && (n = l.childNodes, n.length !== 0); i++)
  ...
  isSameAttributes: function(e, t) {
    ...
    return i === n.length && i === l.length && o === u.length && o === s.length;
  },
  /**
  ...
  compareElements: function(e, t) {
    ...
    const i = l.parentNode.childNodes, s = this.getArrayIndex(i, l), u = this.getArrayIndex(i, n);
    return {
  ...
  getOffset: function(e, t) {
    ...
    return {
      ...
      top: n - (s ? s.scrollTop : 0) + (u ? t.parentElement.offsetTop : 0)
    };
  },
  /**
  ...
  setDisabledButtons: function(e, t, l) {
    for (let n = 0, i = t.length; n < i; n++) {
      let s = t[n];
      (l || !this.isImportantDisabled(s)) && (s.disabled = e), l && (e ? s.setAttribute("data-important-disabled", "") : s.removeAttribute("data-important-disabled"));
    }
  },
  /**
  ...
  detachNestedList: function(e, t) {
    ...
    let s;
    if (t)
      s = this.getListChildren(n, (function(u) {
  ...
  _deleteNestedList: function(e) {
    ...
    let l = t, n = l.parentNode, i, s, u, f, o;
    for (; this.isListCell(n); ) {
      for (f = this.getPositionIndex(e), i = n.nextElementSibling, s = n.parentNode, u = l; u; ) {
  ...
  splitElement: function(e, t, l) {
    ...
    if ((!l || l < 0) && (l = 0), e.nodeType === 3) {
      if (i = this.getPositionIndex(e), t >= 0 && e.length !== t) {
        e.splitText(t);
        const k = this.getNodeFromPath([i + 1], n);
    ...
    }).bind(this)), f.childNodes.length > 0 ? g.insertBefore(f, c) : f = c, this.isListCell(f) && f.children && this.isList(f.children[0]) && f.insertBefore(this.createElement("BR"), f.children[0]), n.childNodes.length === 0 && this.removeItem(n), f) : c;
  },
  /**
    ...
    return i && (s = this._w.Array.apply(null, new this._w.Array(i)).map(this._w.Number.prototype.valueOf, 0)), (function u(f, o, b) {
      ...
      for (let g = 0, k = c.length, S, x; g < k && (S = c[g], x = c[g + 1], !!S); g++)
        if (!(n.isBreak(S) || n.isMedia(S) || n.isInputElement(S))) {
          if (l && n._isIgnoreNodeChange(S) || !l && (n.isTable(S) || n.isListCell(S) || n.isFormatElement(S) && !n.isFreeFormatElement(S))) {
              ...
              for (let p = 0; p < i; p++)
                if (L = t[p], L && L[o] === g) {
                  for (a = S, r = f, d = o, h = !0; d >= 0; ) {
                    if (n.getArrayIndex(r.childNodes, a) !== L[d]) {
                      h = !1;
                      break;
                    }
          ...
          if (S.nodeName === x.nodeName && n.isSameAttributes(S, x) && S.href === x.href) {
  ...
  removeEmptyNode: function(e, t, l) {
    ...
    t && (t = n.getParentElement(t, function(i) {
      ...
      if (n._notTextNode(s) || s === t || n.isNonEditable(s)) return 0;
      if (s !== e && n.onlyZeroWidthSpace(s.textContent) && (!s.firstChild || !n.isBreak(s.firstChild)) && !s.querySelector(n._allowedEmptyNodeList)) {
        if (s.parentNode)
          return s.parentNode.removeChild(s), -1;
      } else {
        const u = s.children;
        for (let f = 0, o = u.length, b = 0; f < o; f++)
          !u[f + b] || n.isComponent(u[f + b]) || (b += i(u[f + b]));
      }
      return 0;
  ...
  sortByDepth: function(e, t) {
    const l = t ? 1 : -1, n = l * -1;
    e.sort((function(i, s) {
      return !this.isListCell(i) || !this.isListCell(s) ? 0 : (i = this.getElementDepth(i), s = this.getElementDepth(s), i > s ? l : i < s ? n : 0);
    }).bind(this));
  },
  /**
  ...
  _consistencyCheckOfHTML: function(e, t, l, n, i) {
    const s = [], u = [], f = [], o = [], b = this.getListChildNodes(e, (function(g) {
      ...
      if (l.test(g.nodeName) || !t.test(g.nodeName) && g.childNodes.length === 0 && this.isNotCheckingNode(g))
        return s.push(g), !1;
      ...
      if (k && g.className) {
        const x = new this._w.Array(g.classList).map(n).join(" ").trim();
...
body{height: min-content; overflow: hidden;}
  ...
  init: function(e, t) {
    ...
    const s = this._createToolBar(l, t.buttonList, t.plugins, t), u = s.element.cloneNode(!1);
    ...
    const c = this._initElements(t, n, s.element, f), g = c.bottomBar, k = c.wysiwygFrame, S = c.placeholder;
    let x = c.codeView;
    const L = g.resizingBar, a = g.navigation, r = g.charWrapper, d = g.charCounter, h = l.createElement("DIV");
    ...
    return L && w && w.appendChild(L), b.appendChild(x), S && b.appendChild(S), C || (i.appendChild(s.element), i.appendChild(u)), i.appendChild(o), i.appendChild(b), i.appendChild(y), i.appendChild(h), i.appendChild(p), i.appendChild(v), i.appendChild(m), i.appendChild(_), L && !w && i.appendChild(L), n.appendChild(i), x = this._checkCodeMirror(t, x), {
      constructed: {
        _top: n,
        _relative: i,
        _toolBar: s.element,
  ...
  _setOptions: function(e, t, l) {
    ...
    const n = t.element, i = n.relative, s = n.editorArea, u = e.toolbarContainer && e.toolbarContainer !== l.toolbarContainer, f = e.lang !== l.lang || e.buttonList !== l.buttonList || e.mode !== l.mode || u, o = this._createToolBar(document, f ? e.buttonList : l.buttonList, e.plugins, e);
    o.pluginCallButtons.math && this._checkKatexMath(e.katex);
    const b = document.createElement("DIV");
    b.className = "se-arrow", f && (o.element.style.visibility = "hidden", u ? (e.toolbarContainer.appendChild(o.element), n.toolbar.parentElement.removeChild(n.toolbar)) : n.toolbar.parentElement.replaceChild(o.element, n.toolbar), n.toolbar = o.element, n._menuTray = o._menuTray, n._arrow = b);
    const c = this._initElements(e, n.topArea, f ? o.element : n.toolbar, b), g = c.bottomBar, k = c.wysiwygFrame, S = c.placeholder;
    let x = c.codeView;
    return n.resizingBar && ge.removeItem(n.resizingBar), g.resizingBar && (e.resizingBarContainer && e.resizingBarContainer !== l.resizingBarContainer ? e.resizingBarContainer.appendChild(g.resizingBar) : i.appendChild(g.resizingBar)), s.innerHTML = "", s.appendChild(x), S && s.appendChild(S), x = this._checkCodeMirror(e, x), n.resizingBar = g.resizingBar, n.navigation = g.navigation, n.charWrapper = g.charWrapper, n.charCounter = g.charCounter, n.wysiwygFrame = k, n.code = x, n.placeholder = S, e.rtl ? ge.addClass(n.topArea, "se-rtl") : ge.removeClass(n.topArea, "se-rtl"), {
  ...
  _initOptions: function(e, t) {
    ...
    if (t.plugins) {
      ...
      for (let f = 0, o = u.length, b; f < o; f++)
        b = u[f].default || u[f], l[b.name] = b;
    }
    t.plugins = l, t.strictMode = t.strictMode !== !1, t.strictHTMLValidation = t.strictHTMLValidation !== !1, t.lang = t.lang || Wi, t.value = typeof t.value == "string" ? t.value : null, t.allowedClassNames = new ge._w.RegExp((t.allowedClassNames && typeof t.allowedClassNames == "string" ? t.allowedClassNames + "|" : "") + "^__se__|se-|katex"), t.historyStackDelayTime = typeof t.historyStackDelayTime == "number" ? t.historyStackDelayTime : 400, t.frameAttrbutes = t.frameAttrbutes || {}, t.defaultTag = typeof t.defaultTag == "string" && t.defaultTag.length > 0 ? t.defaultTag : "p";
    const n = t.textTags = [{ bold: "STRONG", underline: "U", italic: "EM", strike: "DEL", sub: "SUB", sup: "SUP" }, t.textTags || {}].reduce(function(s, u) {
      for (let f in u)
        s[f] = u[f];
      return s;
    }, {});
    ...
    t.tagsBlacklist = t.tagsBlacklist || "", t._defaultTagsWhitelist = (typeof t._defaultTagsWhitelist == "string" ? t._defaultTagsWhitelist : i) + (t.__allowedScriptTag ? "|script" : ""), t._editorTagsWhitelist = t.addTagsWhitelist === "*" ? "*" : this._setWhitelist(t._defaultTagsWhitelist + (typeof t.addTagsWhitelist == "string" && t.addTagsWhitelist.length > 0 ? "|" + t.addTagsWhitelist : ""), t.tagsBlacklist), t.pasteTagsBlacklist = t.tagsBlacklist + (t.tagsBlacklist && t.pasteTagsBlacklist ? "|" + t.pasteTagsBlacklist : t.pasteTagsBlacklist || ""), t.pasteTagsWhitelist = t.pasteTagsWhitelist === "*" ? "*" : this._setWhitelist(typeof t.pasteTagsWhitelist == "string" ? t.pasteTagsWhitelist : t._editorTagsWhitelist, t.pasteTagsBlacklist), t.attributesWhitelist = !t.attributesWhitelist || typeof t.attributesWhitelist != "object" ? null : t.attributesWhitelist, t.attributesBlacklist = !t.attributesBlacklist || typeof t.attributesBlacklist != "object" ? null : t.attributesBlacklist, t.mode = t.mode || "classic", t.rtl = !!t.rtl, t.lineAttrReset = ["id"].concat(t.lineAttrReset && typeof t.lineAttrReset == "string" ? t.lineAttrReset.toLowerCase().split("|") : []), t._editableClass = "sun-editor-editable" + (t.rtl ? " se-rtl" : ""), t._printClass = typeof t._printClass == "string" ? t._printClass : null, t.toolbarWidth = t.toolbarWidth ? ge.isNumber(t.toolbarWidth) ? t.toolbarWidth + "px" : t.toolbarWidth : "auto", t.toolbarContainer = typeof t.toolbarContainer == "string" ? document.querySelector(t.toolbarContainer) : t.toolbarContainer, t.stickyToolbar = /balloon/i.test(t.mode) || t.toolbarContainer ? -1 : t.stickyToolbar === void 0 ? 0 : /^\d+/.test(t.stickyToolbar) ? ge.getNumber(t.stickyToolbar, 0) : -1, t.hideToolbar = !!t.hideToolbar, t.fullScreenOffset = t.fullScreenOffset === void 0 ? 0 : /^\d+/.test(t.fullScreenOffset) ? ge.getNumber(t.fullScreenOffset, 0) : 0, t.fullPage = !!t.fullPage, t.iframe = t.fullPage || !!t.iframe, t.iframeAttributes = t.iframeAttributes || {}, t.iframeCSSFileName = t.iframe ? typeof t.iframeCSSFileName == "string" ? [t.iframeCSSFileName] : t.iframeCSSFileName || ["suneditor"] : null, t.previewTemplate = typeof t.previewTemplate == "string" ? t.previewTemplate : null, t.printTemplate = typeof t.printTemplate == "string" ? t.printTemplate : null, t.codeMirror = t.codeMirror ? t.codeMirror.src ? t.codeMirror : { src: t.codeMirror } : null, t.katex = t.katex ? t.katex.src ? t.katex : { src: t.katex } : null, t.mathFontSize = t.mathFontSize ? t.mathFontSize : [
      ...
      ["fullScreen", "showBlocks", "codeView"],
      ["preview", "print"]
    ], t.rtl && (t.buttonList = t.buttonList.reverse()), t.icons = !t.icons || typeof t.icons != "object" ? pn : [pn, t.icons].reduce(function(s, u) {
      for (let f in u)
  ...
  _defaultButtons: function(e) {
    const t = e.icons, l = e.lang, n = ge.isOSX_IOS ? "⌘" : "CTRL", i = ge.isOSX_IOS ? "⇧" : "+SHIFT", s = e.shortcutsHint ? e.shortcutsDisable : ["bold", "strike", "underline", "italic", "undo", "indent", "save"], u = e.rtl ? ["[", "]"] : ["]", "["], f = e.rtl ? [t.outdent, t.indent] : [t.indent, t.outdent];
    return {
      /** default command */
      bold: ["", l.toolbar.bold + '<span class="se-shortcut">' + (s.indexOf("bold") > -1 ? "" : n + '+<span class="se-shortcut-key">B</span>') + "</span>", "bold", "", t.bold],
      underline: ["", l.toolbar.underline + '<span class="se-shortcut">' + (s.indexOf("underline") > -1 ? "" : n + '+<span class="se-shortcut-key">U</span>') + "</span>", "underline", "", t.underline],
      italic: ["", l.toolbar.italic + '<span class="se-shortcut">' + (s.indexOf("italic") > -1 ? "" : n + '+<span class="se-shortcut-key">I</span>') + "</span>", "italic", "", t.italic],
      strike: ["", l.toolbar.strike + '<span class="se-shortcut">' + (s.indexOf("strike") > -1 ? "" : n + i + '+<span class="se-shortcut-key">S</span>') + "</span>", "strike", "", t.strike],
      ...
      indent: ["", l.toolbar.indent + '<span class="se-shortcut">' + (s.indexOf("indent") > -1 ? "" : n + '+<span class="se-shortcut-key">' + u[0] + "</span>") + "</span>", "indent", "", f[0]],
      outdent: ["", l.toolbar.outdent + '<span class="se-shortcut">' + (s.indexOf("indent") > -1 ? "" : n + '+<span class="se-shortcut-key">' + u[1] + "</span>") + "</span>", "outdent", "", f[1]],
      ...
      undo: ["", l.toolbar.undo + '<span class="se-shortcut">' + (s.indexOf("undo") > -1 ? "" : n + '+<span class="se-shortcut-key">Z</span>') + "</span>", "undo", "", t.undo],
      redo: ["", l.toolbar.redo + '<span class="se-shortcut">' + (s.indexOf("undo") > -1 ? "" : n + '+<span class="se-shortcut-key">Y</span> / ' + n + i + '+<span class="se-shortcut-key">Z</span>') + "</span>", "redo", "", t.redo],
      ...
      save: ["se-resizing-enabled", l.toolbar.save + '<span class="se-shortcut">' + (s.indexOf("save") > -1 ? "" : n + '+<span class="se-shortcut-key">S</span>') + "</span>", "save", "", t.save],
      /** plugins - command */
   ...
   * @private
   */
  _createButton: function(e, t, l, n, i, s, u) {
    const f = ge.createElement("LI"), o = ge.createElement("BUTTON"), b = t || l;
    return o.setAttribute("type", "button"), o.setAttribute("class", "se-btn" + (e ? " " + e : "") + " se-tooltip"), o.setAttribute("data-command", l), o.setAttribute("data-display", n), o.setAttribute("aria-label", b.replace(/<span .+<\/span>/, "")), o.setAttribute("tabindex", "-1"), i || (i = '<span class="se-icon-text">!</span>'), /^default\./i.test(i) && (i = u[i.replace(/^default\./i, "")]), /^text\./i.test(i) && (i = i.replace(/^text\./i, ""), o.className += " se-btn-more-text"), i += '<span class="se-tooltip-inner"><span class="se-tooltip-text">' + b + "</span></span>", s && o.setAttribute("disabled", !0), o.innerHTML = i, f.appendChild(o), {
      li: f,
      button: o
    };
  },
  ...
  _createToolBar: function(e, t, l, n) {
    ...
    const f = n.icons, o = this._defaultButtons(n), b = {}, c = [];
      ...
      for (let p = 0, v, m, y, _, C; p < t.length; p++)
        if (v = !1, C = "", _ = t[p], S = this._createModuleGroup(), typeof _ == "object") {
          for (let w = 0, z; w < _.length; w++) {
            ...
            if (typeof k == "object")
              typeof k.add == "function" ? (L = k.name, g = o[L], l[L] = k) : (L = k.name, g = [k.buttonClass, k.title, k.name, k.dataDisplay, k.innerHTML, k._disabled]);
            else {
              if (/^\-/.test(k)) {
            ...
            x = this._createButton(g[0], g[1], g[2], g[3], g[4], g[5], f), (v ? m : S.ul).appendChild(x.li), l[L] && (b[L] = x.button), z && (v = !0, m = ge.createElement("DIV"), m.className = "se-more-layer " + y, m.innerHTML = '<div class="se-more-form"><ul class="se-menu-list"' + (C ? ' style="float: ' + C + ';"' : "") + "></ul></div>", r.appendChild(m), m = m.firstElementChild.firstElementChild);
          }
          if (a) {
    ...
    return h.className = "se-toolbar-cover", s.appendChild(h), n.hideToolbar && (s.style.display = "none"), {
      element: s,
      plugins: l,
      pluginCallButtons: b,
      responsiveButtons: c,
...
function Tr(e, t) {
  ...
  return {
    ...
    push: function(S) {
      ...
      if ((!x || o) && (l.clearTimeout(o), !x)) {
        k();
        return;
      }
      o = l.setTimeout(function() {
        l.clearTimeout(o), o = null, k();
      }, x);
    },
    /**
...
function Er(e, t, l, n, i, s) {
  const u = e.element.originElement.ownerDocument || document, f = u.defaultView || window, o = ge, b = i.icons, c = {
    ...
    _setMenuPosition: function(a, r) {
      ...
      if (i.rtl) {
        const N = a.offsetWidth, q = v > N ? v - N : 0, M = q > 0 ? 0 : N - v;
        r.style.left = m - q + M + "px", p.left > g._getEditorOffsets(r).left && (r.style.left = "0px");
      } else {
        const N = h <= v ? 0 : h - (m + v);
      ...
      if (B < z) {
        let N = -1 * (z - C + 3);
        const q = w - T + N, M = z + (q < 0 ? q : 0);
        M > B ? (r.style.height = M + "px", N = -1 * (M - C + 3)) : (r.style.height = B + "px", N = C + a.parentElement.offsetHeight), r.style.top = N + "px";
      } else
    ...
    getSelectedElements: function(a) {
      ...
      const B = z === T;
      for (let N = 0, q = v.length, M; N < q; N++) {
        if (M = v[N], m === M || !B && M === z) {
          _ = N;
          continue;
        }
    ...
    insertNode: function(a, r, d) {
      ...
      if (m && (C = r || o.isList(a) ? v.lastChild : v.nextElementSibling, w = o.isList(a) ? v : (C || v).parentNode), !r && (T || o.isComponent(a) || o.isMedia(a))) {
        const P = this.isEdgePoint(p.endContainer, p.endOffset, "end"), E = this.removeNode(), H = E.container, A = H === E.prevContainer && p.collapsed ? null : E.prevContainer;
        if (m && A)
          if (w = A.nodeType === 3 ? A.parentNode : A, w.contains(H)) {
            let $ = !0;
          ...
          const $ = o.getParentElement(H, (function(R) {
            return this.isRangeFormatElement(R) || this.isListCell(R);
          }).bind(o));
          if (r = o.splitElement(H, E.offset, $ ? o.getElementDepth($) + 1 : 0), !r)
            o.isListCell(v) || (C = r = v);
          else if (m) {
            if (v.contains(H)) {
              const R = o.isList(v.lastElementChild);
              let O = null;
              P || (O = v.cloneNode(!1), O.appendChild(r.textContent.trim() ? r : o.createTextNode(o.zeroWidthSpace))), R && (O || (O = v.cloneNode(!1), O.appendChild(o.createTextNode(o.zeroWidthSpace))), O.appendChild(v.lastElementChild)), O && (v.parentNode.insertBefore(O, v.nextElementSibling), C = r = O);
            }
          } else
            r = r.previousSibling;
        }
      ...
      const B = p.commonAncestorContainer, N = p.startOffset, q = p.endOffset, M = p.startContainer === B && o.isFormatElement(B), U = M && (B.childNodes[N] || B.childNodes[0]) || p.startContainer, D = M && (B.childNodes[q] || B.childNodes[B.childNodes.length - 1]) || p.endContainer;
      if (!m)
        if (r)
          y = r.parentNode, r = r.nextSibling, _ = !0;
        else if (y = U, U.nodeType === 3 && (y = U.parentNode), p.collapsed)
          if (B.nodeType === 3)
            B.textContent.length > q ? r = B.splitText(q) : r = B.nextSibling;
          else if (o.isBreak(y))
            r = y, y = y.parentNode;
          else {
          ...
          this.isEdgePoint(D, q) ? r = D.nextSibling : r = D.splitText(q);
          let E = U;
          this.isEdgePoint(U, N) || (E = U.splitText(N)), y.removeChild(E), y.childNodes.length === 0 && T && (y.innerHTML = "<br>");
        } else {
          const E = this.removeNode(), H = E.container, A = E.prevContainer;
          if (H && H.childNodes.length === 0 && T && (o.isFormatElement(H) ? H.innerHTML = "<br>" : o.isRangeFormatElement(H) && (H.innerHTML = "<" + i.defaultTag + "><br></" + i.defaultTag + ">")), o.isListCell(H) && a.nodeType === 3)
            ...
            if (y = A.nodeType === 3 ? A.parentNode : A, y.contains(H)) {
              let $ = !0;
              ...
              r = null;
          else o.isWysiwygDiv(H) && !o.isFormatElement(a) ? (y = H.appendChild(o.createElement(i.defaultTag)), r = null) : (r = T ? D : H === A ? H.nextSibling : H, y = !r || !r.parentNode ? B : r.parentNode);
      ...
      try {
        if (!m) {
          if ((o.isWysiwygDiv(r) || y === e.element.wysiwyg.parentNode) && (y = e.element.wysiwyg, r = null), o.isFormatElement(a) || o.isRangeFormatElement(a) || !o.isListCell(y) && o.isComponent(a)) {
            ...
            if (o.isList(r))
              ...
              const E = this.removeNode(), H = E.container.nodeType === 3 ? o.isListCell(o.getFormatElement(E.container, null)) ? E.container : o.getFormatElement(E.container, null) || E.container.parentNode : E.container, A = o.isWysiwygDiv(H) || o.isRangeFormatElement(H);
              y = A ? H : H.parentNode, r = A ? null : H.nextSibling;
            }
        ...
        if (P.length > 0)
          for (let E = 0, H = P.length, A, $, R, O; E < H; E++) {
            for (A = P[E], R = A.childNodes, O = A.parentNode; R[0]; )
              $ = R[0], O.insertBefore($, A);
            A === a && (a = $), o.removeItem(A);
          }
        if ((o.isFormatElement(a) || o.isComponent(a)) && U === D) {
    ...
    removeNode: function() {
      ...
      if (a.startContainer === a.endContainer) {
        ...
        if (E) {
          const H = o.createElement("BR"), A = o.createElement(i.defaultTag);
          return A.appendChild(H), o.changeElement(E, A), c.setRange(A, 0, A, 0), this.history.push(!0), {
            container: A,
            offset: 0,
            prevContainer: null
          };
      ...
      let B = null, N = null;
      const q = o.getListChildNodes(T, null);
      let M = o.getArrayIndex(q, _), U = o.getArrayIndex(q, C);
      if (q.length > 0 && M > -1 && U > -1) {
        for (let E = M + 1, H = _; E >= 0; E--)
          q[E] === H.parentNode && q[E].firstChild === H && w === 0 && (M = E, H = H.parentNode);
        for (let E = U - 1, H = C; E > M; E--)
          q[E] === H.parentNode && q[E].nodeType === 1 && (q.splice(E, 1), H = H.parentNode, --U);
      } else {
        if (q.length === 0) {
          ...
          q.push(T), _ = C = T;
        } else if (_ = C = q[0], o.isBreak(_) || o.onlyZeroWidthSpace(_))
          return {
      ...
      const D = o.getParentElement(C, "ul"), P = o.getParentElement(_, "li");
      if (D && P && P.contains(D) ? (m = D.previousSibling, y = m.textContent.length) : (m = C && C.parentNode ? C : _ && _.parentNode ? _ : a.endContainer || a.startContainer, y = !r && !d ? y : d ? m.textContent.length : 0), !o.isWysiwygDiv(m) && m.childNodes.length === 0) {
    ...
    applyRangeFormatElement: function(a) {
      ...
      e:
        for (let z = 0, T = r.length, B, N, q, M, U, D; z < T; z++)
          if (B = r[z], !!o.isListCell(B) && (N = B.lastElementChild, N && o.isListCell(B.nextElementSibling) && r.indexOf(B.nextElementSibling) > -1 && (M = N.lastElementChild, r.indexOf(M) > -1))) {
            let P = null;
            for (; P = M.lastElementChild; )
              if (o.isList(P))
                if (r.indexOf(P.lastElementChild) > -1)
                  M = P.lastElementChild;
                else
                  continue e;
            q = N.firstElementChild, U = r.indexOf(q), D = r.indexOf(M), r.splice(U, D - U + 1), T = r.length;
            continue;
          }
      ...
      for (let z = 0, T = r.length, B, N, q, M, U, D, P; z < T; z++)
        if (B = r[z], N = B.parentNode, !(!N || a.contains(N)))
          if (q = o.getElementDepth(B), o.isList(N)) {
            if (y === null && (D ? (y = D, P = !0, D = null) : y = N.cloneNode(!1)), _.push(B), U = r[z + 1], z === T - 1 || U && U.parentNode !== N) {
              U && B.contains(U.parentNode) && (D = U.parentNode.cloneNode(!1));
              let E = N.parentNode, H;
              for (; o.isList(E); )
                H = o.createElement(E.nodeName), H.appendChild(y), y = H, E = E.parentNode;
              const A = this.detachRangeFormatElement(N, _, null, !0, !0);
              m >= q ? (m = q, v = A.cc, p = C(v, N, A.ec), p && (v = p.parentNode)) : v === A.cc && (p = A.ec), v !== A.cc && (M = C(v, A.cc, M), M !== void 0 ? p = M : p = A.cc);
              for (let $ = 0, R = A.removeArray.length; $ < R; $++)
                y.appendChild(A.removeArray[$]);
              P || a.appendChild(y), D && A.removeArray[A.removeArray.length - 1].appendChild(D), y = null, P = !1;
            }
          } else
            m >= q && (m = q, v = N, p = B.nextSibling), a.appendChild(B), v !== N && (M = C(v, N), M !== void 0 && (p = M));
    ...
    detachRangeFormatElement: function(a, r, d, h, p) {
      ...
      let m = v.startOffset, y = v.endOffset, _ = o.getListChildNodes(a, function(A) {
        return A.parentNode === a;
      }), C = a.parentNode, w = null, z = null, T = a.cloneNode(!1);
      const B = [], N = o.isList(d);
      let q = !1, M = !1, U = !1;
      function D(A, $, R, O) {
        if (o.onlyZeroWidthSpace($) && ($.innerHTML = o.zeroWidthSpace, m = y = 1), $.nodeType === 3)
          return A.insertBefore($, R), $;
        const W = (U ? $ : O).childNodes;
        let Z = $.cloneNode(!1), te = null, X = null;
        for (; W[0]; )
          X = W[0], o._notTextNode(X) && !o.isBreak(X) && !o.isListCell(Z) ? (Z.childNodes.length > 0 && (te || (te = Z), A.insertBefore(Z, R), Z = $.cloneNode(!1)), A.insertBefore(X, R), te || (te = X)) : Z.appendChild(X);
        if (Z.childNodes.length > 0) {
          if (o.isListCell(A) && o.isListCell(Z) && o.isList(R))
            if (N) {
              ...
              const Q = O.nextElementSibling, ne = o.detachNestedList(O, !1);
              if (a !== ne || Q !== O.nextElementSibling) {
                const fe = Z.childNodes;
                for (; fe[0]; )
                  O.appendChild(fe[0]);
                a = ne, M = !0;
              }
      ...
      for (let A = 0, $ = _.length, R, O, W; A < $; A++)
        if (R = _[A], !(R.nodeType === 3 && o.isList(T)))
          if (U = !1, h && A === 0 && (!r || r.length === $ || r[0] === R ? w = a.previousSibling : w = T), r && (O = r.indexOf(R)), r && O === -1)
            T || (T = a.cloneNode(!1)), T.appendChild(R);
          else {
            if (r && (W = r[O + 1]), T && T.children.length > 0 && (C.insertBefore(T, a), T = null), !N && o.isListCell(R))
              if (W && o.getElementDepth(R) !== o.getElementDepth(W) && (o.isListCell(C) || o.getArrayItem(R.children, o.isList, !1))) {
                const Z = R.nextElementSibling, te = o.detachNestedList(R, !1);
                (a !== te || Z !== R.nextElementSibling) && (a = te, M = !0);
              } else {
                const Z = R;
                R = o.createElement(h ? Z.nodeName : o.isList(a.parentNode) || o.isListCell(a.parentNode) ? "LI" : o.isCell(a.parentNode) ? "DIV" : i.defaultTag);
                const te = o.isListCell(R), X = Z.childNodes;
                for (; X[0] && !(o.isList(X[0]) && !te); )
                  R.appendChild(X[0]);
                o.copyFormatAttributes(R, Z), U = !0;
              }
            else
              R = R.cloneNode(!1);
            if (!M && (h ? (B.push(R), o.removeItem(_[A])) : (d ? (q || (C.insertBefore(d, a), q = !0), R = D(d, R, null, _[A])) : R = D(C, R, a, _[A]), M || (r ? (z = R, w || (w = R)) : w || (w = z = R))), M)) {
              M = U = !1, _ = o.getListChildNodes(a, function(Z) {
                return Z.parentNode === a;
              }), T = a.cloneNode(!1), C = a.parentNode, A = -1, $ = _.length;
              continue;
            }
          }
      ...
      if (h)
        ...
        w || (w = z), z || (z = w);
        const A = o.getEdgeChildNodes(w, z.parentNode ? w : z);
        H = {
    ...
    nodeChange: function(a, r, d, h) {
      ...
      if (p.collapsed && !m && y.nodeType === 1 && !o.isBreak(y) && !o.isComponent(y)) {
        ...
        y.insertBefore(ne, X), this.setRange(ne, 1, ne, 1), p = this.getRange(), y = p.startContainer, _ = p.startOffset, C = p.endContainer, w = p.endOffset;
      }
      ...
      if (!m && y === C && !d && a) {
        let X = y, Q = 0;
        const ne = [], fe = a.style;
        for (let se = 0, ve = fe.length; se < ve; se++)
          ne.push(fe[se]);
        const re = a.classList;
        for (let se = 0, ve = re.length; se < ve; se++)
          ne.push("." + re[se]);
        if (ne.length > 0) {
          for (; !o.isFormatElement(X) && !o.isWysiwygDiv(X); ) {
            for (let se = 0; se < ne.length; se++)
              if (X.nodeType === 1) {
                const ve = ne[se], me = /^\./.test(ve) ? new z("\\s*" + ve.replace(/^\./, "") + "(\\s+|$)", "ig") : !1, Ne = v ? !!X.style[ve] : !!X.style[ve] && !!a.style[ve] && X.style[ve] === a.style[ve], Ce = me === !1 ? !1 : v ? !!X.className.match(me) : !!X.className.match(me) && !!a.className.match(me);
                (Ne || Ce) && Q++;
              }
            X = X.parentNode;
          }
      ...
      if (r) {
        for (let X = 0, Q = r.length, ne; X < Q; X++)
          ne = r[X], /^\./.test(ne) ? U += (U ? "|" : "\\s*(?:") + ne.replace(/^\./, "") : M += (M ? "|" : "(?:;|^|\\s)(?:") + ne;
        M && (M += ")\\s*:[^;]*\\s*(?:;|$)", M = new z(M, "ig")), U && (U += ")(?=\\s+|$)", U = new z(U, "ig"));
      }
      if (d) {
        D = "^(?:" + d[0];
      ...
      const P = f.Boolean, E = { v: !1 }, H = function(X) {
        const Q = X.cloneNode(!1);
        if (Q.nodeType === 3 || o.isBreak(Q)) return Q;
        if (m) return null;
        const ne = !D && v || D && D.test(Q.nodeName);
        if (ne && !h)
          return E.v = !0, null;
        const fe = Q.style.cssText;
        let re = "";
        M && fe.length > 0 && (re = fe.replace(M, "").trim(), re !== fe && (E.v = !0));
        const se = Q.className;
        let ve = "";
        return U && se.length > 0 && (ve = se.replace(U, "").trim(), ve !== se && (E.v = !0)), v && (U || !se) && (M || !fe) && !re && !ve && ne ? (E.v = !0, null) : re || ve || Q.nodeName !== T || P(M) !== P(fe) || P(U) !== P(se) ? (M && fe.length > 0 && (Q.style.cssText = re), Q.style.cssText || Q.removeAttribute("style"), U && se.length > 0 && (Q.className = ve.trim()), Q.className.trim() || Q.removeAttribute("class"), !Q.style.cssText && !Q.className && (Q.nodeName === T || ne) ? (E.v = !0, null) : Q) : (E.v = !0, null);
      }, A = this.getSelectedElements(null);
      p = this.getRange(), y = p.startContainer, _ = p.startOffset, C = p.endContainer, w = p.endOffset, o.getFormatElement(y, null) || (y = o.getChildElement(A[0], function(X) {
        return X.nodeType === 3;
      }, !1), _ = 0), o.getFormatElement(C, null) || (C = o.getChildElement(A[A.length - 1], function(X) {
        return X.nodeType === 3;
      }, !1), w = C.textContent.length);
      const $ = o.getFormatElement(y, null) === o.getFormatElement(C, null), R = A.length - ($ ? 0 : 1);
      q = a.cloneNode(!1);
      const O = m || v && (function(X) {
        for (let Q = 0, ne = X.length; Q < ne; Q++)
          if (o._isMaintainedNode(X[Q]) || o._isSizeNode(X[Q])) return !0;
        return !1;
      })(d), W = v || o._isSizeNode(q), Z = this._util_getMaintainedNode.bind(o, O, W), te = this._util_isMaintainedNode.bind(o, O, W);
      if ($) {
        this._resetCommonListCell(A[0], r) && (p = this.setRange(y, _, C, w));
        const X = this._nodeChange_oneLine(A[0], q, H, y, _, C, w, m, v, p.collapsed, E, Z, te);
        B.container = X.startContainer, B.offset = X.startOffset, N.container = X.endContainer, N.offset = X.endOffset, B.container === N.container && o.onlyZeroWidthSpace(B.container) && (B.offset = N.offset = 1), this._setCommonListStyle(X.ancestor, null);
      } else {
        let X = !1;
        R > 0 && this._resetCommonListCell(A[R], r) && (X = !0), this._resetCommonListCell(A[0], r) && (X = !0), X && this.setRange(y, _, C, w), R > 0 && (q = a.cloneNode(!1), N = this._nodeChange_endLine(A[R], q, H, C, w, m, v, E, Z, te));
        for (let Q = R - 1, ne; Q > 0; Q--)
          this._resetCommonListCell(A[Q], r), q = a.cloneNode(!1), ne = this._nodeChange_middleLine(A[Q], q, H, m, v, E, N.container), ne.endContainer && ne.ancestor.contains(ne.endContainer) && (N.ancestor = null, N.container = ne.endContainer), this._setCommonListStyle(ne.ancestor, null);
        q = a.cloneNode(!1), B = this._nodeChange_startLine(A[0], q, H, y, _, m, v, E, Z, te, N.container), B.endContainer && (N.ancestor = null, N.container = B.endContainer), R <= 0 ? N = B : N.container || (N.ancestor = null, N.container = B.container, N.offset = B.container.textContent.length), this._setCommonListStyle(B.ancestor, null), this._setCommonListStyle(N.ancestor || o.getFormatElement(N.container), null);
      }
    ...
    _resetCommonListCell: function(a, r) {
      ...
      for (let z = 0, T = d.length, B, N; z < T; z++)
        B = d[z], !i._textTagsMap[B.nodeName.toLowerCase()] && (N = o.getValues(B.style), N.length === 0 || p.some(function(q) {
    ...
    _nodeChange_oneLine: function(a, r, d, h, p, v, m, y, _, C, w, z, T) {
      ...
      if (!_ && B === v.parentNode && B.nodeName === r.nodeName && o.onlyZeroWidthSpace(h.textContent.slice(0, p)) && o.onlyZeroWidthSpace(v.textContent.slice(m))) {
        ...
        let ce = !0;
        for (let Be = 0, Ge = Ce.length, Fe, Je, Ue, Te; Be < Ge; Be++) {
          if (Fe = Ce[Be], Te = !o.onlyZeroWidthSpace(Fe), Fe === h) {
            Je = !0;
            continue;
          }
          if (Fe === v) {
      ...
      w.v = !1;
      const N = a, q = [r], M = a.cloneNode(!1), U = h === v;
      let D = h, P = p, E = v, H = m, A = !1, $ = !1, R, O, W, Z, te;
      const X = f.RegExp;
      function Q(Ce) {
        const ce = new X("(?:;|^|\\s)(?:" + Z + "null)\\s*:[^;]*\\s*(?:;|$)", "ig");
        let Be = "";
        return ce && Ce.style.cssText.length > 0 && (Be = ce.test(Ce.style.cssText)), !Be;
      }
      if ((function Ce(ce, Be) {
        const Ge = ce.childNodes;
        for (let Fe = 0, Je = Ge.length, Ue; Fe < Je; Fe++) {
          ...
          if (!A && Te === D) {
            let Pe = M;
            te = z(Te);
            const Ie = o.createTextNode(D.nodeType === 1 ? "" : D.substringData(0, P)), Oe = o.createTextNode(
              D.nodeType === 1 ? "" : D.substringData(
                P,
                U && H >= P ? H - P : D.data.length - P
              )
            );
            if (te) {
              const _t = z(Be);
              if (_t && _t.parentNode !== Pe) {
                let Qe = _t, Tt = null;
                for (; Qe.parentNode !== Pe; ) {
                  for (Be = Tt = Qe.parentNode.cloneNode(!1); Qe.childNodes[0]; )
                    Tt.appendChild(Qe.childNodes[0]);
                  Qe.appendChild(Tt), Qe = Qe.parentNode;
                }
                Qe.parentNode.appendChild(_t);
              }
              te = te.cloneNode(!1);
            }
            o.onlyZeroWidthSpace(Ie) || Be.appendChild(Ie);
            const Ve = z(Be);
            for (Ve && (te = Ve), te && (Pe = te), O = Te, R = [], Z = ""; O !== Pe && O !== N && O !== null; )
              Ue = T(O) ? null : d(O), Ue && O.nodeType === 1 && Q(O) && (R.push(Ue), Z += O.style.cssText.substr(0, O.style.cssText.indexOf(":")) + "|"), O = O.parentNode;
            const Ct = R.pop() || Oe;
            for (W = O = Ct; R.length > 0; )
              O = R.pop(), W.appendChild(O), W = O;
            if (r.appendChild(Ct), Pe.appendChild(r), te && !z(E) && (r = r.cloneNode(!1), M.appendChild(r), q.push(r)), D = Oe, P = 0, A = !0, O !== Oe && O.appendChild(D), !U) continue;
          }
          if (!$ && Te === E) {
            te = z(Te);
            const Pe = o.createTextNode(E.nodeType === 1 ? "" : E.substringData(H, E.length - H)), Ie = o.createTextNode(U || E.nodeType === 1 ? "" : E.substringData(0, H));
            if (te ? te = te.cloneNode(!1) : T(r.parentNode) && !te && (r = r.cloneNode(!1), M.appendChild(r), q.push(r)), !o.onlyZeroWidthSpace(Pe)) {
              O = Te, Z = "", R = [];
              const Ve = [];
              for (; O !== M && O !== N && O !== null; )
                O.nodeType === 1 && Q(O) && (T(O) ? Ve.push(O.cloneNode(!1)) : R.push(O.cloneNode(!1)), Z += O.style.cssText.substr(0, O.style.cssText.indexOf(":")) + "|"), O = O.parentNode;
              for (R = R.concat(Ve), et = W = O = R.pop() || Pe; R.length > 0; )
                O = R.pop(), W.appendChild(O), W = O;
              M.appendChild(et), O.textContent = Pe.data;
            }
            if (te && et) {
              const Ve = z(et);
              Ve && (te = Ve);
            }
            for (O = Te, R = [], Z = ""; O !== M && O !== N && O !== null; )
              Ue = T(O) ? null : d(O), Ue && O.nodeType === 1 && Q(O) && (R.push(Ue), Z += O.style.cssText.substr(0, O.style.cssText.indexOf(":")) + "|"), O = O.parentNode;
            const Oe = R.pop() || Ie;
            for (W = O = Oe; R.length > 0; )
              O = R.pop(), W.appendChild(O), W = O;
            te ? (r = r.cloneNode(!1), r.appendChild(Oe), te.insertBefore(r, te.firstChild), M.appendChild(te), q.push(r), te = null) : r.appendChild(Oe), E = Ie, H = Ie.data.length, $ = !0, !y && C && (r = Ie, Ie.textContent = o.zeroWidthSpace), O !== Ie && O.appendChild(E);
            continue;
          }
          if (A) {
            if (Te.nodeType === 1 && !o.isBreak(Te)) {
              o._isIgnoreNodeChange(Te) ? (M.appendChild(Te.cloneNode(!0)), C || (r = r.cloneNode(!1), M.appendChild(r), q.push(r))) : Ce(Te, Te);
              continue;
            }
            O = Te, R = [], Z = "";
            const Pe = [];
            for (; O.parentNode !== null && O !== N && O !== r; )
              Ue = $ ? O.cloneNode(!1) : d(O), O.nodeType === 1 && !o.isBreak(Te) && Ue && Q(O) && (T(O) ? te || Pe.push(Ue) : R.push(Ue), Z += O.style.cssText.substr(0, O.style.cssText.indexOf(":")) + "|"), O = O.parentNode;
            R = R.concat(Pe);
            const Ie = R.pop() || Te;
            for (W = O = Ie; R.length > 0; )
              O = R.pop(), W.appendChild(O), W = O;
            if (T(r.parentNode) && !T(Ie) && !o.onlyZeroWidthSpace(r) && (r = r.cloneNode(!1), M.appendChild(r), q.push(r)), !$ && !te && T(Ie)) {
              r = r.cloneNode(!1);
              const Oe = Ie.childNodes;
              for (let Ve = 0, Ct = Oe.length; Ve < Ct; Ve++)
                r.appendChild(Oe[Ve]);
              Ie.appendChild(r), M.appendChild(Ie), q.push(r), r.children.length > 0 ? Be = O : Be = r;
            } else Ie === Te ? $ ? Be = M : Be = r : $ ? (M.appendChild(Ie), Be = O) : (r.appendChild(Ie), Be = O);
            if (te && Te.nodeType === 3)
              if (z(Te)) {
                const Oe = o.getParentElement(Be, (function(Ve) {
                  return this._isMaintainedNode(Ve.parentNode) || Ve.parentNode === M;
                }).bind(o));
                te.appendChild(Oe), r = Oe.cloneNode(!1), q.push(r), M.appendChild(r);
              } else
                te = null;
          }
          et = Te.cloneNode(!1), Be.appendChild(et), Te.nodeType === 1 && !o.isBreak(Te) && (Ht = et), Ce(Te, Ht);
        }
      })(a, M), _ && !y && !w.v)
        return {
          ancestor: a,
      ...
      if (y = y && _, y)
        for (let Ce = 0; Ce < q.length; Ce++) {
          let ce = q[Ce], Be, Ge, Fe;
          if (C)
            Be = o.createTextNode(o.zeroWidthSpace), M.replaceChild(Be, ce);
          else {
            const Je = ce.childNodes;
            for (Ge = Je[0]; Je[0]; )
              Fe = Je[0], M.insertBefore(Fe, ce);
            o.removeItem(ce);
          }
          Ce === 0 && (C ? D = E = Be : (D = Ge, E = Fe));
        }
      else {
        if (_)
          for (let Ce = 0; Ce < q.length; Ce++)
            this._stripRemoveNode(q[Ce]);
        C && (D = E = r);
      }
      o.removeEmptyNode(M, r, !1), C && (P = D.textContent.length, H = E.textContent.length);
      const ne = y || E.textContent.length === 0;
      !o.isBreak(E) && E.textContent.length === 0 && (o.removeItem(E), E = D), H = ne ? E.textContent.length : H;
      const fe = { s: 0, e: 0 }, re = o.getNodePath(D, M, fe), se = !E.parentNode;
      se && (E = D);
      const ve = { s: 0, e: 0 }, me = o.getNodePath(E, M, !se && !ne ? ve : null);
      P += fe.s, H = C ? P : se ? D.textContent.length : ne ? H + fe.s : H + ve.s;
      const Ne = o.mergeSameTags(M, [re, me], !0);
      return a.parentNode.replaceChild(M, a), D = o.getNodeFromPath(re, M), E = o.getNodeFromPath(me, M), {
        ancestor: M,
        startContainer: D,
        startOffset: P + Ne[0],
        endContainer: E,
    ...
    _nodeChange_startLine: function(a, r, d, h, p, v, m, y, _, C, w) {
      ...
      if (!m && z.nodeName === r.nodeName && !o.isFormatElement(z) && !z.nextSibling && o.onlyZeroWidthSpace(h.textContent.slice(0, p))) {
        let A = !0, $ = h.previousSibling;
        for (; $; ) {
          if (!o.onlyZeroWidthSpace($)) {
            A = !1;
            break;
          }
          $ = $.previousSibling;
      ...
      let q = h, M = p, U = !1, D, P, E, H;
      if ((function A($, R) {
        const O = $.childNodes;
        for (let W = 0, Z = O.length, te, X; W < Z; W++) {
          const Q = O[W];
          if (!Q) continue;
          let ne = R;
          if (U && !o.isBreak(Q)) {
            if (Q.nodeType === 1) {
              if (o._isIgnoreNodeChange(Q)) {
                if (r = r.cloneNode(!1), X = Q.cloneNode(!0), N.appendChild(X), N.appendChild(r), B.push(r), w && Q.contains(w)) {
                  const ve = o.getNodePath(w, Q);
                  w = o.getNodeFromPath(ve, X);
                }
              } else
                A(Q, Q);
              continue;
            ...
            for (; P.parentNode !== null && P !== T && P !== r; )
              te = d(P), P.nodeType === 1 && te && (C(P) ? H || fe.push(te) : D.push(te)), P = P.parentNode;
            D = D.concat(fe);
            const re = D.length > 0, se = D.pop() || Q;
            for (E = P = se; D.length > 0; )
              P = D.pop(), E.appendChild(P), E = P;
            if (C(r.parentNode) && !C(se) && (r = r.cloneNode(!1), N.appendChild(r), B.push(r)), !H && C(se)) {
              r = r.cloneNode(!1);
              const ve = se.childNodes;
              for (let me = 0, Ne = ve.length; me < Ne; me++)
                r.appendChild(ve[me]);
              se.appendChild(r), N.appendChild(se), R = C(P) ? r : P, B.push(r);
            } else re ? (r.appendChild(se), R = P) : R = r;
            if (H && Q.nodeType === 3)
              if (_(Q)) {
                const ve = o.getParentElement(R, (function(me) {
                  return this._isMaintainedNode(me.parentNode) || me.parentNode === N;
                }).bind(o));
                H.appendChild(ve), r = ve.cloneNode(!1), B.push(r), N.appendChild(r);
              } else
                H = null;
          }
          if (!U && Q === q) {
            let fe = N;
            H = _(Q);
            const re = o.createTextNode(q.nodeType === 1 ? "" : q.substringData(0, M)), se = o.createTextNode(q.nodeType === 1 ? "" : q.substringData(M, q.length - M));
            if (H) {
              const Ne = _(R);
              if (Ne && Ne.parentNode !== fe) {
                let Ce = Ne, ce = null;
                for (; Ce.parentNode !== fe; ) {
                  for (R = ce = Ce.parentNode.cloneNode(!1); Ce.childNodes[0]; )
                    ce.appendChild(Ce.childNodes[0]);
                  Ce.appendChild(ce), Ce = Ce.parentNode;
                }
                Ce.parentNode.appendChild(Ne);
              }
              H = H.cloneNode(!1);
            }
            o.onlyZeroWidthSpace(re) || R.appendChild(re);
            const ve = _(R);
            for (ve && (H = ve), H && (fe = H), P = R, D = []; P !== fe && P !== null; )
              te = d(P), P.nodeType === 1 && te && D.push(te), P = P.parentNode;
            const me = D.pop() || R;
            for (E = P = me; D.length > 0; )
              P = D.pop(), E.appendChild(P), E = P;
            me !== R ? (r.appendChild(me), R = P) : R = r, o.isBreak(Q) && r.appendChild(Q.cloneNode(!1)), fe.appendChild(r), q = se, M = 0, U = !0, R.appendChild(q);
            continue;
          }
          te = U ? d(Q) : Q.cloneNode(!1), te && (R.appendChild(te), Q.nodeType === 1 && !o.isBreak(Q) && (ne = te)), A(Q, ne);
        }
      })(a, N), m && !v && !y.v)
        return {
          ancestor: a,
      ...
      if (v = v && m, v)
        for (let A = 0; A < B.length; A++) {
          let $ = B[A];
          const R = $.childNodes, O = R[0];
          for (; R[0]; )
            N.insertBefore(R[0], $);
          o.removeItem($), A === 0 && (q = O);
        }
      else if (m) {
        r = r.firstChild;
        for (let A = 0; A < B.length; A++)
          this._stripRemoveNode(B[A]);
      }
      if (!v && N.childNodes.length === 0)
        a.childNodes ? q = a.childNodes[0] : (q = o.createTextNode(o.zeroWidthSpace), a.appendChild(q));
      else {
        o.removeEmptyNode(N, r, !1), o.onlyZeroWidthSpace(N.textContent) && (q = N.firstChild, M = 0);
        const A = { s: 0, e: 0 }, $ = o.getNodePath(q, N, A);
        M += A.s;
        const R = o.mergeSameTags(N, [$], !0);
        a.parentNode.replaceChild(N, a), q = o.getNodeFromPath($, N), M += R[0];
      }
      return {
        ancestor: N,
        container: q,
    ...
    _nodeChange_middleLine: function(a, r, d, h, p, v, m) {
      if (!p) {
        ...
        let q = z.childNodes, M = 0, U = q.length;
        for (let D; M < U && (D = q[M], D.nodeType !== 3); M++)
          if (D.nodeName === T)
            D.style.cssText += B, o.addClass(D, N);
          else {
            if (!o.isBreak(D) && o._isIgnoreNodeChange(D))
              continue;
            if (U === 1) {
              q = D.childNodes, U = q.length, M = -1;
              continue;
            } else
              break;
          }
      ...
      if ((function w(z, T) {
        ...
        for (let N = 0, q = B.length, M, U; N < q; N++) {
          let D = B[N];
          if (!D) continue;
          let P = T;
          if (!o.isBreak(D) && o._isIgnoreNodeChange(D)) {
            if (r.childNodes.length > 0 && (y.appendChild(r), r = r.cloneNode(!1)), U = D.cloneNode(!0), y.appendChild(U), y.appendChild(r), _.push(r), T = r, m && D.contains(m)) {
              const E = o.getNodePath(m, D);
              m = o.getNodeFromPath(E, U);
            }
            continue;
          } else
            M = d(D), M && (C = !1, T.appendChild(M), D.nodeType === 1 && (P = M));
          o.isBreak(D) || w(D, P);
        }
    ...
    _nodeChange_endLine: function(a, r, d, h, p, v, m, y, _, C) {
      ...
      let N = h, q = p, M = !1, U, D, P, E;
      if ((function H(A, $) {
        const R = A.childNodes;
        for (let O = R.length - 1, W; 0 <= O; O--) {
          const Z = R[O];
          if (!Z) continue;
          let te = $;
          if (M && !o.isBreak(Z)) {
            if (Z.nodeType === 1) {
              if (o._isIgnoreNodeChange(Z)) {
                r = r.cloneNode(!1);
                const fe = Z.cloneNode(!0);
                B.insertBefore(fe, $), B.insertBefore(r, fe), T.push(r);
              } else
                H(Z, Z);
              continue;
            }
            D = Z, U = [];
            const X = [];
            for (; D.parentNode !== null && D !== z && D !== r; )
              W = d(D), W && D.nodeType === 1 && (C(D) ? E || X.push(W) : U.push(W)), D = D.parentNode;
            U = U.concat(X);
            const Q = U.length > 0, ne = U.pop() || Z;
            for (P = D = ne; U.length > 0; )
              D = U.pop(), P.appendChild(D), P = D;
            if (C(r.parentNode) && !C(ne) && (r = r.cloneNode(!1), B.insertBefore(r, B.firstChild), T.push(r)), !E && C(ne)) {
              r = r.cloneNode(!1);
              const fe = ne.childNodes;
              for (let re = 0, se = fe.length; re < se; re++)
                r.appendChild(fe[re]);
              ne.appendChild(r), B.insertBefore(ne, B.firstChild), T.push(r), r.children.length > 0 ? $ = D : $ = r;
            } else Q ? (r.insertBefore(ne, r.firstChild), $ = D) : $ = r;
            if (E && Z.nodeType === 3)
              if (_(Z)) {
                const fe = o.getParentElement($, (function(re) {
                  return this._isMaintainedNode(re.parentNode) || re.parentNode === B;
                }).bind(o));
                E.appendChild(fe), r = fe.cloneNode(!1), T.push(r), B.insertBefore(r, B.firstChild);
              } else
                E = null;
          }
          if (!M && Z === N) {
            E = _(Z);
            const X = o.createTextNode(N.nodeType === 1 ? "" : N.substringData(q, N.length - q)), Q = o.createTextNode(N.nodeType === 1 ? "" : N.substringData(0, q));
            if (E) {
              E = E.cloneNode(!1);
              const fe = _($);
              if (fe && fe.parentNode !== B) {
                let re = fe, se = null;
                for (; re.parentNode !== B; ) {
                  for ($ = se = re.parentNode.cloneNode(!1); re.childNodes[0]; )
                    se.appendChild(re.childNodes[0]);
                  re.appendChild(se), re = re.parentNode;
                }
                re.parentNode.insertBefore(fe, re.parentNode.firstChild);
              }
              E = E.cloneNode(!1);
            } else C(r.parentNode) && !E && (r = r.cloneNode(!1), B.appendChild(r), T.push(r));
            for (o.onlyZeroWidthSpace(X) || $.insertBefore(X, $.firstChild), D = $, U = []; D !== B && D !== null; )
              W = C(D) ? null : d(D), W && D.nodeType === 1 && U.push(W), D = D.parentNode;
            const ne = U.pop() || $;
            for (P = D = ne; U.length > 0; )
              D = U.pop(), P.appendChild(D), P = D;
            ne !== $ ? (r.insertBefore(ne, r.firstChild), $ = D) : $ = r, o.isBreak(Z) && r.appendChild(Z.cloneNode(!1)), E ? (E.insertBefore(r, E.firstChild), B.insertBefore(E, B.firstChild), E = null) : B.insertBefore(r, B.firstChild), N = Q, q = Q.data.length, M = !0, $.insertBefore(N, $.firstChild);
            continue;
          }
          W = M ? d(Z) : Z.cloneNode(!1), W && ($.insertBefore(W, $.firstChild), Z.nodeType === 1 && !o.isBreak(Z) && (te = W)), H(Z, te);
        }
      })(a, B), m && !v && !y.v)
        return {
          ancestor: a,
      ...
      if (v = v && m, v)
        for (let H = 0; H < T.length; H++) {
          ...
          let R = null;
          for (; $[0]; )
            R = $[0], B.insertBefore(R, A);
          o.removeItem(A), H === T.length - 1 && (N = R, q = R.textContent.length);
        }
      else if (m) {
        r = r.firstChild;
        for (let H = 0; H < T.length; H++)
      ...
      if (!v && B.childNodes.length === 0)
        ...
        o.removeEmptyNode(B, r, !1), o.onlyZeroWidthSpace(B.textContent) ? (N = B.firstChild, q = N.textContent.length) : o.onlyZeroWidthSpace(N) && (N = r, q = 1);
        const H = { s: 0, e: 0 }, A = o.getNodePath(N, B, H);
        q += H.s;
        const $ = o.mergeSameTags(B, [A], !0);
        a.parentNode.replaceChild(B, a), N = o.getNodeFromPath(A, B), q += $[0];
      }
      return {
        ancestor: B,
        container: N,
        offset: N.nodeType === 1 && q === 1 ? N.childNodes.length : q
      };
    },
    /**
...
` + a + `</body>
    ...
    preview: function() {
      ...
      if (i.iframe) {
        ...
        for (let m = 0, y = p.length; m < y; m++)
          v += p[m].outerHTML;
        r.document.write(
          '<!DOCTYPE html><html><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"><title>' + n.toolbar.preview + "</title>" + v + '</head><body class="' + (i._printClass !== null ? i._printClass : i._editableClass) + '" style="margin:10px auto !important; height:auto !important; outline:1px dashed #ccc;">' + a + "</body></html>"
        );
      }
    },
    /**
    ...
    setDir: function(a) {
      ...
      const v = e.tool;
      v.dir && (o.changeTxt(v.dir.querySelector(".se-tooltip-text"), n.toolbar[i.rtl ? "dir_ltr" : "dir_rtl"]), o.changeElement(v.dir.firstElementChild, b[i.rtl ? "dir_ltr" : "dir_rtl"])), v.dir_ltr && (r ? o.removeClass(v.dir_ltr, "active") : o.addClass(v.dir_ltr, "active")), v.dir_rtl && (r ? o.addClass(v.dir_rtl, "active") : o.removeClass(v.dir_rtl, "active"));
    },
    /**
...
`;
      ...
      return _ = _ > 0 ? new f.Array(_ + 1).join(" ") : "", (function C(w, z) {
        ...
        for (let q = 0, M = T.length, U, D, P, E, H, A; q < M; q++) {
          if (U = T[q], E = p.test(U.nodeName), D = E ? y : "", P = m(U) && !B && !/^(TH|TD)$/i.test(w.nodeName) ? y : "", U.nodeType === 8) {
            d += `
<!-- ` + U.textContent.trim() + " -->" + D;
            continue;
          }
          if (U.nodeType === 3) {
          ...
          if (U.childNodes.length === 0) {
            d += (/^HR$/i.test(U.nodeName) ? y : "") + (/^PRE$/i.test(U.parentElement.nodeName) && /^BR$/i.test(U.nodeName) ? "" : N) + U.outerHTML + D;
            continue;
          }
          U.outerHTML ? (H = U.nodeName.toLowerCase(), A = N || E ? z : "", d += (P || (B ? "" : D)) + A + U.outerHTML.match(h("<" + H + "[^>]*>", "i"))[0] + D, C(U, z + _), d += (/\n$/.test(d) ? A : "") + "</" + H + ">" + (P || D || B || /^(TH|TD)$/i.test(U.nodeName) ? y : "")) : d += new f.XMLSerializer().serializeToString(U);
        }
      })(v, ""), d.trim() + y;
    },
    /**
    ...
    _setKeyEffect: function(a) {
      ...
      for (let h in r)
        a.indexOf(h) > -1 || !o.hasOwn(r, h) || (d.indexOf(h) > -1 ? l[h].active.call(this, null) : r.OUTDENT && /^OUTDENT$/i.test(h) ? o.isImportantDisabled(r.OUTDENT) || r.OUTDENT.setAttribute("disabled", !0) : r.INDENT && /^INDENT$/i.test(h) ? o.isImportantDisabled(r.INDENT) || r.INDENT.removeAttribute("disabled") : o.removeClass(r[h], "active"));
    },
    /**
    ...
    _init: function(a, r) {
      ...
      if (B = {}, N = "", q)
        for (let E in q)
          o.hasOwn(q, E) && (E === "all" ? N = m(q[E], "") : B[E] = new d("\\s(?:" + m(q[E], "") + ")" + z, "ig"));
      ...
      for (let E in l)
        if (o.hasOwn(l, E)) {
          if (D = l[E], P = t[E], (D.active || D.action) && P && this.callPlugin(E, null, P), typeof D.checkFileInfo == "function" && typeof D.resetFileInfo == "function" && (this.callPlugin(E, null, P), this._fileInfoPluginsCheck.push(D.checkFileInfo.bind(this)), this._fileInfoPluginsReset.push(D.resetFileInfo.bind(this))), f.Array.isArray(D.fileTags)) {
            const H = D.fileTags;
            this.callPlugin(E, null, P), this._fileManager.tags = this._fileManager.tags.concat(H), U.push(E);
            for (let A = 0, $ = H.length; A < $; A++)
              this._fileManager.pluginMap[H[A].toLowerCase()] = E;
          }
          if (D.managedTags) {
            const H = D.managedTags();
            M.push("." + H.className), this.managedTagsInfo.map[H.className] = H.method.bind(this);
          }
        }
      this.managedTagsInfo.query = M.toString(), this._fileManager.queryString = this._fileManager.tags.join(","), this._fileManager.regExp = new d("^(" + (this._fileManager.tags.join("|") || "^") + ")$", "i"), this._fileManager.pluginRegExp = new d("^(" + (U.length === 0 ? "^" : U.join("|")) + ")$", "i"), this._variable._originCssText = e.element.topArea.style.cssText, this._placeholder = e.element.placeholder, this._lineBreaker = e.element.lineBreaker, this._lineBreakerButton = this._lineBreaker.querySelector("button"), this.history = Tr(this, this._onChange_historyStack.bind(this)), this.addModule([mn]), i.iframe && (this._wd = e.element.wysiwygFrame.contentDocument, e.element.wysiwyg = this._wd.body, i._editorStyles.editor && (e.element.wysiwyg.style.cssText = i._editorStyles.editor), i.height === "auto" && (this._iframeAuto = this._wd.body)), this._initWysiwygArea(a, r);
    },
    /**
    ...
    _setOptionsInit: function(a, r) {
      this.context = e = al(a.originElement, this._getConstructed(a), i), this._componentsInfoReset = !0, this._editorInit(!0, r);
    },
    /**
      ...
      for (let C = a; !o.isWysiwygDiv(C) && C; C = C.parentNode)
        if (!(C.nodeType !== 1 || o.isBreak(C))) {
          if (_ = C.nodeName.toUpperCase(), v.push(_), !c.isReadOnly)
            for (let w = 0, z; w < y; w++)
              z = m[w], p.indexOf(z) === -1 && l[z].active.call(c, C) && p.push(z);
    ...
    _showToolbarBalloon: function(a) {
      ...
      const N = f.Math.round(e.element._arrow.offsetWidth / 2), q = d.offsetWidth, M = d.offsetHeight, U = /iframe/i.test(e.element.wysiwygFrame.nodeName) ? e.element.wysiwygFrame.getClientRects()[0] : null;
      if (U && (m = {
        left: m.left + U.left,
        top: m.top + U.top,
        right: m.right + U.right - U.width,
        bottom: m.bottom + U.bottom - U.height
      }), g._setToolbarOffset(v, m, d, B, w, _, C, T, N), (q !== d.offsetWidth || M !== d.offsetHeight) && g._setToolbarOffset(v, m, d, B, w, _, C, T, N), i.toolbarContainer) {
    ...
    _setToolbarOffset: function(a, r, d, h, p, v, m, y, _) {
      ...
      let N = (a ? r.top - z - _ : r.bottom + _) - (r.noText ? 0 : y) + m, q = T < 0 ? 1 : B < 0 ? T : T - B - 1 - 1, M = !1;
      const U = N + (a ? g._getEditorOffsets(null).top : d.offsetHeight - e.element.wysiwyg.offsetHeight);
      !a && U > 0 && g._getPageBottomSpace() < U ? (a = !0, M = !0) : a && u.documentElement.offsetTop > U && (a = !1, M = !0), M && (N = (a ? r.top - z - _ : r.bottom + _) - (r.noText ? 0 : y) + m), d.style.left = f.Math.floor(q) + "px", d.style.top = f.Math.floor(N) + "px", a ? (o.removeClass(e.element._arrow, "se-arrow-up"), o.addClass(e.element._arrow, "se-arrow-down"), e.element._arrow.style.top = z + "px") : (o.removeClass(e.element._arrow, "se-arrow-down"), o.addClass(e.element._arrow, "se-arrow-up"), e.element._arrow.style.top = -_ + "px");
      const D = f.Math.floor(w / 2 + (T - q));
      e.element._arrow.style.left = (D + _ > d.offsetWidth ? d.offsetWidth - _ : D < _ ? _ : D) + "px";
    },
        ...
        switch (d) {
          case 8:
            ...
            if (!y && !C.previousElementSibling && m.startOffset === 0 && !r.previousSibling && !o.isListCell(C) && o.isFormatElement(C) && (!o.isFreeFormatElement(C) || o.isClosureFreeFormatElement(C))) {
              ...
              if (o.isWysiwygDiv(C.parentNode) && C.childNodes.length <= 1 && (!C.firstChild || o.onlyZeroWidthSpace(C.textContent))) {
                if (a.preventDefault(), a.stopPropagation(), C.nodeName.toUpperCase() === i.defaultTag.toUpperCase()) {
                  ...
                  for (; A[0]; )
                    C.removeAttribute(A[0].name);
                } else {
                  const A = o.createElement(i.defaultTag);
                  A.innerHTML = "<br>", C.parentElement.replaceChild(A, C);
                }
            ...
            if (C && !C.previousElementSibling && m.startOffset === 0 && T.nodeType === 3 && !o.isFormatElement(T.parentNode)) {
              let A = T.parentNode.previousSibling;
              const $ = T.parentNode.nextSibling;
              A || ($ ? A = $ : (A = o.createElement("BR"), C.appendChild(A)));
              let R = T;
            ...
            if (C = o.getFormatElement(m.startContainer, null), w = o.getRangeFormatElement(C, null), w && C && !o.isCell(w) && !/^FIGCAPTION$/i.test(w.nodeName)) {
              if (o.isListCell(C) && o.isList(w) && (o.isListCell(w.parentNode) || C.previousElementSibling) && (r === C || r.nodeType === 3 && (!r.previousSibling || o.isList(r.previousSibling))) && (o.getFormatElement(m.startContainer, null) !== o.getFormatElement(m.endContainer, null) ? w.contains(m.startContainer) : m.startOffset === 0 && m.collapsed)) {
                if (m.startContainer !== m.endContainer)
                  ...
                  let A = C.previousElementSibling || w.parentNode;
                  if (o.isListCell(A)) {
                    a.preventDefault();
                    let $ = A;
                    if (!A.contains(C) && o.isListCell($) && o.isList($.lastElementChild)) {
                      for ($ = $.lastElementChild.lastElementChild; o.isListCell($) && o.isList($.lastElementChild); )
                        $ = $.lastElementChild && $.lastElementChild.lastElementChild;
                      A = $;
                    }
                    let R = A === w.parentNode ? w.previousSibling : A.lastChild;
                    R || (R = o.createTextNode(o.zeroWidthSpace), w.parentNode.insertBefore(R, w.parentNode.firstChild));
                    const O = R.nodeType === 3 ? R.textContent.length : 1, W = C.childNodes;
                    let Z = R, te = W[0];
                    for (; te = W[0]; )
                      A.insertBefore(te, Z.nextSibling), Z = te;
                    o.removeItem(C), w.children.length === 0 && o.removeItem(w), c.setRange(R, O, R, O), c.history.push(!0);
                  }
                }
                break;
              }
              if (!y && m.startOffset === 0) {
                let A = !0, $ = B;
                for (; $ && $ !== w && !o.isWysiwygDiv($); ) {
                  if ($.previousSibling && ($.previousSibling.nodeType === 1 || !o.onlyZeroWidthSpace($.previousSibling.textContent.trim()))) {
                    A = !1;
                    break;
                  }
                  $ = $.parentNode;
            ...
            if (!y && C && (m.startOffset === 0 || r === C && C.childNodes[m.startOffset])) {
              const A = o.isListCell(C), $ = r === C ? C.childNodes[m.startOffset] : r, R = A ? $.previousSibling : C.previousSibling, O = A || (B.nodeType === 3 || o.isBreak(B)) && !B.previousSibling && m.startOffset === 0;
              if ($ && (A || !$.previousSibling) && (B && o.isComponent(B.previousSibling) || O && o.isComponent(R))) {
                const W = c.getFileComponent(R);
                W ? (a.preventDefault(), a.stopPropagation(), A ? o.removeItem($) : C.textContent.length === 0 && o.removeItem(C), c.selectComponent(W.target, W.pluginName) === !1 && c.blur()) : o.isComponent(R) && (a.preventDefault(), a.stopPropagation(), o.removeItem(R));
                break;
              }
              if ($ && o.isNonEditable($.previousSibling)) {
                a.preventDefault(), a.stopPropagation(), o.removeItem($.previousSibling);
                break;
              }
            }
            break;
          case 46:
            ...
            if ((o.isFormatElement(r) || r.nextSibling === null || o.onlyZeroWidthSpace(r.nextSibling) && r.nextSibling.nextSibling === null) && m.startOffset === r.textContent.length) {
              const A = C.nextElementSibling;
              if (!A) break;
              if (o.isComponent(A)) {
                if (a.preventDefault(), o.onlyZeroWidthSpace(C) && (o.removeItem(C), o.isTable(A))) {
                  let R = o.getChildElement(A, o.isCell, !1);
                  R = R.firstElementChild || R, c.setRange(R, 0, R, 0);
                  break;
                }
                const $ = c.getFileComponent(A);
                $ ? (a.stopPropagation(), c.selectComponent($.target, $.pluginName) === !1 && c.blur()) : o.isComponent(A) && (a.stopPropagation(), o.removeItem(A));
                break;
              }
            }
            if (!y && (c.isEdgePoint(m.endContainer, m.endOffset) || r === C && C.childNodes[m.startOffset])) {
              const A = r === C && C.childNodes[m.startOffset] || r;
              if (A && o.isNonEditable(A.nextSibling)) {
                a.preventDefault(), a.stopPropagation(), o.removeItem(A.nextSibling);
                break;
              } else if (o.isComponent(A)) {
                a.preventDefault(), a.stopPropagation(), o.removeItem(A);
                break;
              }
            }
            if (!y && c._isEdgeFormat(m.endContainer, m.endOffset, "end") && o.isFormatElement(C.nextElementSibling) && (c._formatAttrsTemp = C.attributes), C = o.getFormatElement(m.startContainer, null), w = o.getRangeFormatElement(C, null), o.isListCell(C) && o.isList(w) && (r === C || r.nodeType === 3 && (!r.nextSibling || o.isList(r.nextSibling)) && (o.getFormatElement(m.startContainer, null) !== o.getFormatElement(m.endContainer, null) ? w.contains(m.endContainer) : m.endOffset === r.textContent.length && m.collapsed))) {
              ...
              let A = o.getArrayItem(C.children, o.isList, !1);
              if (A = A || C.nextElementSibling || (w.parentNode ? w.parentNode.nextElementSibling : null), A && (o.isList(A) || o.getArrayItem(A.children, o.isList, !1))) {
                a.preventDefault();
                let $, R;
                if (o.isList(A)) {
                  const O = A.firstElementChild;
                  for (R = O.childNodes, $ = R[0]; R[0]; )
                    C.insertBefore(R[0], A);
                  o.removeItem(O);
                } else {
                  for ($ = A.firstChild, R = A.childNodes; R[0]; )
                    C.appendChild(R[0]);
                  o.removeItem(A);
                }
                c.setRange($, 0, $, 0), c.history.push(!0);
              }
              break;
            }
            break;
          case 9:
            ...
            const N = !m.collapsed || c.isEdgePoint(m.startContainer, m.startOffset), q = c.getSelectedElements(null);
            r = c.getSelectionNode();
            const M = [];
            let U = [], D = o.isListCell(q[0]), P = o.isListCell(q[q.length - 1]), E = { sc: m.startContainer, so: m.startOffset, ec: m.endContainer, eo: m.endOffset };
            for (let A = 0, $ = q.length, R; A < $; A++)
              if (R = q[A], o.isListCell(R)) {
                if (!R.previousElementSibling && !h)
                  continue;
                M.push(R);
              } else
                U.push(R);
            if (M.length > 0 && N && c.plugins.list)
              E = c.plugins.list.editInsideList.call(c, h, M);
            else {
              const A = o.getParentElement(r, o.isCell);
              if (A && N) {
                const $ = o.getParentElement(A, "table"), R = o.getListChildren($, o.isCell);
                let O = h ? o.prevIdx(R, A) : o.nextIdx(R, A);
                O === R.length && !h && (O = 0), O === -1 && h && (O = R.length - 1);
                let W = R[O];
                if (!W) break;
                W = W.firstElementChild || W, c.setRange(W, 0, W, 0);
                break;
              }
              U = U.concat(M), D = P = null;
            }
            if (U.length > 0)
              if (h) {
                const A = U.length - 1;
                for (let O = 0, W; O <= A; O++) {
                  W = U[O].childNodes;
                  for (let Z = 0, te = W.length, X; Z < te && (X = W[Z], !!X); Z++)
                ...
                const $ = o.getChildElement(U[0], "text", !1), R = o.getChildElement(U[A], "text", !0);
                !D && $ && (E.sc = $, E.so = 0), !P && R && (E.ec = R, E.eo = R.textContent.length);
              } else {
                const A = o.createTextNode(new f.Array(c._variable.tabSize + 1).join(" "));
                if (U.length === 1) {
                  if (!c.insertNode(A, null, !0)) return !1;
                  D || (E.sc = A, E.so = A.length), P || (E.ec = A, E.eo = A.length);
                } else {
                  const $ = U.length - 1;
                  for (let W = 0, Z; W <= $; W++)
                    Z = U[W].firstChild, Z && (o.isBreak(Z) ? U[W].insertBefore(A.cloneNode(!1), Z) : Z.textContent = A.textContent + Z.textContent);
                  const R = o.getChildElement(U[0], "text", !1), O = o.getChildElement(U[$], "text", !0);
                  !D && R && (E.sc = R, E.so = 0), !P && O && (E.ec = O, E.eo = O.textContent.length);
                }
              }
          ...
          case 13:
            ...
            if (c._charTypeHTML) {
              let A = "";
              if (!h && H || h ? A = "<br>" : A = "<" + C.nodeName + "><br></" + C.nodeName + ">", !c.checkCharCount(A, "byte-html"))
                return a.preventDefault(), !1;
            }
            if (!h && !_) {
              const A = c._isEdgeFormat(m.endContainer, m.endOffset, "end"), $ = c._isEdgeFormat(m.startContainer, m.startOffset, "start");
              if (A && (/^H[1-6]$/i.test(C.nodeName) || /^HR$/i.test(C.nodeName))) {
                g._enterPrevent(a);
                let R = null;
                const O = c.appendFormatTag(C, i.defaultTag);
                if (A && A.length > 0) {
                  R = A.pop();
                  const W = R;
                  for (; A.length > 0; )
                ...
                if (R = R ? R.appendChild(O.firstChild) : O.firstChild, o.isBreak(R)) {
                  const W = o.createTextNode(o.zeroWidthSpace);
                  R.parentNode.insertBefore(W, R), c.setRange(W, 1, W, 1);
                } else
                  c.setRange(R, 0, R, 0);
                break;
                ...
                if (c.isEdgePoint(R.endContainer, R.endOffset) && o.isList(r.nextSibling)) {
                  g._enterPrevent(a);
                  const O = o.createElement("LI"), W = o.createElement("BR");
                  O.appendChild(W), C.parentNode.insertBefore(O, C.nextElementSibling), O.appendChild(r.nextSibling), c.setRange(W, 1, W, 1);
                  break;
                }
                if ((R.commonAncestorContainer.nodeType !== 3 || !R.commonAncestorContainer.nextElementSibling) && o.onlyZeroWidthSpace(C.innerText.trim()) && !o.isListCell(C.nextElementSibling)) {
                  ...
                  if (o.isListCell(w.parentNode)) {
                    const W = C.parentNode.parentNode;
                    w = W.parentNode;
                    const Z = o.createElement("LI");
                    Z.innerHTML = "<br>", o.copyTagAttributes(Z, C, i.lineAttrReset), O = Z, w.insertBefore(O, W.nextElementSibling);
                  } else {
                    const W = o.isCell(w.parentNode) ? "DIV" : o.isList(w.parentNode) ? "LI" : o.isFormatElement(w.nextElementSibling) && !o.isRangeFormatElement(w.nextElementSibling) ? w.nextElementSibling.nodeName : o.isFormatElement(w.previousElementSibling) && !o.isRangeFormatElement(w.previousElementSibling) ? w.previousElementSibling.nodeName : i.defaultTag;
                    O = o.createElement(W), o.copyTagAttributes(O, C, i.lineAttrReset);
                    const Z = c.detachRangeFormatElement(w, [C], null, !0, !0);
                    Z.cc.insertBefore(O, Z.ec);
                  }
                  O.innerHTML = "<br>", o.removeItemAllParents(C, null, null), c.setRange(O, 1, O, 1);
                  break;
                }
              }
              if (H) {
                g._enterPrevent(a);
                const R = r === H, O = c.getSelection(), W = r.childNodes, Z = O.focusOffset, te = r.previousElementSibling, X = r.nextSibling;
                if (!o.isClosureFreeFormatElement(H) && W && (R && m.collapsed && W.length - 1 <= Z + 1 && o.isBreak(W[Z]) && (!W[Z + 1] || (!W[Z + 2] || o.onlyZeroWidthSpace(W[Z + 2].textContent)) && W[Z + 1].nodeType === 3 && o.onlyZeroWidthSpace(W[Z + 1].textContent)) && Z > 0 && o.isBreak(W[Z - 1]) || !R && o.onlyZeroWidthSpace(r.textContent) && o.isBreak(te) && (o.isBreak(te.previousSibling) || !o.onlyZeroWidthSpace(te.previousSibling.textContent)) && (!X || !o.isBreak(X) && o.onlyZeroWidthSpace(X.textContent)))) {
                  R ? o.removeItem(W[Z - 1]) : o.removeItem(r);
                ...
                if (R) {
                  ...
                  let Q = O.focusNode;
                  const ne = O.focusOffset;
                  H === Q && (Q = Q.childNodes[ne - Z > 1 ? ne - 1 : ne]), c.setRange(Q, 1, Q, 1);
                } else {
                  const Q = O.focusNode.nextSibling, ne = o.createElement("BR");
                  c.insertNode(ne, null, !1);
                  const fe = ne.previousSibling, re = ne.nextSibling;
                  !o.isBreak(Q) && !o.isBreak(fe) && (!re || o.onlyZeroWidthSpace(re)) ? (ne.parentNode.insertBefore(ne.cloneNode(!1), ne), c.setRange(ne, 1, ne, 1)) : c.setRange(re, 0, re, 0);
                }
                g._onShortcutKey = !0;
                break;
              }
              if (m.collapsed && ($ || A)) {
                g._enterPrevent(a);
                const R = o.createElement("BR"), O = o.createElement(C.nodeName);
                o.copyTagAttributes(O, C, i.lineAttrReset);
                let W = R;
                do {
                ...
                O.appendChild(W), C.parentNode.insertBefore(O, $ && !A ? C : C.nextElementSibling), A && c.setRange(R, 1, R, 1);
                break;
              }
              if (C) {
                a.stopPropagation();
                ...
                if (m.collapsed)
                  ...
                  const W = o.getFormatElement(m.startContainer, null) !== o.getFormatElement(m.endContainer, null), Z = C.cloneNode(!1);
                  Z.innerHTML = "<br>";
                  const te = m.commonAncestorContainer, X = te === m.startContainer && te === m.endContainer && o.onlyZeroWidthSpace(te) ? m : c.removeNode();
                  if (R = o.getFormatElement(X.container, null), !R) {
                    o.isWysiwygDiv(X.container) && (g._enterPrevent(a), e.element.wysiwyg.appendChild(Z), R = Z, o.copyTagAttributes(R, C, i.lineAttrReset), c.setRange(R, O, R, O));
                    break;
                  }
                  const Q = o.getRangeFormatElement(X.container);
                  if (R = R.contains(Q) ? o.getChildElement(Q, o.getFormatElement.bind(o)) : R, W) {
                    if (A && !$)
                      R.parentNode.insertBefore(Z, !X.prevContainer || X.container === X.prevContainer ? R.nextElementSibling : R), R = Z, O = 0;
                    else if (O = X.offset, $) {
                      const ne = R.parentNode.insertBefore(Z, R);
                      A && (R = ne, O = 0);
                    }
                  } else
                    A && $ ? (R.parentNode.insertBefore(Z, X.prevContainer && X.container === X.prevContainer ? R.nextElementSibling : R), R = Z, O = 0) : R = o.splitElement(X.container, X.offset, o.getElementDepth(C));
                }
                g._enterPrevent(a), o.copyTagAttributes(R, C, i.lineAttrReset), c.setRange(R, O, R, O);
                break;
              }
            }
            if (y) break;
            if (w && o.getParentElement(w, "FIGCAPTION") && o.getParentElement(w, o.isList) && (g._enterPrevent(a), C = c.appendFormatTag(C, null), c.setRange(C, 0, C, 0)), _) {
              ...
              const A = e[_], $ = A._container, R = $.previousElementSibling || $.nextElementSibling;
              let O = null;
              o.isListCell($.parentNode) ? O = o.createElement("BR") : (O = o.createElement(o.isFormatElement(R) && !o.isRangeFormatElement(R) ? R.nodeName : i.defaultTag), O.innerHTML = "<br>"), h ? $.parentNode.insertBefore(O, $) : $.parentNode.insertBefore(O, $.nextElementSibling), c.callPlugin(_, function() {
                c.selectComponent(A._element, _) === !1 && c.blur();
              }, null);
            }
            break;
          case 27:
        ...
        for (let y in m)
          if (o.hasOwn(m, y))
            if (y === "plugins" && m[y] && v[y]) {
              ...
              v[y] = m[y];
        return v;
      }, {}), d = e.element, h = d.wysiwyg.innerHTML, p = ol._setOptions(r, e, i);
      p.callButtons && (t = p.callButtons, c.initPlugins = {}), p.plugins && (c.plugins = l = p.plugins), d._menuTray.children.length === 0 && (this._menuTray = {}), s = p.toolbar.responsiveButtons, c.options = i = r, c.lang = n = i.lang, i.iframe && d.wysiwygFrame.addEventListener("load", function() {
...
const Lr = {
  ...
  create: function(e, t, l) {
    ge._propertiesInit(), typeof t != "object" && (t = {}), l && (t = [l, t].reduce(function(s, u) {
      for (let f in u)
        if (ge.hasOwn(u, f))
    ...
    return Er(al(n, i.constructed, i.options), i.pluginCallButtons, i.plugins, i.options.lang, t, i._responsiveButtons);
  }
}, Br = ["innerHTML", "id", "tabindex"], zr = /* @__PURE__ */ xe({
  __name: "HtmlInput",
  props: {
    modelValue: { default: "" },
    name: {},
  ...
  setup(e, { expose: t, emit: l }) {
    const n = l, i = e, s = K(null), u = K(i.modelValue);
    let f = null, o;
    const b = K(i.focusing), c = (x) => {
      ...
      o && clearTimeout(o), o = setTimeout(() => {
        ll(x) === "" ? u.value = "" : u.value = x;
      }, 100);
    }, S = () => {
      let x = {
        //@ts-ignore
        lang: sn[i.lang] ? sn[i.lang] : Wi,
        plugins: {
          ...xr
        },
        ...Sr
      };
      f = Lr.create(i.id, x), f.onChange = (L) => {
    ...
    return ie(() => i.modelValue, (x) => u.value = x), ie(u, (x) => n("update:modelValue", x)), ot(() => {
      S();
    }), t({
      doSetValue: (x) => {
        f && f.setContents(x);
  ...
  if (typeof e == "string" && (e = qe(e, t), typeof e == "string" && e.startsWith("__:"))) {
    let l = e.substring(3), n = Cn(l), i = [];
    for (let s in n) i.push({ value: s, label: n[s] });
    return mt.i18nOptionsFormatter[l] && (i = mt.i18nOptionsFormatter[l](i)), Xe(i, t);
  }
  return !Array.isArray(e) || e.length === 0 ? [] : lo(
    e.map((l) => {
...
}, lo = (e) => e.reduce((t, l) => t.find((i) => i.value === l.value) ? t : t.concat([l]), []), yt = (e, t = "", l = !0, n = void 0) => {
  if (t === "" && typeof n != "function") return !0;
  const i = String(t).toLowerCase();
  let s = String(e.label).toLowerCase();
  return !(!(s.indexOf(i) !== -1 && (l || s !== i)) || typeof n == "function" && !n(e));
}, Rt = (e, t) => {
  if (t !== "")
    return e.find((l) => Array.isArray(t) ? t.includes(l.value) : l.value == t);
}, Nr = (e, t, l) => lo([...Xe(t, l), ...e]), $i = (e, t, l) => {
  if (l) {
    if (Array.isArray(t)) {
  ...
  var n, i;
  let t = !1, l = [];
  if ((n = e.value.value) == null || n.forEach((s, u) => {
    s == e.option.value && (t = !0, l.push(u));
  }), t)
    return e.tagMode ? 3 : (l.forEach((s) => {
      e.value.value.splice(s, 1);
    }), 1);
  {
    let s = e.option.value;
    return ((i = e.optionsConfig) == null ? void 0 : i.typeCasting) === "int" ? s = parseInt(s) : s = String(s), e.value.value.push(s), 2;
  }
}, Ar = (e) => {
  var n;
  let t = !1, l = [];
  return (n = e.value.value) == null || n.forEach((i, s) => {
    i.value == e.option.value && (t = !0, l.push(s));
  }), t ? e.tagMode ? 3 : (l.forEach((i) => {
    e.value.value.splice(i, 1);
  }), 1) : (e.value.value.push(e.option), 2);
}, Zi = (e) => {
  if (e.option.disabled) return !1;
  let t;
  return e.optionValueType === "option" ? t = Ar(e) : t = Rr(e), t !== 3 && ft({
    value: e.value,
  ...
  var l, n, i, s;
  if (e.multiple) {
    let u = e.options.length;
    for (let f = 0; f < u; ++f) {
      let o = e.optionValueType === "option" ? Rt(e.options, (l = e.value.value[f]) == null ? void 0 : l.value) : ((n = e.optionsConfig) == null ? void 0 : n.typeCasting) === "int" ? Rt(e.options, parseInt(e.value.value[f])) : Rt(e.options, e.value.value[f]);
      typeof o < "u" && (e.pickedOptions.value.length === 0 ? e.pickedOptions.value.push(o) : e.pickedOptions.value.splice(f, 1, o));
    }
    return;
  }
  let t = e.optionValueType === "option" ? Rt(e.options, (i = e.value.value) == null ? void 0 : i.value) : ((s = e.optionsConfig) == null ? void 0 : s.typeCasting) === "int" ? Rt(e.options, parseInt(e.value.value)) : Rt(e.options, e.value.value);
  typeof t < "u" && (e.pickedOptions.value.length === 0 ? e.pickedOptions.value.push(t) : e.pickedOptions.value.splice(0, 1, t));
}, gn = (e) => {
  var n, i, s, u, f;
  ...
  if (e.focusing) {
    if (["ArrowDown", "ArrowUp", "Enter"].includes(l) && (e.event.preventDefault(), e.event.stopPropagation()), l === "ArrowDown") {
      ...
      let b = typeof ((n = e.container.value) == null ? void 0 : n.querySelector) == "function" && ((i = e.container.value) == null ? void 0 : i.querySelector('[data-index="' + e.focusedIndex.value + '"]'));
      ...
      let o = e.options.value[e.focusedIndex.value];
      for (; !yt(o, e.query, (s = e.optionsConfig) == null ? void 0 : s.filter) && e.focusedIndex.value > 0; )
        --e.focusedIndex.value, o = e.options.value[e.focusedIndex.value];
  ...
  return (e.optionValueType === "option" ? Pi(t, (n = e.value.value) == null ? void 0 : n.value) : Pi(t, e.value.value)) === -1 ? (e.value.value.push(e.optionValueType === "option" ? t : t.value), e.options.value.push(t), e.pickedOptions.push(t), !0) : !1;
}, Vr = (e) => {
  var l;
  let t = !0;
  for (; t; ) {
    let n = e.optionValueType === "option" ? Pi(e.option, (l = e.value.value) == null ? void 0 : l.value) : Pi(e.option, e.value.value);
  ...
  for (; !yt(n, e.query, !0, (i = e.optionsConfig) == null ? void 0 : i.filter) && t < l; )
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = J(() => {
      var L, a, r;
      return (L = n.item) != null && L.icon ? n.item.icon : typeof ((r = (a = n.data) == null ? void 0 : a.optionsConfig) == null ? void 0 : r.icon) == "function" ? n.data.optionsConfig.icon(n.item, n.data.prop) : n.data.optionsConfig.icon;
    }), s = J(() => {
      ...
      if (b.value === "lkt-anchor") {
        if (typeof ((a = n.data.optionsConfig) == null ? void 0 : a.anchor) == "function") return { ...n.data.optionsConfig.anchor({ data: n.item }), prop: n.item };
        if (typeof ((r = n.data.optionsConfig) == null ? void 0 : r.anchor) == "object") return { ...n.data.optionsConfig.anchor, prop: n.item };
        let m = (d = n.data.optionsConfig) == null ? void 0 : d.download;
        typeof n.data.optionsConfig.download == "function" ? m = () => {
          var _;
          return (_ = n.data.optionsConfig) == null ? void 0 : _.download(n.item);
        } : (p = (h = n.data.optionsConfig) == null ? void 0 : h.download) != null && p.startsWith("prop:") && (m = qe((v = n.data.optionsConfig) == null ? void 0 : v.download, n.item));
        let y = n.data.optionsConfig.download !== "";
        return {
          to: m,
          type: y ? wn.Download : void 0,
          prop: n.item
        };
      }
    ...
    }), g = J(() => typeof n.item.tags > "u" ? [] : typeof n.item.tags == "function" ? n.item.tags() : n.item.tags), k = () => {
      var L;
      ...
      n.editing && (L.stopPropagation(), L.preventDefault(), k());
    }, x = () => {
      var L;
      typeof ((L = n.events) == null ? void 0 : L.clickIcon) == "function" && n.events.clickIcon(n.item, n.index), l("click-icon", n.item);
    };
    return (L, a) => {
      const r = he("lkt-button"), d = he("lkt-tag");
      return he("lkt-table"), F(), ue(He, null, [
        e.data.fieldType === V(G).ToggleButtonGroup ? (F(), Y(r, Me(ae({ key: 0 }, {
          icon: i.value,
          text: s.value,
          events: {
            click: k
          }
        })), null, 16)) : (F(), Y(dt(b.value), ae({ key: 1 }, c.value, {
          class: ["lkt-field--dropdown-option", f.value],
          title: s.value,
          onClick: Eo(k, ["stop", "prevent"]),
          onClickIcon: x
        }), {
          default: ye(() => {
            var h;
            return [
              i.value && b.value !== "lkt-button" ? (F(), ue("div", {
                key: 0,
              ...
              (h = e.data.optionsConfig) != null && h.extendedContentSlotComponent ? (F(), Y(dt(e.data.optionsConfig.extendedContentSlotComponent), Me(ae({ key: 1 }, {
                ...e.data.optionsConfig.extendedContentSlotData,
                item: e.item
              })), null, 16)) : oe("", !0),
              (F(!0), ue(He, null, vt(g.value, (p) => (F(), Y(d, ae({ ref_for: !0 }, p), null, 16))), 256))
            ];
          }),
          _: 1
        }, 16, ["class", "title"])),
...
}, Mr = ["value", "placeholder", "disabled"], Or = {
  key: 1,
  class: "lkt-field--searchable-box"
}, Hr = ["value", "placeholder", "disabled"], Fr = { key: 0 }, vn = /* @__PURE__ */ xe({
  __name: "SelectInput",
  props: {
    modelValue: {},
  ...
  setup(e, { expose: t, emit: l }) {
    const n = l, i = K(null), s = K(null), u = e, f = K(u.modelValue), o = K(-1), b = u.multiple && u.canTag, c = typeof u.options == "object" && u.optionValueType !== "option" ? JSON.parse(JSON.stringify(u.options)) : u.options, g = K([...Xe(u.options, u.prop)]), k = K(!0);
    ie(k, (W) => {
      W || Ee(() => {
        k.value = !0;
      });
      ...
      var Z;
      !W && ((Z = u.optionsConfig) != null && Z.autoPickFirstOptionIfEmpty) ? (u.pickedOptions.splice(0, u.pickedOptions.length), Ee(() => {
        ji({
          value: f,
      ...
      var Z;
      typeof ((Z = u.events) == null ? void 0 : Z.updatedOptions) == "function" && (k.value = !1, u.events.updatedOptions({
        options: W
      })), n("update:options", W);
    }), ie(() => u.options, (W, Z) => {
      if (!k.value) return;
      ...
      te.increment({ opts: W }), te.changed() && (g.value = Xe(W, u.prop), H());
    }, { deep: !0 });
    const S = K(""), x = K(null), L = K(u.pickedOptions);
    ie(L, (W) => {
      n("update:pickedOptions", W), u.optionValueType === "option" && u.multipleDisplayEdition === gt.Table && (f.value = L.value);
    }, { deep: !0 });
    const a = K(!1), r = K(u.showOptions);
    ie(r, (W) => {
      b || n("update:showOptions", W), Ee(() => {
        W || (v.value = !1, p.value = !1, h.value = !1), a.value = r.value;
      });
    });
    const d = (W) => {
      var Z;
      !W && ((Z = u.tooltip) == null ? void 0 : Z.type) === Tl.Full && (r.value = !1);
    }, h = K(u.focusing), p = K(!1), v = K(!1);
    ie(() => u.focusing, (W) => {
      W !== h.value && Ee(() => {
        W ? N() : T();
      });
    ...
    const _ = (W) => {
      clearTimeout(m), m = setTimeout(() => {
        p.value = !1, h.value = v.value, r.value = h.value;
      }, 100);
    }, C = (W) => {
      if (p.value = !0, b && W.key === "Enter") {
      ...
      } else if (["ArrowDown", "ArrowUp", "Enter"].includes(W.key)) {
        let Z = gn({
          event: W,
          options: g,
          focusing: u.focusing,
        ...
        typeof Z == "object" && E(Z);
      } else ["Escape"].includes(W.key) && (p.value = !1, v.value = !1, h.value = !1, r.value = !1);
    }, w = (W) => {
      p.value = !0, v.value = !1, h.value = !0, r.value = !0;
    }, z = () => {
      clearTimeout(m), clearTimeout(y), setTimeout(() => {
        x.value && x.value.focus();
      }, 100);
    }, T = (W) => {
      clearTimeout(y), !P.value && (y = setTimeout(() => {
        v.value = !1, h.value = p.value, r.value = h.value;
      }, 100));
    }, B = (W) => {
      if (v.value = !0, ["ArrowDown", "ArrowUp", "Enter"].includes(W.key)) {
        let Z = gn({
          event: W,
          options: g,
          focusing: u.focusing,
      ...
      u.searchable ? (v.value = !1, p.value = !0, h.value = !0, r.value = !0, Ee(() => {
        z();
      })) : (v.value = !0, p.value = !1, h.value = !0, r.value = !0);
    }, q = (W) => {
      Vr({
        value: f,
        option: W,
    ...
    t({
      doClear: () => {
        u.isAutoCompleteText ? (S.value = "", f.value = "") : u.multiple ? f.value.splice(0, f.value.length) : f.value = "", L.value.splice(0, L.value.length), Ee(() => {
          H();
        });
      },
      doUndo: (W) => {
    ...
    }), ie(() => u.pickedOptions, (W) => {
      n("change"), L.value = W;
    }, { deep: !0 });
    const D = J(() => u.multiple && (u.canTag || u.searchable)), P = J(() => !u.multiple && u.searchable && h.value), E = (W) => {
      var te, X, Q;
      if (u.isAutoCompleteText) {
        S.value = W.value, f.value = W.value;
        return;
      }
      (u.multiple ? Zi({
        option: W,
        ...
        showOptions: r.value,
        optionValueType: u.optionValueType,
        callback: (X = u.events) == null ? void 0 : X.clickOption,
        optionsConfig: u.optionsConfig
      })) && (u.searchable && !u.multiple && (S.value = ""), typeof ((Q = u.events) == null ? void 0 : Q.clickOption) == "function" && u.events.clickOption({
        option: W
      }));
    }, H = () => {
      u.multiple ? ft({
      ...
      if (u.autoLoading && u.optionsConfig.autoloadResource === "feed" && u.multiple)
        for (let W = 0; W < g.value.length; ++W)
          u.optionValueType === "option" ? f.value.push(g.value[W]) : f.value.push(g.value[W].value);
      o.value = -1, H();
    }, $ = J(() => {
      var X, Q, ne;
      if (!((X = u.optionsConfig.http) != null && X.resource)) return;
      let W = {
        ...(Q = u.optionsConfig.http) == null ? void 0 : Q.data
      };
      ee.searchKeyForResource !== "" && (W[ee.searchKeyForResource] = S.value);
      const Z = (fe) => {
        var re, se, ve, me;
        u.autoLoading && u.optionsConfig.autoloadResource && n("autoload-start"), typeof ((se = (re = u.optionsConfig.http) == null ? void 0 : re.events) == null ? void 0 : se.onStart) == "function" && ((me = (ve = u.optionsConfig.http) == null ? void 0 : ve.events) == null || me.onStart(fe));
      }, te = (fe) => {
        var re, se, ve, me;
        u.autoLoading && u.optionsConfig.autoloadResource && n("autoload-end"), typeof ((se = (re = u.optionsConfig.http) == null ? void 0 : re.events) == null ? void 0 : se.onEnd) == "function" && ((me = (ve = u.optionsConfig.http) == null ? void 0 : ve.events) == null || me.onEnd(fe));
      };
      return {
        resource: (ne = u.optionsConfig.http) == null ? void 0 : ne.resource,
        resourceData: W,
        events: {
          httpStart: Z,
          httpEnd: te
    ...
    }), R = J(() => u.autoLoading ? "div" : "lkt-tooltip"), O = J(() => u.isAutoCompleteText || P.value || D.value ? x.value : u.referrer);
    return ot(() => {
      u.isAutoCompleteText && (S.value = f.value), H();
    }), (W, Z) => {
      var ne, fe, re, se, ve;
      const te = he("lkt-tag"), X = he("lkt-table"), Q = he("lkt-button");
      return F(), ue(He, null, [
        e.isAutoCompleteText ? (F(), ue("div", Dr, [
          De(we("input", {
            "onUpdate:modelValue": Z[0] || (Z[0] = (me) => S.value = me),
            ref_key: "queryField",
            ref: x,
            value: S.value,
        ...
        ])) : !e.autoLoading && (P.value || D.value) ? (F(), ue("div", Or, [
          e.multiple ? (F(), Y(te, Me(ae({ key: 0 }, {
            icon: e.optionsConfig.icon,
            text: L.value.length
          })), null, 16)) : L.value.length > 0 ? (F(), Y(te, Me(ae({ key: 1 }, {
            icon: L.value[0].icon ?? e.optionsConfig.icon,
            text: L.value[0].label
          })), null, 16)) : oe("", !0),
          De(we("input", {
            "onUpdate:modelValue": Z[1] || (Z[1] = (me) => S.value = me),
            ref_key: "queryField",
            ref: x,
            value: S.value,
            placeholder: e.searchPlaceholder,
        ...
        !e.autoLoading && !e.isAutoCompleteText ? De((F(), Y(Q, ae({
          key: 2,
          ref_key: "selectButton",
          ref: i
        }, {
          type: V(b) || !(typeof ((ne = e.optionsConfig) == null ? void 0 : ne.canRenderDropdown) > "u" || ((fe = e.optionsConfig) == null ? void 0 : fe.canRenderDropdown) === !0) ? V(je).Content : V(je).Button,
          ...
          default: ye(() => [
            V(b) || e.multiple && (e.multipleDisplayEdition === V(gt).Table || L.value.length > 0) ? (F(), ue(He, { key: 0 }, [
              e.multipleDisplayEdition === V(gt).Count ? (F(), ue("div", Fr, xt(L.value.length), 1)) : e.multipleDisplayEdition === V(gt).Table ? (F(), Y(X, ae({
                key: 1,
                modelValue: L.value,
                "onUpdate:modelValue": Z[2] || (Z[2] = (me) => L.value = me)
              }, {
                ...e.optionsConfig.table,
                editMode: e.editable
              }), null, 16, ["modelValue"])) : (F(), Y(X, ae({
                key: 2,
                modelValue: L.value,
                "onUpdate:modelValue": Z[3] || (Z[3] = (me) => L.value = me)
              }, {
                type: V(bt).Ul,
                editMode: e.editable,
                itemsContainerClass: `lkt-field-select-read multiple-display-${e.multipleDisplayEdition}`,
                itemSlotComponent: Vt(nt),
                itemSlotData: {
            ...
            ], 64)) : !e.multiple && L.value.length > 0 ? (F(), Y(nt, Me(ae({ key: 1 }, {
              item: L.value[0],
              data: {
                optionSlot: e.optionSlot,
                previewMode: !0,
        ...
        typeof ((re = e.optionsConfig) == null ? void 0 : re.canRenderDropdown) > "u" || ((se = e.optionsConfig) == null ? void 0 : se.canRenderDropdown) === !0 ? (F(), Y(dt(R.value), ae({
          key: 3,
          ref_key: "dropdownEl",
          ref: s
        }, e.autoLoading ? {} : {
          ...
          ...e.tooltip,
          modelValue: r.value,
          remoteControl: ((ve = e.tooltip) == null ? void 0 : ve.type) !== V(Tl).Full
        }, { "onUpdate:modelValue": d }), {
          default: ye(() => [
            e.autoLoading && !e.localAutoLoad || a.value ? De((F(), Y(X, ae({
              key: 0,
              ref: "optionList",
              modelValue: g.value,
              "onUpdate:modelValue": Z[4] || (Z[4] = (me) => g.value = me)
            }, {
              type: V(bt).Ul,
              editMode: e.editable,
              paginator: $.value,
              events: {
                parseResults: (me) => {
                  var Ne;
                  return (Ne = e.optionsConfig.http) != null && Ne.resource ? V(Nr)(V(Xe)(V(c), u.prop), me, e.prop) : V(Xe)(V(c), u.prop);
                }
              },
              itemDisplayChecker: (me) => {
                var Ne;
                return V(yt)(me, S.value, !0, (Ne = e.optionsConfig) == null ? void 0 : Ne.filter);
              },
              itemsContainerClass: "lkt-field--dropdown-options",
              itemContainerClass: (me, Ne) => {
                let Ce = [];
                return V($i)(me, f.value, e.multiple) && Ce.push("is-active"), o.value === Ne && Ce.push("is-focused"), me.disabled && Ce.push("is-disabled"), Ce.join(" ");
              },
              itemSlotComponent: Vt(nt),
              itemSlotData: {
                optionSlot: e.optionSlot,
...
}), Ur = { class: "lkt-calc--formula" }, Pr = { class: "lkt-calc--custom-pad" }, Wr = { class: "lkt-calc--pad" }, $r = { class: "lkt-calc--numeric-pad" }, qr = { class: "lkt-calc--math-pad" }, Zr = { class: "lkt-calc--advance-math-pad" }, jr = /* @__PURE__ */ xe({
  __name: "CalcInput",
  props: {
    modelValue: { default: "" },
    options: { default: () => [] },
  ...
  emits: ["update:modelValue", "focus", "blur"],
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(n.modelValue), s = K(null);
    ie(i, (p) => l("update:modelValue", p));
    ...
    return ie(u, (p) => {
      ...
      return F(), ue("div", {
        ...
        e.editable ? (F(), Y(y, {
          ...
          default: ye(() => [
            we("div", Pr, [
              (F(!0), ue(He, null, vt(e.options, (_) => (F(), Y(m, {
                icon: _.icon,
                text: _.label,
                onClick: (C) => r(_)
  ...
  setup(e) {
    const t = e, l = J(() => {
      ...
      if (t.validation.text && t.validation.text !== "")
        ...
        f = Il(t.validation.code, t.stack);
        let b = Il(t.validation.status + "-" + t.validation.code, t.stack);
        b && (f = b);
      }
      return f ? f.startsWith("__:") ? Cn(f.substring(3), o) : Bo(f, o, ":", "") : t.validation.code;
    }), n = J(() => ee.validationIconSlot !== ""), i = J(() => ee.validationIconSlot), s = J(() => {
      let f = [];
    ...
    return (f, o) => {
      ...
      return F(), ue("div", {
        ...
        (c = e.validation.element) != null && c.tag ? (F(), Y(dt(e.validation.element.tag), ae({
          key: 0,
          class: e.validation.element.class
        }, e.validation.element.props), null, 16, ["class"])) : (F(), ue(He, { key: 1 }, [
          u.value && typeof u.value == "string" ? (F(), Y(b, Me(ae({ key: 0 }, {
            icon: u.value
          })), null, 16)) : u.value && typeof u.value == "object" ? (F(), Y(b, Me(ae({ key: 1 }, u.value)), null, 16)) : n.value ? (F(), Y(dt(i.value), { key: 2 })) : oe("", !0),
          il(" " + xt(l.value), 1)
        ], 64))
      ], 2);
    };
  }
}), Gr = { class: "lkt-field-validation-info" }, yn = /* @__PURE__ */ xe({
  ...
  setup(e) {
    return (t, l) => {
      ...
      return F(), ue("div", Gr, [
        e.config.groupConstraints ? (F(), Y(n, Me(ae({ key: 0 }, {
          ...e.config.groupConstraintsButton,
          type: V(je).TooltipEver
        })), {
          tooltip: ye(({ doClose: i }) => [
            (F(!0), ue(He, null, vt(e.items, (s) => (F(), Y(bn, {
              validation: s,
              stack: e.stack,
              key: s.code
          ...
          _: 1
        }, 16)) : (F(!0), ue(He, { key: 1 }, vt(e.items, (i) => (F(), Y(bn, {
          validation: i,
          stack: e.stack,
          key: i.code
        }, null, 8, ["validation", "stack"]))), 128))
  ...
  emits: ["update:modelValue", "focus", "blur"],
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(n.modelValue), s = K(n.focusing);
    let u, f;
    const o = K({}), b = () => {
    ...
    return (S, x) => {
      const L = he("lkt-table"), a = he("lkt-tooltip");
      return F(), ue(He, null, [
        De(we("input", {
          id: e.id,
          type: "text",
        ...
        e.editable && e.hadFirstFocus ? (F(), Y(a, ae({
          key: 0,
          ref: "dropdownEl",
          ...
          default: ye(() => [
            de(L, ae({
              ...
              itemDisplayChecker: (r) => {
                var d;
                return V(yt)(r, "", !0, (d = e.optionsConfig) == null ? void 0 : d.filter);
              },
              itemSlotEvents: {
                click: (r, d) => {
                  e.optionsConfig.closeDropdownOnOptionClick ? s.value = !1 : k(), typeof e.events.clickOption == "function" && n.events.clickOption({
                    option: r
                  });
                }
              }
...
}, Jr = { class: "lkt-field--toggle-button" }, Qr = {
  key: 3,
  class: "lkt-field--read-value"
}, eu = ["innerHTML", "title"], tu = ["title"], iu = { key: 0 }, lu = ["title"], nu = ["innerHTML"], ou = ["innerHTML", "title"], au = ["innerHTML", "title"], su = /* @__PURE__ */ xe({
  ...
  props: {
    ...
    multipleDisplay: { default: gt.List },
    modal: { default: "" },
    modalKey: { default: "" },
    modalData: { default: () => ({}) },
    optionSlot: { default: "" },
  ...
  emits: ["click"],
  setup(e, { emit: t }) {
    const l = t, n = sl(), i = e, s = () => l("click"), u = J(() => {
      switch (i.type) {
        case G.Select:
        case G.Radio:
        case G.DayOfWeek:
        case G.ToggleButtonGroup:
          if (i.multiple && Array.isArray(i.value) && i.value.length > 0 || i.multiple && i.multipleDisplay === gt.Count || !i.multiple && i.value) return "";
          break;
        case G.Date:
          if (i.value !== "") return "";
          break;
      ...
      var c;
      let b = i.value;
      return Mo.includes(i.type) && i.multiple && !Array.isArray(b) && (b = []), (i.type === G.Textarea || i.type === G.Text) && (typeof ((c = i.readModeConfig) == null ? void 0 : c.textMaxLength) < "u" && b.length > i.readModeConfig.textMaxLength ? b = b.substring(0, i.readModeConfig.textMaxLength) + "..." : typeof ee.readTextMaxLength < "u" && b.length > ee.readTextMaxLength && (b = b.substring(0, ee.readTextMaxLength) + "...")), b;
    });
    return (b, c) => {
      var r;
      const g = he("lkt-loader"), k = he("lkt-image"), S = he("lkt-table"), x = he("lkt-button"), L = he("lkt-anchor"), a = he("lkt-tag");
      return F(), ue("div", {
        class: "lkt-field--read",
        onClick: s
      }, [
        e.isLoading ? (F(), Y(g, { key: 0 })) : V(n).value ? it(b.$slots, "value", {
          key: 1,
          value: o.value,
          title: e.title,
          data: e.slotData
          ...
          title: e.title,
          data: e.slotData
        }, null, 8, ["value", "title", "data"])) : (F(), ue(He, { key: 4 }, [
          e.type === V(G).File || e.type === V(G).Image ? (F(), ue("div", Xr, [
            e.multiple && e.type === V(G).Image ? (F(), Y(S, Me(ae({ key: 0 }, {
              modelValue: e.value,
              type: V(bt).Carousel
            })), {
              item: ye(({ item: d, index: h }) => [
                we("div", Jr, [
                  e.type === V(G).Image ? (F(), Y(k, {
                    key: 0,
                    src: o.value[h],
              ...
              key: 1,
              class: "lkt-field--toggle-button",
              text: e.type === V(G).File ? e.fileName : "",
              disabled: ""
            }, {
              default: ye(() => [
                e.type === V(G).Image ? (F(), Y(k, {
            ...
            _: 1
          }, 8, ["title", "to"])) : e.type === V(G).Tel ? (F(), Y(L, {
            key: 2,
            type: "tel",
            class: "lkt-field--read-value",
            title: e.title,
            ...
            editMode: !1
          }), null, 16, ["modelValue"])) : e.type === V(G).Date ? (F(), ue("div", {
            key: 5,
            class: "lkt-field--read-value",
            innerHTML: o.value,
            title: e.title
          }, null, 8, eu)) : [V(G).Select, V(G).Radio, V(G).DayOfWeek, V(G).ToggleButtonGroup].includes(e.type) ? (F(), ue("div", {
            key: 6,
            class: "lkt-field--read-value",
            title: e.title
          }, [
            e.multiple ? (F(), ue(He, { key: 0 }, [
              e.multipleDisplay === V(gt).Count ? (F(), ue("div", iu, xt(o.value.length), 1)) : e.multipleDisplay === V(gt).Table ? (F(), Y(S, ae({
                key: 1,
                "model-value": o.value
              }, e.optionsConfig.table), null, 16, ["model-value"])) : o.value.length > 0 ? (F(), ue("ul", {
                key: 2,
                class: ct(["lkt-field-select-read", `multiple-display-${e.multipleDisplay}`])
              }, [
                (F(!0), ue(He, null, vt(o.value, (d, h) => {
                  var p;
                  return F(), ue("li", {
            ...
            ], 64)) : o.value.length > 0 ? (F(), Y(nt, Me(ae({ key: 1 }, {
              item: o.value[0],
              data: {
                optionSlot: e.optionSlot,
                editable: !1,
            ...
            default: ye(() => [
              we("div", { innerHTML: o.value }, null, 8, nu)
            ]),
            _: 1
          }, 8, ["title", "modal", "modal-key", "modal-data"])) : e.download ? (F(), Y(nt, Me(ae({ key: 8 }, {
          ...
          })), null, 16)) : e.type === V(G).Number ? (F(), ue("div", {
            key: 9,
            class: "lkt-field--read-value",
            innerHTML: e.title,
            title: e.title
...
}), ru = ["name", "id", "disabled", "readonly", "placeholder", "accept"], uu = {
  key: 2,
  class: "lkt-button lkt-field--toggle-button"
}, cu = { class: "lkt-grid-1" }, no = /* @__PURE__ */ xe({
  __name: "FileInput",
  props: {
    modelValue: { default: "" },
    name: {},
  ...
  setup(e, { expose: t, emit: l }) {
    const n = l, i = e, s = K(null), u = K(null), f = K(i.modelValue), o = K(i.fileName), b = K(i.uploading), c = (S) => {
      let x = S.target;
      if (x.files && x.files[0]) {
        ...
        L.onload = (a) => {
          if (f.value = a.target.result, i.resource) {
            ...
            r.files = x.files[0], rl(i.resource, r).then((d) => {
    ...
    ie(f, (S) => n("update:modelValue", S)), ie(o, (S) => n("update:fileName", S)), t({
      click: () => {
        var S;
    ...
    return (S, x) => {
      const L = he("lkt-image"), a = he("lkt-button");
      return F(), ue(He, null, [
        we("input", {
        ...
        g.value ? e.isImage ? e.isImage ? (F(), ue("div", uu, [
          e.isImage ? (F(), Y(L, {
            key: 0,
            src: f.value,
            class: "lkt-field--image-cover"
          ...
          e.isImage ? (F(), Y(L, {
            ...
            overlay: ye(() => [
              we("div", null, [
                we("div", cu, [
                  oe("", !0),
                  de(a, ae({ ref: "fileBrowserButtonRef" }, {
                    text: "Explore files",
                    icon: "lkt-icn-search",
                    disabled: e.disabled,
        ...
        e.callToActionButton ? (F(), Y(a, Me(ae({ key: 3 }, {
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(void 0), s = K(""), u = K(""), f = K(n.modelValue), o = J(() => {
      if (n.isDateTime) {
    ...
    }), b = J(() => n.isDateTime ? "Y-m-d H:i" : "Y-m-d"), c = (S) => {
      let x = new Date(S);
      En(x) && (i.value = x, n.isDateTime && (s.value = [At(x.getHours(), 2, "0"), At(x.getMinutes(), 2, "0")].join(":")));
    }, g = () => {
      u.value = Ln(i.value, o.value);
    };
    ie(() => n.modelValue, (S) => {
      f.value = S, c(S);
    }), ie(f, (S) => l("update:modelValue", S));
    const k = (S) => {
      var L, a;
      let x = S.split(":");
    ...
    return ie(s, (S) => {
      ...
      if (typeof S > "u")
        ...
        let a = s.value.split(":");
        a.length >= 2 && typeof i.value == "object" && ((x = i.value) == null || x.setHours(parseInt(a[0])), (L = i.value) == null || L.setMinutes(parseInt(a[1]))), f.value = kn(b.value, S);
      }
      g();
    }, { deep: !0 }), ot(() => {
      c(n.modelValue), g();
    }), (S, x) => {
      const L = he("lkt-calendar"), a = he("lkt-field"), r = he("lkt-button");
      return F(), Y(r, Me(ni({
        type: V(je).TooltipEver,
        icon: e.icon,
        class: "lkt-field--toggle-button",
  ...
  setup(e) {
    const t = sl(), l = e, n = K(l.modelValue), i = J(() => typeof l.max == "boolean" || n.value.length < l.max ? ["modal-create"] : []);
    return (s, u) => {
      ...
      return F(), Y(f, {
        ...
        item: ye(({ item: o, index: b, isLoading: c, canCreate: g, canRead: k, canUpdate: S, canDrop: x, doDrop: L }) => [
          de(oo, {
            modelValue: n.value[b],
            "onUpdate:modelValue": (a) => n.value[b] = a,
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = J(() => n.insideEllipsis ? "lkt-field--info-split-btn" : "lkt-field--info-btn"), s = () => l("click");
    return (u, f) => {
      const o = he("lkt-button");
      return F(), Y(o, ae(e.config, {
        type: e.config.type ? e.config.type : V(je).FileUpload,
...
}), mu = { class: "lkt-time lkt-flex-column" }, gu = /* @__PURE__ */ xe({
  __name: "LktTime",
  props: {
    hour: {},
    minutes: {}
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(n.hour), s = K(n.minutes);
    return ie(() => n.hour, (u) => i.value = u), ie(() => n.minutes, (u) => s.value = u), ie(i, (u) => l("update:hour", u)), ie(s, (u) => l("update:minutes", u)), (u, f) => {
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = /* @__PURE__ */ new Date(), s = K(i.getHours()), u = K(i.getMinutes()), f = K(n.modelValue), o = (b) => {
      let c = b.split(":");
      c.length >= 2 && (s.value = parseInt(c[0]), u.value = parseInt(c[1]));
    };
    return ie([s, u], (b) => {
      f.value = [At(s.value, 2, "0"), At(u.value, 2, "0")].join(":");
    }), ie(() => n.modelValue, (b) => f.value = b), ie(f, (b) => l("update:modelValue", b)), ot(() => {
      o(f.value), f.value = [At(s.value, 2, "0"), At(u.value, 2, "0")].join(":");
    }), (b, c) => {
      const g = he("lkt-button");
      return F(), Y(g, Me(ni({
        type: V(je).Tooltip,
...
var pe = /* @__PURE__ */ ((e) => (e[e.TextInput = 0] = "TextInput", e[e.TextareaInput = 1] = "TextareaInput", e[e.HtmlInput = 2] = "HtmlInput", e[e.BooleanInput = 3] = "BooleanInput", e[e.MultipleColorInput = 4] = "MultipleColorInput", e[e.SingleColorInput = 5] = "SingleColorInput", e[e.FileInput = 6] = "FileInput", e[e.DateInput = 7] = "DateInput", e[e.TimeInput = 8] = "TimeInput", e[e.SelectInput = 9] = "SelectInput", e[e.CalcInput = 10] = "CalcInput", e[e.SearchInput = 11] = "SearchInput", e[e.MultipleCardInput = 12] = "MultipleCardInput", e[e.SingleCardInput = 13] = "SingleCardInput", e[e.TableInput = 14] = "TableInput", e[e.RadioInput = 15] = "RadioInput", e[e.ToggleButtonGroupInput = 16] = "ToggleButtonGroupInput", e[e.RangeOptsInput = 17] = "RangeOptsInput", e))(pe || {});
const bu = /* @__PURE__ */ xe({
  __name: "RadioInput",
  props: {
    modelValue: {},
    searchable: { type: Boolean },
  ...
  setup(e, { expose: t, emit: l }) {
    const n = l, i = e, s = K(i.modelValue), u = K(-1), f = J(() => i.isDayOfWeek ? Oo.getDaysAsOptions() : []), o = K([...Xe(
    ...
    ie(b, (z) => {
      ...
      var T;
      !z && ((T = i.optionsConfig) != null && T.autoPickFirstOptionIfEmpty) ? (i.pickedOptions.splice(0, i.pickedOptions.length), Ee(() => {
        ji({
          value: s,
    ...
    ie(k, (z) => {
      n("update:pickedOptions", z);
    });
    const S = K(!1), x = K(i.showOptions);
    ie(x, (z) => {
      n("update:showOptions", z), Ee(() => {
    ...
    const h = () => {
      ...
      i.searchable ? (r.value = !1, a.value = !0, L.value = !0, x.value = !0, Ee(() => {
        h();
      })) : (r.value = !0, a.value = !1, L.value = !0, x.value = !0);
    };
    t({
      doClear: () => {
        i.multiple ? s.value.splice(0, s.value.length) : s.value = "", k.value.splice(0, k.value.length), Ee(() => {
          w();
        });
      },
      doUndo: (z) => {
        if (i.multiple) {
          ...
          s.value = z;
        k.value.splice(0, k.value.length), Ee(() => {
          w();
        });
      },
      keepFocused: h,
    ...
    const _ = J(() => !i.multiple && i.searchable && L.value), C = (z) => {
      var B, N;
      (i.multiple ? Zi({
        option: z,
        value: s,
        pickedOptions: k,
        dropdownOptions: o.value,
        tagMode: !1,
    ...
    return ot(() => {
      ...
      return F(), Y(B, ae({
        ...
        itemDisplayChecker: (N) => {
          var q;
          return V(yt)(N, c.value, !0, (q = e.optionsConfig) == null ? void 0 : q.filter);
        },
        itemsContainerClass: "lkt-field--dropdown-options lkt-field--radio-options",
        itemContainerClass: (N, q) => {
          let M = [];
          return V($i)(N, s.value, e.multiple) && M.push("is-active"), u.value === q && M.push("is-focused"), N.disabled && M.push("is-disabled"), M.join(" ");
        },
        itemSlotComponent: Vt(nt),
        itemSlotData: {
          optionSlot: e.optionSlot,
  ...
  setup(e, { expose: t, emit: l }) {
    const n = l, i = e, s = K(i.modelValue), u = K(-1), f = K([...Xe(i.options, i.prop)]), o = K(!0);
    ie(o, (w) => {
      w || Ee(() => {
        o.value = !0;
      });
      ...
      var z;
      !w && ((z = i.optionsConfig) != null && z.autoPickFirstOptionIfEmpty) ? (i.pickedOptions.splice(0, i.pickedOptions.length), Ee(() => {
        ji({
          value: s,
          optionValueType: i.optionValueType,
          multiple: i.multiple,
    ...
    const d = () => {
      ...
      i.searchable ? (a.value = !1, L.value = !0, x.value = !0, S.value = !0, Ee(() => {
        d();
      })) : (a.value = !0, L.value = !1, x.value = !0, S.value = !0);
    };
    t({
      doClear: () => {
        i.multiple ? s.value.splice(0, s.value.length) : s.value = "", g.value.splice(0, g.value.length), Ee(() => {
          C();
        });
      },
      doUndo: (w) => {
        if (i.multiple) {
          ...
          s.value = w;
        g.value.splice(0, g.value.length), Ee(() => {
          C();
        });
      },
      keepFocused: d,
    ...
    const y = J(() => !i.multiple && i.searchable && x.value), _ = (w) => {
      var T, B;
      (i.multiple ? Zi({
        option: w,
        value: s,
    ...
    return ot(() => {
      ...
      return F(), Y(T, ae({
        ...
        itemDisplayChecker: (B) => {
          var N;
          return V(yt)(B, b.value, !0, (N = e.optionsConfig) == null ? void 0 : N.filter);
        },
        itemsContainerClass: "lkt-field--toggle-button-group-options",
        itemContainerClass: (B, N) => {
          let q = [];
          return V($i)(B, s.value, e.multiple) && q.push("is-active"), u.value === N && q.push("is-focused"), B.disabled && q.push("is-disabled"), q.join(" ");
        },
        itemSlotComponent: Vt(nt),
        itemSlotData: {
          optionSlot: e.optionSlot,
          ...
          multiple: e.multiple,
          focusedOptionIndex: u.value,
          fieldType: V(G).ToggleButtonGroup
        },
        itemSlotEvents: {
          click: (B, N) => {
            _(B);
...
}), Cu = { class: "lkt-field--range-opts" }, _u = { class: "lkt-field--range-track" }, wu = ["value", "min", "max", "step"], ku = /* @__PURE__ */ xe({
  ...
  setup(e, { expose: t, emit: l }) {
    const n = l, i = e, s = K(null), u = K(i.modelValue), f = K(-1), o = K(!1), b = K([...Xe(i.options, i.prop)]), c = K(!0);
    ie(c, (M) => {
      M || Ee(() => {
        c.value = !0;
      });
      ...
      var U;
      !M && ((U = i.optionsConfig) != null && U.autoPickFirstOptionIfEmpty) ? (i.pickedOptions.splice(0, i.pickedOptions.length), Ee(() => {
        ji({
          value: u,
          optionValueType: i.optionValueType,
          multiple: i.multiple,
      ...
      D.increment({ opts: M }), D.changed() && (b.value = Xe(M, i.prop), z());
    }, { deep: !0 });
    const g = K(""), k = K(null), S = K(i.pickedOptions);
    ie(S, (M) => {
      n("update:pickedOptions", M);
    });
    const x = K(!1), L = K(i.showOptions);
    ie(L, (M) => {
      n("update:showOptions", M), Ee(() => {
        M || (d.value = !1, r.value = !1, a.value = !1), x.value = L.value;
      });
    });
    ...
    const p = () => {
      ...
      i.searchable ? (d.value = !1, r.value = !0, a.value = !0, L.value = !0, Ee(() => {
        p();
      })) : (d.value = !0, r.value = !1, a.value = !0, L.value = !0);
    };
    t({
      doClear: () => {
        i.multiple ? u.value.splice(0, u.value.length) : u.value = "", S.value.splice(0, S.value.length), Ee(() => {
          z();
        });
      },
      doUndo: (M) => {
        if (i.multiple) {
          ...
          u.value = M;
        S.value.splice(0, S.value.length), Ee(() => {
          z();
        });
      },
      keepFocused: p,
    ...
    }), ie(() => i.pickedOptions, (M) => {
      n("change"), S.value = M;
    }, { deep: !0 });
    const C = J(() => !i.multiple && i.searchable && a.value), w = (M) => {
      var D, P;
      (i.multiple ? Zi({
        option: M,
        value: u,
    ...
    const T = J(() => b.value.map((M) => M.value).sort()), B = J(() => T.value[0]), N = J(() => T.value[T.value.length - 1]), q = (M, U) => {
      var W;
      let D = b.value.length, P = window.getComputedStyle((W = s.value) == null ? void 0 : W.closest(".lkt-field--range-track"), null).getPropertyValue("padding-left");
      P = parseFloat(P);
      const E = [
        "position: absolute",
        "top: 0"
      ...
      let A = 100 / (D - 1), $ = b.value.map((Z, te) => te).filter((Z) => ![0, H, D - 1].includes(Z)), R = $.findIndex((Z) => Z === U), O = $[R];
      return U < H ? [
        ...E,
        `left: calc(${O * A}% + ${P}px)`,
        "transform: translateX(-50%)"
      ...
      return F(), ue("div", Cu, [
        ...
        o.value ? (F(), Y(D, ae({
          ...
          itemDisplayChecker: (P) => {
            var E;
            return V(yt)(P, g.value, !0, (E = e.optionsConfig) == null ? void 0 : E.filter);
          },
          itemsContainerClass: "lkt-field--dropdown-options lkt-field--range-options",
          itemContainerClass: (P, E) => {
            let H = [];
            return V($i)(P, u.value, e.multiple) && H.push("is-active"), f.value === E && H.push("is-focused"), P.disabled && H.push("is-disabled"), H.join(" ");
          },
          itemContainerStyle: (P, E) => q(P, E),
          itemSlotComponent: Vt(nt),
          itemSlotData: {
            optionSlot: e.optionSlot,
            editable: e.editable,
  ...
  setup(e, { emit: t }) {
    const l = t, n = e, i = K(n.modelValue), s = J(() => typeof n.max == "boolean" || i.value.length < n.max ? ["inline-create"] : []), u = (g) => l("change", g), f = (g) => l("uploading", g), o = (g) => l("upload-success", g), b = (g) => l("upload-error", g), c = (g) => l("picked-files", g);
    return ie(() => n.modelValue, (g) => i.value = g, { deep: !0 }), ie(i, (g) => l("update:modelValue", g), { deep: !0 }), (g, k) => {
      const S = he("lkt-table");
      return F(), Y(S, ae({
        type: "item",
        modelValue: i.value,
        ...
        item: ye(({ item: x, index: L, isLoading: a, canCreate: r, canRead: d, canUpdate: h, canDrop: p, doDrop: v }) => {
          var m, y;
          return [
            de(no, {
...
}), Su = ["data-show-ui", "data-labeled"], Tu = ["for", "innerHTML"], Eu = { class: "lkt-field-content" }, Lu = {
  key: 0,
  class: "lkt-field--atn-btn-container"
}, Bu = {
  key: 1,
  class: "lkt-field--icon"
}, zu = ["value", "type", "name", "id", "disabled", "readonly", "placeholder", "tabindex", "autocomplete", "min", "max", "step"], Nu = ["value", "type", "name", "id", "disabled", "readonly", "placeholder", "tabindex", "autocomplete", "min", "max", "step"], Ru = ["name", "id", "disabled", "readonly", "placeholder", "tabindex", "autocomplete"], Au = ["name", "id", "disabled", "readonly", "placeholder", "tabindex", "autocomplete"], Iu = {
  key: 4,
  class: "lkt-field--info-nav"
}, Vu = ["innerHTML"], Dt = /* @__PURE__ */ xe({
  __name: "LktField",
  props: /* @__PURE__ */ Lo({
  ...
  setup(e, { expose: t, emit: l }) {
    const n = l, i = sl(), s = e, u = zo(16), f = K(!1), o = K(!1), b = J(() => s.validation.reportLevel ? s.validation.reportLevel : Ze.Error);
    ...
    s.multiple && Ho.includes(s.type) ? (!r || !Array.isArray(r)) && (r = []) : pt.includes(s.type) ? typeof r != "boolean" && (r = !1) : [G.Date, G.DateTime].includes(s.type) && !k ? k = ee.defaultDateIcon : s.type === G.Time && !k ? k = "lkt-icn-clock" : s.type === G.Number && s.canStep && a === "" && (a = ee.defaultNumberFeaturedButton), s.type === G.Table && (r = JSON.parse(JSON.stringify(s.modelValue)));
    const d = K(r), h = K(r), p = K(s.valid === !0), v = K(!0), m = K(!1), y = K(!1), _ = K(!1), C = K(!1), w = K([]), z = K(s.fileName), T = K(s.fileName), B = K(null), N = K(!1), q = K(!1), M = K([]), U = K(!1), D = J(() => Vo.value), P = J(() => (D.value, ee.dateReadFormat ? ee.dateReadFormat : ee.langDateReadFormat[D.value] ? ee.langDateReadFormat[D.value] : ee.defaultDateReadFormat ? ee.defaultDateReadFormat : "Y-m-d")), E = h, H = K(typeof E.value == "object" ? JSON.parse(JSON.stringify(E.value)) : E.value), A = J(() => s.type === G.Textarea ? "textarea" : s.type === G.Html ? "div" : "input"), $ = J(() => {
      if ([G.Date, G.DateTime].includes(s.type))
        return h.value !== d.value;
      if (s.type === G.Select || s.type === G.Radio) {
        if (s.multiple && s.optionValueType !== "option") {
          let I = new lt({ v: H.value });
          return I.increment({ v: E.value }), I.changed();
        }
      } else if (s.type === G.Table) {
        let I = new lt({ v: H.value });
        return I.increment({ v: E.value }), I.changed();
      }
      return E.value !== H.value;
    }), R = J(() => typeof s.disabled == "function" ? s.disabled(s.prop) : s.disabled), O = J(() => {
      if (!ce.value)
        return 0;
      let I = 0;
      return Ct.value && ++I, _t.value && ++I, Qe.value && ++I, Tt.value && ++I, fl.value && ++I, hl.value && ++I, dl.value && ++I, Ht.value && ++I, et.value && ++I, (s.customButtonText || s.customButtonClass) && ++I, typeof s.createButton == "object" && ++I, I > 1 && [
        G.Textarea,
        G.Html,
        G.Table,
        G.Radio
      ].includes(s.type) || I > 0 && s.infoButtonEllipsis ? 1 : I;
    }), W = J(() => Oe.value && a === "i18n" || Ve.value && a === "password" || Te.value && a === "subtract"), Z = J(() => O.value > 0), te = J(() => s.autocomplete === !0 ? "on" : "off"), X = J(() => {
      var I;
      return [G.Date, G.DateTime].includes(s.type) ? h.value !== "" : [G.Select, G.Radio].includes(s.type) ? (I = s.optionsConfig) != null && I.zeroMeansEmpty ? !(h.value === "" || h.value === 0) : h.value !== "" : E.value !== "";
    }), Q = J(() => s.type === G.Password && m.value === !0 ? "text" : s.type === G.Email ? "email" : s.type === G.Password ? "password" : s.type === G.Number ? "number" : s.type === G.Tel ? "tel" : s.type === G.Search ? "search" : s.type === G.Color ? "color" : s.type === G.Range ? "range" : "text"), ne = J(() => {
      var j;
      const I = [];
      if (s.multiple)
        switch (s.type) {
        ...
        I.push(`is-${s.type}`);
      return pt.includes(s.type) && (I.push("is-boolean"), E.value && I.push("is-checked")), $.value && I.push("is-changed"), R.value && I.push("is-disabled"), s.multiple && I.push("is-multiple"), W.value && I.push("with-atn-btn"), Z.value && I.push("with-info-btn"), s.mandatory && ce.value && I.push("is-mandatory-field"), ce.value && y.value && I.push("has-focus"), N.value && I.push("show-options"), s.searchable && U.value && I.push("is-searching"), s.hidden && I.push("lkt-hidden-field"), s.class && I.push(s.class), s.type !== G.Range && ((j = s.validation) == null ? void 0 : j.type) === ui.Auto && C.value && _.value && (w.value.length > 0 ? I.push("is-invalid") : I.push("is-valid")), [G.Range, G.Radio, G.Select].includes(s.type) && I.push(`picked-value--${E.value}`), [G.Textarea, G.Html].includes(s.type) && I.push("is-lg"), [G.Image].includes(s.type) && I.push("is-xl"), s.multiple && [G.Select, G.Radio].includes(s.type) && I.push("is-lg"), s.multiple && (ce.value ? I.push(`has-multiple-display-${s.multipleDisplayEdition}`) : I.push(`has-multiple-display-${s.multipleDisplay}`)), O.value > 0 && I.push("has-icons", `has-icons-${O.value}`), I.push(ce.value ? "is-editable" : "is-read"), s.type !== G.Range && (I.push(p.value ? "is-valid" : "is-error"), I.push(X.value ? "is-filled" : "is-empty")), I.join(" ");
    }), fe = J(() => {
      var I;
      return typeof E.value == "number" ? (D.value, (I = ee.langNumberFormat[D.value]) != null && I.amountOfDecimals ? Sl(
        E.value,
      ...
      ) : E.value.toString()) : s.type === G.Html ? ll(E.value) : E.value;
    }), re = J(() => {
      let I = qe(s.min, s.prop);
      return typeof I == "string" ? parseFloat(I) : typeof I == "number" ? I : !1;
    }), se = J(() => {
      let I = qe(s.max, s.prop);
      return typeof I == "string" ? parseFloat(I) : typeof I == "number" ? I : !1;
    }), ve = J(() => {
      var I, j, be, ze;
      if (pt.includes(s.type)) {
        if (E.value === !0 && typeof s.configOn == "object")
          return tl(
            li(((I = s.configOn) == null ? void 0 : I.label) ?? s.label),
            ((j = s.configOn) == null ? void 0 : j.labelIcon) ?? s.labelIcon,
            s.labelIconAtEnd
          );
        if (E.value !== !0 && typeof s.configOff == "object")
          return tl(
            li(((be = s.configOff) == null ? void 0 : be.label) ?? s.label),
    ...
    }), me = J(() => li(s.placeholder)), Ne = J(() => li(s.searchPlaceholder)), Ce = J(() => typeof c == "function" ? c(s.prop) : qe(c, s.prop)), ce = J(() => typeof s.readMode == "function" ? !s.readMode(s.prop) : !qe(s.readMode, s.prop)), Be = J(() => {
      ...
      if (typeof s.modalData == "object" && !Array.isArray(s.modalData)) {
        let I = {};
        for (let j in s.modalData)
          I[j] = qe(s.modalData[j], s.prop);
        return I;
      }
      return s.modalData;
    }), Ge = J(() => typeof k == "function" ? k(s.prop) : qe(k, s.prop)), Fe = J(() => s.type === G.File ? ee.acceptTypes.file : s.type === G.Image ? ee.acceptTypes.image : ""), Je = J(() => s.errorMessage), Ue = J(() => s.infoMessage), Te = J(() => s.canStep && ce.value && s.type === G.Number), Ht = J(() => s.canStep && ce.value && s.type === G.Number && a !== "subtract"), et = J(() => s.canStep && ce.value && s.type === G.Number), Pe = J(() => s.canUndo && $.value && ce.value && !Fo.includes(s.type)), Ie = J(() => s.canClear && X.value && ce.value && !Uo.includes(s.type)), Oe = J(() => s.canI18n && typeof h.value == "object" && ce.value), Ve = J(() => s.type === G.Password && s.showPassword && X.value && ce.value), Ct = J(() => Pe.value && !s.infoButtonEllipsis), _t = J(() => Ie.value && !s.infoButtonEllipsis), Qe = J(() => Ve.value && !s.infoButtonEllipsis && a !== "password"), Tt = J(() => Oe.value && !s.infoButtonEllipsis && a !== "i18n"), dl = J(() => s.type === G.Select), fl = J(() => s.allowReadModeSwitch && !s.infoButtonEllipsis), hl = J(() => typeof s.fileUploadButton == "object" && Object.keys(s.fileUploadButton).length > 0), pl = () => {
      Ee(() => {
      ...
      var j;
      let I = [];
      if ((j = s.validation) != null && j.resource) {
        n("validating");
        const be = await rl(s.validation.resource, {
          ...s.validation.resourceData,
          value: E.value
        });
        if (be) {
          let ze = be.data === !0;
          !ze && E.value === d.value && (ze = !0), I.push(Se.createRemoteResponse(be, ze ? _e.Ok : _e.Ko));
        }
        n("validation", be);
      }
      return I;
    ...
    const so = K(new lt($e.value));
    ie($e, (I) => {
      let j = new lt(so.value.getOriginalData());
      j.increment(I), j.changed() && (n("update:modelValue", I), Et && clearTimeout(Et), Et = setTimeout(() => {
        wt();
      }, 150));
    }, { deep: !0 }), ie(() => {
      var I;
      return (I = s.validation) == null ? void 0 : I.checkEqualTo;
    }, () => wt()), ie(() => s.valid, (I) => p.value = I), ie(() => s.modelValue, (I) => {
      if ([G.Card].includes(s.type))
        E.value = I;
      else if (Ae.value === pe.DateInput)
        E.value = I;
      else if (s.canI18n) {
        let j = new lt($e.value);
        j.increment(I), j.changed() && ($e.value = JSON.parse(JSON.stringify(I)) ?? {});
      } else
        E.value = I;
    }, { deep: !0 }), ie(E, (I) => {
      typeof I == "object" && !Array.isArray(I) && ![G.Card].includes(s.type) ? h.value[D.value] = I : h.value = I, s.type === G.Number && bo(I);
    }, { deep: !0 });
    let Et;
    ie(h, (I) => {
      var j;
      q.value && ce.value && (n("update:modelValue", I), typeof ((j = s.events) == null ? void 0 : j.changed) == "function" && s.events.changed({
        prop: s.prop
    ...
    const at = (I) => {
      var j, be, ze;
      return !!((j = s.validation.defaultValueOverrides) != null && j.includes(I) && ((ze = (be = s.validation) == null ? void 0 : be.defaultValue) == null ? void 0 : ze.length) > 0);
    }, wt = async () => {
      let I = [];
      if (s.validation.type === ui.External)
        s.validation.defaultValue !== void 0 && (I = [...s.validation.defaultValue]);
      else {
        const ze = await ao(), st = ro();
        I = [...ze, ...st];
      }
      let j = I.filter((ze) => ze.status === _e.Ko).length === 0;
      if (v.value = j, s.type === G.Range) return;
      new lt({
        status: w.value
      }).increment(I).changed() && (w.value.splice(0, w.value.length - 1), w.value = I), p.value = j, n("validation-status", I);
    }, ro = () => {
      var st, ht, Ft, Ut, Pt, Wt, $t, qt, Zt, jt, Gt, Kt, Yt, Re;
      let I = [], j = E.value;
      s.canI18n && (j = $e[D]);
      let be = re.value, ze = se.value;
      if (s.type === G.Number && typeof s.min < "u" && typeof s.max < "u" && (j < be || j > ze) && (I.push(Se.createNumBetween(be, ze, _e.Ko)), p.value = !1, b.value === Ze.Error))
        return I;
      if (s.mandatory) {
        switch (s.type) {
          case G.Select:
          case G.Radio:
          case G.ToggleButtonGroup:
            s.multiple && M.value.length === 0 ? at(ut.Empty) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createEmpty(_e.Ko)) : !s.multiple && !j && (at(ut.Empty) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createEmpty(_e.Ko)));
            break;
          case G.Html:
            No(ll(j)).length === 0 && (at(ut.Empty) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createEmpty(_e.Ko)));
            break;
          default:
            ![G.Number].includes(s.type) && j === "" && (at(ut.Empty) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createEmpty(_e.Ko)));
        }
        if (b.value === Ze.Error && I.length > 0) return I;
      }
      if (be > 0 && (s.type !== G.Number && j.length < be ? at(ut.MinStringLength) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createMinStr(_e.Ko)) : j < be && (at(ut.MinNumber) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createMinNum(_e.Ko)))), ze > 0 && (s.type !== G.Number && j.length > ze ? at(ut.MaxStringLength) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createMaxStr(_e.Ko)) : j > ze && (at(ut.MaxNumber) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createMaxNum(_e.Ko)))), s.type === G.Email && (Ro(j) || (at(ut.Email) ? I = [...I, ...s.validation.defaultValue] : I.push(Se.createEmail(_e.Ko)))), Po.includes(s.type) && (ca(I, b.value, j, (st = s.validation) == null ? void 0 : st.minNumbers, (ht = s.validation) == null ? void 0 : ht.maxNumbers), da(I, b.value, j, (Ft = s.validation) == null ? void 0 : Ft.minUpperChars, (Ut = s.validation) == null ? void 0 : Ut.maxUpperChars), fa(I, b.value, j, (Pt = s.validation) == null ? void 0 : Pt.minLowerChars, (Wt = s.validation) == null ? void 0 : Wt.maxLowerChars), ha(I, b.value, j, ($t = s.validation) == null ? void 0 : $t.minChars, (qt = s.validation) == null ? void 0 : qt.maxChars), pa(I, b.value, j, (Zt = s.validation) == null ? void 0 : Zt.minSpecialChars, (jt = s.validation) == null ? void 0 : jt.maxSpecialChars)), (Gt = s.validation) != null && Gt.checkEqualTo) {
        let rt = typeof ((Kt = s.validation) == null ? void 0 : Kt.checkEqualTo) == "function" ? (Yt = s.validation) == null ? void 0 : Yt.checkEqualTo() : (Re = s.validation) == null ? void 0 : Re.checkEqualTo;
        j !== rt && I.push(Se.createEqualTo(rt, _e.Ko));
      }
      return I;
    }, ai = J(() => {
      var I, j, be, ze, st, ht;
      return ((I = s.validation) == null ? void 0 : I.trigger) === !1 ? !1 : ((j = s.validation) == null ? void 0 : j.trigger) === Qi.Always || ((be = s.validation) == null ? void 0 : be.type) === ui.External && ((ze = s.validation) == null ? void 0 : ze.defaultValue.length) > 0 || ((st = s.validation) == null ? void 0 : st.trigger) === Qi.Focus && C.value ? !0 : ((ht = s.validation) == null ? void 0 : ht.trigger) === Qi.Blur && _.value && C.value;
    }), Gi = J(() => {
      var I, j, be, ze;
      return s.validation.type === ui.External ? w.value.length > 0 ? 3 : 0 : !ai.value && ((j = (I = s.validation) == null ? void 0 : I.defaultValue) == null ? void 0 : j.length) > 0 ? 1 : ai.value ? 2 : w.value.length === 0 ? ((ze = (be = s.validation) == null ? void 0 : be.defaultValue) == null ? void 0 : ze.length) > 0 ? 1 : 0 : 2;
    }), Ki = J(() => {
      var I, j;
      switch (Gi.value) {
        case 1:
          return Array.isArray((I = s.validation) == null ? void 0 : I.defaultValue) ? (j = s.validation) == null ? void 0 : j.defaultValue : [];
        case 2:
        case 3:
          return w.value;
        default:
    ...
    }), uo = J(() => !(Ki.value.length === 0 || s.validation.report === !1 || s.validation.report === El.Inline || !s.validation.report || Gi.value === 2 && !ai.value)), co = J(() => !(Ki.value.length === 0 || s.validation.report === !1 || s.validation.report === El.Message || !s.validation.report || Gi.value === 1 && !ai.value)), Yi = () => {
      var I;
      switch (Ae.value) {
        case pe.HtmlInput:
        ...
        case pe.FileInput:
          ...
          return;
        case pe.SelectInput:
          (I = L.value) == null || I.doUndo(H.value);
          return;
        case pe.TableInput:
      ...
      return Lt();
    }, ri = (I) => n("keydown", I), Lt = (I) => {
      C.value = !0, y.value = !0, wt(), n("focus", I);
    }, Bt = (I) => {
      setTimeout(() => {
        if (!(s.searchable && U.value)) {
          ...
          _.value = !0, N.value = !1, y.value = !1, wt(), n("blur", I);
        }
      }, 100);
    }, Xi = (I) => {
      C.value = !0, y.value = !0, n("focus", I);
    }, Ji = (I) => {
      _.value = !0, y.value = !1, n("blur", I);
    }, zt = () => {
      C.value = !0, y.value = !0, wt(), s.searchable && ho(), n("focus");
    }, Nt = () => {
      _.value = !0, y.value = !1, n("blur");
    }, Ke = (I) => {
      n("change", I, E.value);
    }, kt = (I) => {
      n("click", I);
    }, gl = (I) => n("click-info", I), mo = (I) => n("click-error", I), vl = () => {
      let I = s.step ?? 1;
      typeof I == "string" && (I = parseFloat(I));
      let j = String(I).split(".")[0].length, be = parseFloat(E.value);
      isNaN(be) && (be = 0), (!re.value || be > re.value) && (E.value = parseFloat((be - I).toFixed(j)));
    }, go = () => {
      let I = s.step ?? 1;
      typeof I == "string" && (I = parseFloat(I));
      let j = String(I).split(".")[0].length, be = parseFloat(E.value);
      isNaN(be) && (be = 0), (!se.value || be < se.value) && (E.value = parseFloat((be + I).toFixed(j)));
    }, vo = () => {
      ce.value && pl();
    }, bl = (I) => {
      Nl({
      ...
      let j = Number(I), be = Qo(j, re.value, se.value);
      return j !== be ? (E.value = be, !0) : !1;
    };
    t({
      Identifier: u,
      reset: Yi,
      ...
      click: () => {
        ...
        switch (s.type) {
          case G.File:
            return (I = L.value) == null ? void 0 : I.click();
        }
        B.value.click();
      }
    });
    const yo = J(() => s.editSlot !== "" && typeof ee.customEditSlots[s.editSlot] < "u"), Co = J(() => ee.customEditSlots[s.editSlot]);
    ot(() => {
      s.type === G.Select && s.multiple && (U.value = !0), wt(), q.value = !0;
    });
    const _o = J(() => pt.includes(s.type) && !R.value ? "label" : "div"), wo = J(() => pt.includes(s.type) ? {
      for: u
    } : {}), ko = J(() => {
      switch (s.type) {
        case G.Select:
        ...
        case G.Date:
        case G.DateTime:
          return Ln(h.value, P.value);
        case G.File:
        case G.Image:
          return h.value;
        default:
          return s.canI18n ? $e.value[D.value] : E.value;
      }
    }), xo = J(() => typeof s.canRender == "function" ? s.canRender({
      prop: s.prop
    }) : typeof s.canRender == "boolean" ? s.canRender : !0), So = J(() => typeof s.canDisplay == "function" ? s.canDisplay({
      prop: s.prop
    }) : typeof s.canDisplay == "boolean" ? s.canDisplay : !0), Ae = J(() => {
      var I, j;
      if (pt.includes(s.type)) return pe.BooleanInput;
      switch (s.type) {
        case G.Color:
          return s.multiple ? pe.MultipleColorInput : pe.SingleColorInput;
        case G.Card:
          return s.multiple ? pe.MultipleCardInput : pe.SingleCardInput;
        case G.File:
        case G.Image:
          return pe.FileInput;
        case G.Date:
        ...
        case G.Time:
          return pe.TimeInput;
        case G.Select:
          return pe.SelectInput;
        case G.Calc:
          return pe.CalcInput;
        case G.Search:
          return pe.SearchInput;
        case G.Html:
          return pe.HtmlInput;
        case G.Table:
          return pe.TableInput;
        case G.Range:
          if (s.options.length > 0)
            return pe.RangeOptsInput;
        case G.Radio:
        case G.DayOfWeek:
          return pe.RadioInput;
        case G.ToggleButtonGroup:
          return pe.ToggleButtonGroupInput;
        default:
          if (A.value === "input")
            return s.options.length > 0 || (I = s.optionsConfig) != null && I.http && Object.keys((j = s.optionsConfig) == null ? void 0 : j.http).length > 0 ? pe.SelectInput : pe.TextInput;
          if (A.value === "textarea")
            return pe.TextareaInput;
      }
    });
    return (I, j) => {
      var ht, Ft, Ut, Pt, Wt, $t, qt, Zt, jt, Gt, Kt, Yt;
      const be = he("lkt-button"), ze = he("lkt-table"), st = he("lkt-polymorphic-element");
      return xo.value ? De((F(), ue("div", {
        key: 0,
        class: ct(["lkt-field", ne.value]),
        "data-show-ui": Z.value,
        "data-labeled": !V(i).label,
        ref_key: "container",
        ref: B
      }, [
        V(i).label ? it(I.$slots, "label", { key: 0 }) : oe("", !0),
        !V(i).label && ve.value !== "" && !V(pt).includes(e.type) ? (F(), ue("label", {
          key: 1,
          for: V(u),
          class: "lkt-field--label",
          innerHTML: ve.value
        ...
        we("div", Eu, [
          W.value ? (F(), ue("div", Lu, [
            e.featuredButton === "password" && Ve.value ? (F(), Y(nl, {
              key: 0,
              modelValue: m.value,
              "onUpdate:modelValue": j[0] || (j[0] = (Re) => m.value = Re),
              "is-featured": ""
            }, null, 8, ["modelValue"])) : oe("", !0),
            Oe.value && V(a) === "i18n" && e.canI18n && B.value ? (F(), Y(Rl, {
              key: 1,
            ...
            Te.value && V(a) === "subtract" ? (F(), Y(be, ae({ key: 2 }, {
              class: "lkt-field--info-btn",
              icon: "lkt-icn-less",
              disabled: V(E) === re.value
            }, { onClick: vl }), null, 16)) : oe("", !0)
          ])) : oe("", !0),
          Ge.value && (!ce.value || ![V(G).Time, V(G).Date, V(G).DateTime].includes(e.type)) ? (F(), ue("div", Bu, [
            we("i", {
              class: ct(Ge.value)
            }, null, 2)
          ])) : oe("", !0),
          ce.value ? (F(), Y(dt(_o.value), ae({ key: 2 }, wo.value, { class: "lkt-field-main" }), {
            default: ye(() => {
              var Re, rt, Xt, Jt, Qt, ei, ti, ii, wl;
              return [
                V(i).edit ? (F(), ue("div", {
                  key: 0,
                  onClick: kt
                ...
                ])) : Ae.value === V(pe).BooleanInput ? (F(), Y(ba, {
                  key: 2,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[1] || (j[1] = (le) => We(E) ? E.value = le : null),
                  ref_key: "inputElement",
                  ref: L,
                  id: V(u),
                  name: e.name,
                  ...
                  onFocus: Xi,
                  onBlur: Ji
                }, null, 8, ["modelValue", "id", "name", "type", "label", "editable", "focusing", "disabled", "readonly"])) : Ae.value === V(pe).MultipleColorInput ? (F(), Y(ua, {
                  key: 3,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[2] || (j[2] = (le) => We(E) ? E.value = le : null),
                  ref_key: "inputElement",
                  ref: L,
                  "edit-mode": ce.value,
                  min: re.value,
                  max: se.value
                }, null, 8, ["modelValue", "edit-mode", "min", "max"])) : Ae.value === V(pe).SingleColorInput ? (F(), Y(Bn, {
                  key: 4,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[3] || (j[3] = (le) => We(E) ? E.value = le : null),
                  onChange: Ke,
                  ref_key: "inputElement",
                  ref: L
                }, null, 8, ["modelValue"])) : Ae.value === V(pe).FileInput && e.multiple ? (F(), Y(xu, {
                  key: 5,
                  modelValue: h.value,
                  "onUpdate:modelValue": j[4] || (j[4] = (le) => h.value = le),
                  "file-name": T.value,
                  "onUpdate:fileName": j[5] || (j[5] = (le) => T.value = le),
                  ref_key: "inputElement",
                  ref: L,
                  id: V(u),
                  ...
                  onUploadError: yl,
                  onPickedFiles: _l
                }, null, 8, ["modelValue", "file-name", "id", "file-upload-http", "tabindex", "name", "placeholder", "accept", "focusing", "disabled", "readonly", "is-image", "file-browser-config", "call-to-action-button", "table-config"])) : Ae.value === V(pe).FileInput ? (F(), Y(no, {
                  key: 6,
                  modelValue: h.value,
                  "onUpdate:modelValue": j[6] || (j[6] = (le) => h.value = le),
                  "file-name": T.value,
                  "onUpdate:fileName": j[7] || (j[7] = (le) => T.value = le),
                  ref_key: "inputElement",
                  ref: L,
                  id: V(u),
                  tabindex: e.tabindex,
                  resource: (Re = e.fileUploadHttp) == null ? void 0 : Re.resource,
                  "resource-data": (rt = e.fileUploadHttp) == null ? void 0 : rt.data,
                  name: e.name,
                  placeholder: me.value,
                  accept: Fe.value,
                  focusing: y.value,
                  ...
                  onUploadError: yl,
                  onPickedFiles: _l
                }, null, 8, ["modelValue", "file-name", "id", "tabindex", "resource", "resource-data", "name", "placeholder", "accept", "focusing", "disabled", "readonly", "is-image", "file-browser-config", "call-to-action-button"])) : Ae.value === V(pe).DateInput ? (F(), Y(du, {
                  key: 7,
                  modelValue: h.value,
                  "onUpdate:modelValue": j[8] || (j[8] = (le) => h.value = le),
                  id: V(u),
                  tabindex: e.tabindex,
                  lang: D.value,
                  name: e.name,
                  icon: Ge.value,
                  "is-date-time": V(G).DateTime === e.type,
                  tooltip: e.tooltipConfig
                }, null, 8, ["modelValue", "id", "tabindex", "lang", "name", "icon", "is-date-time", "tooltip"])) : Ae.value === V(pe).TimeInput ? (F(), Y(vu, {
                  key: 8,
                  modelValue: h.value,
                  "onUpdate:modelValue": j[9] || (j[9] = (le) => h.value = le),
                  id: V(u),
                  tabindex: e.tabindex,
                  lang: D.value,
                  name: e.name,
                  icon: Ge.value,
                  tooltip: e.tooltipConfig
                }, null, 8, ["modelValue", "id", "tabindex", "lang", "name", "icon", "tooltip"])) : Ae.value === V(pe).SelectInput ? (F(), Y(vn, ae({
                  key: 9,
                  ref_key: "inputElement",
                  ref: L,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[10] || (j[10] = (le) => We(E) ? E.value = le : null),
                  "show-options": N.value,
                  "onUpdate:showOptions": j[11] || (j[11] = (le) => N.value = le),
                  "picked-options": M.value,
                  "onUpdate:pickedOptions": j[12] || (j[12] = (le) => M.value = le)
                }, {
                  ...
                  optionValueType: e.optionValueType,
                  referrer: B.value,
                  isAutoCompleteText: e.type !== V(G).Select
                }, {
                  onFocus: zt,
                  onBlur: Nt,
                  onChange: Ke
                }), null, 16, ["modelValue", "show-options", "picked-options"])) : Ae.value === V(pe).RadioInput ? (F(), Y(bu, ae({
                  key: 10,
                  ref_key: "inputElement",
                  ref: L,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[13] || (j[13] = (le) => We(E) ? E.value = le : null),
                  "show-options": N.value,
                  "onUpdate:showOptions": j[14] || (j[14] = (le) => N.value = le),
                  "picked-options": M.value,
                  "onUpdate:pickedOptions": j[15] || (j[15] = (le) => M.value = le)
                }, {
                  searchable: e.searchable,
                  searchMode: U.value,
                  multiple: e.multiple,
                  ...
                  optionValueType: e.optionValueType,
                  referrer: B.value,
                  isDayOfWeek: e.type === V(G).DayOfWeek
                }, {
                  onFocus: zt,
                  onBlur: Nt,
                  onChange: Ke
                }), null, 16, ["modelValue", "show-options", "picked-options"])) : Ae.value === V(pe).RangeOptsInput ? (F(), Y(ku, ae({
                  key: 11,
                  ref_key: "inputElement",
                  ref: L,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[16] || (j[16] = (le) => We(E) ? E.value = le : null),
                  "show-options": N.value,
                  "onUpdate:showOptions": j[17] || (j[17] = (le) => N.value = le),
                  "picked-options": M.value,
                  "onUpdate:pickedOptions": j[18] || (j[18] = (le) => M.value = le)
                }, {
                  searchable: e.searchable,
                  searchMode: U.value,
                  multiple: e.multiple,
                  ...
                  onBlur: Nt,
                  onChange: Ke
                }), null, 16, ["modelValue", "show-options", "picked-options"])) : Ae.value === V(pe).ToggleButtonGroupInput ? (F(), Y(yu, ae({
                  key: 12,
                  ref_key: "inputElement",
                  ref: L,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[19] || (j[19] = (le) => We(E) ? E.value = le : null),
                  "show-options": N.value,
                  "onUpdate:showOptions": j[20] || (j[20] = (le) => N.value = le),
                  "picked-options": M.value,
                  "onUpdate:pickedOptions": j[21] || (j[21] = (le) => M.value = le)
                }, {
                  searchable: e.searchable,
                  searchMode: U.value,
                  multiple: e.multiple,
                  ...
                  onBlur: Nt,
                  onChange: Ke
                }), null, 16, ["modelValue", "show-options", "picked-options"])) : Ae.value === V(pe).CalcInput ? (F(), Y(jr, {
                  key: 13,
                  ref_key: "inputElement",
                  ref: L,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[22] || (j[22] = (le) => We(E) ? E.value = le : null),
                  id: V(u),
                  tabindex: e.tabindex,
                  name: e.name,
                  editable: ce.value,
                  ...
                  onFocus: Xi,
                  onBlur: Ji
                }, null, 8, ["modelValue", "id", "tabindex", "name", "editable", "focusing", "disabled", "readonly", "options"])) : Ae.value === V(pe).SearchInput ? (F(), Y(Yr, {
                  key: 14,
                  ref_key: "inputElement",
                  ref: L,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[23] || (j[23] = (le) => We(E) ? E.value = le : null),
                  id: V(u),
                  tabindex: e.tabindex,
                  name: e.name,
                  editable: ce.value,
                  ...
                  disabled: R.value,
                  readonly: e.readonly,
                  "options-resource": (Jt = (Xt = e.optionsConfig) == null ? void 0 : Xt.http) == null ? void 0 : Jt.resource,
                  container: B.value,
                  tooltip: e.tooltipConfig,
                  events: e.events,
                  ...
                  onFocus: Xi,
                  onBlur: Ji
                }, null, 8, ["modelValue", "id", "tabindex", "name", "editable", "focusing", "had-first-focus", "disabled", "readonly", "options-resource", "container", "tooltip", "events", "options-config"])) : Ae.value === V(pe).MultipleCardInput ? (F(), Y(hu, {
                  key: 15,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[24] || (j[24] = (le) => We(E) ? E.value = le : null),
                  id: V(u),
                  tabindex: e.tabindex,
                  name: e.name,
                  editable: ce.value,
                  ...
                  disabled: R.value,
                  readonly: e.readonly,
                  "options-resource": (ei = (Qt = e.optionsConfig) == null ? void 0 : Qt.http) == null ? void 0 : ei.resource,
                  modal: Ce.value,
                  "modal-key": V(g),
                  "modal-data": Be.value,
                  "item-type": V(x)
                  ...
                  V(i)["item-" + V(x)] ? {
                    name: "item",
                    fn: ye(({ item: le }) => [
                      it(I.$slots, "item-" + V(x), { item: le })
                    ]),
                    key: "0"
                  } : V(i).item ? {
                    name: "item",
                    fn: ye(({ item: le }) => [
                      it(I.$slots, "item", { item: le })
                    ]),
                    key: "1"
                  } : void 0
                ]), 1032, ["modelValue", "id", "tabindex", "name", "editable", "focusing", "had-first-focus", "disabled", "readonly", "options-resource", "modal", "modal-key", "modal-data", "item-type"])) : Ae.value === V(pe).SingleCardInput ? (F(), Y(oo, {
                  key: 16,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[25] || (j[25] = (le) => We(E) ? E.value = le : null),
                  id: V(u),
                  tabindex: e.tabindex,
                  name: e.name,
                  editable: ce.value,
                  ...
                  disabled: R.value,
                  readonly: e.readonly,
                  "options-resource": (ii = (ti = e.optionsConfig) == null ? void 0 : ti.http) == null ? void 0 : ii.resource,
                  modal: Ce.value,
                  "modal-key": V(g),
                  "modal-data": Be.value,
                  "item-type": V(x)
                ...
                ]), 1032, ["modelValue", "id", "tabindex", "name", "editable", "focusing", "had-first-focus", "disabled", "readonly", "options-resource", "modal", "modal-key", "modal-data", "item-type"])) : Ae.value === V(pe).TableInput ? (F(), Y(ze, ae({
                  key: 17,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[26] || (j[26] = (le) => We(E) ? E.value = le : null)
                }, {
                  ...(wl = e.optionsConfig) == null ? void 0 : wl.table,
                  editMode: ce.value
                }), null, 16, ["modelValue"])) : e.canI18n && Ae.value === V(pe).TextInput ? De((F(), ue("input", {
                  key: 18,
                  "onUpdate:modelValue": j[27] || (j[27] = (le) => $e.value[D.value] = le),
                  ref: (le) => L.value = le,
                  ...
                  [xl, $e.value[D.value]]
                ]) : Ae.value === V(pe).TextInput ? De((F(), ue("input", {
                  key: 19,
                  "onUpdate:modelValue": j[28] || (j[28] = (le) => We(E) ? E.value = le : null),
                  ref: (le) => L.value = le,
                  value: V(E),
                  type: Q.value,
                  name: e.name,
                  ...
                  [xl, V(E)]
                ]) : e.canI18n && Ae.value === V(pe).TextareaInput ? De((F(), ue("textarea", {
                  key: 20,
                  "onUpdate:modelValue": j[29] || (j[29] = (le) => $e.value[D.value] = le),
                  ref: (le) => L.value = le,
                  name: e.name,
                  id: V(u),
                  disabled: R.value,
                  ...
                  [St, $e.value[D.value]]
                ]) : Ae.value === V(pe).TextareaInput ? De((F(), ue("textarea", {
                  key: 21,
                  "onUpdate:modelValue": j[30] || (j[30] = (le) => We(E) ? E.value = le : null),
                  ref: (le) => L.value = le,
                  name: e.name,
                  id: V(u),
                  disabled: R.value,
                  ...
                  [St, V(E)]
                ]) : Ae.value === V(pe).HtmlInput ? (F(), Y(zr, {
                  key: 22,
                  ref_key: "inputElement",
                  ref: L,
                  modelValue: V(E),
                  "onUpdate:modelValue": j[31] || (j[31] = (le) => We(E) ? E.value = le : null),
                  id: V(u),
                  tabindex: e.tabindex,
                  name: e.name,
                  lang: D.value,
          ...
          ce.value ? oe("", !0) : (F(), Y(su, {
            ...
            download: V(S),
            anchor: (ht = e.optionsConfig) == null ? void 0 : ht.anchor,
            multiple: e.multiple,
          ...
          Z.value ? (F(), ue("div", Iu, [
            ...
            De(de(xn, { onClick: Yi }, null, 512), [
              [tt, Ct.value]
            ]),
            De(de(Sn, { onClick: ml }, null, 512), [
              [tt, _t.value]
            ]),
            e.type === V(G).Number ? De((F(), Y(be, ae({ key: 1 }, {
              class: "lkt-field--info-btn",
              icon: "lkt-icn-less",
              disabled: V(E) === re.value
            }, { onClick: vl }), null, 16)), [
            ...
            e.type === V(G).Number ? De((F(), Y(be, ae({ key: 2 }, {
              class: "lkt-field--info-btn",
              icon: "lkt-icn-more",
              disabled: V(E) === se.value
            }, { onClick: go }), null, 16)), [
              [tt, et.value]
            ]) : oe("", !0),
            co.value ? (F(), Y(be, ae({
            ...
            ce.value && hl.value ? (F(), Y(pu, {
              key: 5,
              config: e.fileUploadButton,
              "file-upload-http": e.fileUploadHttp
            }, null, 8, ["config", "file-upload-http"])) : oe("", !0),
            e.type === V(G).Password ? De((F(), Y(nl, {
              key: 6,
              modelValue: m.value,
              "onUpdate:modelValue": j[32] || (j[32] = (Re) => m.value = Re)
            }, null, 8, ["modelValue"])), [
              [tt, Qe.value]
            ]) : oe("", !0),
            Tt.value && B.value ? (F(), Y(Rl, {
              key: 7,
              translations: $e.value,
              type: e.type,
              referrer: B.value
            }, null, 8, ["translations", "type", "referrer"])) : oe("", !0),
            ce.value && fl.value ? (F(), Y(Tn, {
              key: 8,
              modelValue: ce.value,
              "onUpdate:modelValue": j[33] || (j[33] = (Re) => ce.value = Re),
              onClick: vo
            }, null, 8, ["modelValue"])) : oe("", !0),
            e.customButtonText || e.customButtonClass ? (F(), Y(be, {
              key: 9,
              text: e.customButtonText,
              class: "lkt-field--info-btn lkt-field--custom-btn",
              icon: e.customButtonClass
            }, null, 8, ["text", "icon"])) : oe("", !0),
            typeof e.createButton == "object" && e.createButton && ce.value ? (F(), Y(be, ae({ key: 10 }, {
              icon: "lkt-icn-add",
              ...e.createButton,
              modalData: {
                ...
                events: {
                  onCreate: () => {
                    var Re, rt, Xt, Jt, Qt, ei, ti, ii;
                    e.createButton && typeof ((Xt = (rt = (Re = e.createButton) == null ? void 0 : Re.modalData) == null ? void 0 : rt.events) == null ? void 0 : Xt.onCreate) == "function" && ((ei = (Qt = (Jt = e.createButton) == null ? void 0 : Jt.modalData) == null ? void 0 : Qt.events) == null || ei.onCreate()), typeof ((ti = e.events) == null ? void 0 : ti.itemCreated) == "function" && ((ii = e.events) == null || ii.itemCreated());
                  }
                }
              }
            }, { class: "lkt-field--info-btn" }), null, 16)) : oe("", !0),
            ce.value && typeof ((jt = e.optionsConfig) == null ? void 0 : jt.canRenderDropdown) > "u" || ((Gt = e.optionsConfig) == null ? void 0 : Gt.canRenderDropdown) === !0 ? De((F(), Y(ea, {
              key: 11,
              onClick: po
            }, null, 512)), [
              [tt, dl.value]
            ]) : oe("", !0),
            e.infoButtonEllipsis ? (F(), Y(Xo, {
              key: 12,
              "show-undo": Pe.value,
              "show-clear": Ie.value,
              "show-password": Ve.value,
              "show-edition": e.allowReadModeSwitch,
              "show-password-check": m.value,
              "onUpdate:showPasswordCheck": j[34] || (j[34] = (Re) => m.value = Re),
              "show-edition-check": ce.value,
              "onUpdate:showEditionCheck": j[35] || (j[35] = (Re) => ce.value = Re),
              onUndo: Yi,
              onClear: ml
            }, null, 8, ["show-undo", "show-clear", "show-password", "show-edition", "show-password-check", "show-edition-check"])) : oe("", !0)
          ])) : oe("", !0),
          (F(!0), ue(He, null, vt(e.endContent, (Re) => (F(), Y(st, ae({ ref_for: !0 }, Re), null, 16))), 256))
        ]),
        ce.value ? De((F(), Y(yn, {
          key: 2,
          items: Ki.value,
        ...
        q.value && (e.type === V(G).Select || e.type === V(G).Radio || e.type === V(G).ToggleButtonGroup || e.type === V(G).Table) ? (F(), Y(vn, ae({
          key: 3,
          ref_key: "inputElement",
          ref: L
        }, {
          modelValue: V(E),
          pickedOptions: M.value,
          showOptions: N.value,
          searchable: e.searchable,
          searchMode: U.value,
          multiple: e.multiple,
          ...
          onBlur: Nt,
          onChange: Ke,
          onLoaded: j[36] || (j[36] = (Re) => f.value = !0),
          onAutoloadStart: j[37] || (j[37] = (Re) => o.value = !0),
          onAutoloadEnd: j[38] || (j[38] = (Re) => o.value = !1)
        }), null, 16)) : oe("", !0)
      ], 10, Su)), [
        [tt, So.value]
      ]) : oe("", !0);
...
}), Du = { class: "lkt-file-entity-main" }, Mu = /* @__PURE__ */ xe({
  ...
  setup(e, { emit: t }) {
    const l = e, n = t, i = K(l.modelValue), s = K(0);
    let u;
    const f = () => {
      ++s.value, s.value === 1 ? u = setTimeout(() => {
        i.value.isPicked = !i.value.isPicked, s.value = 0;
      }, 225) : (clearTimeout(u), n("double-click", i.value), s.value = 0);
    }, o = J(() => i.value.isPicked ? "lkt-icn-checkbox" : "lkt-icn-checkbox-empty");
    return (b, c) => {
      const g = he("lkt-icon"), k = he("lkt-image");
      return F(), ue("div", {
        class: "lkt-file-entity-box",
        onClick: f
      }, [
        we("div", Du, [
          i.value.type !== V(Ye).Directory ? (F(), ue("i", {
            key: 0,
            class: ct(["lkt-file-entity-picked-indicator", o.value])
          }, null, 2)) : oe("", !0),
          i.value.type === V(Ye).Directory ? (F(), Y(g, Me(ae({ key: 1 }, {
            icon: "lkt-icn-folder",
            text: i.value.name
          })), null, 16)) : i.value.type === V(Ye).Image ? (F(), Y(k, Me(ae({ key: 2 }, {
            src: i.value.src,
            text: i.value.name
          })), null, 16)) : oe("", !0)
        ])
...
}), Ou = { class: "lkt-file-entity-details" }, Hu = {
  key: 0,
  class: "lkt-grid-1"
}, Fu = /* @__PURE__ */ xe({
  ...
  setup(e) {
    ...
    return (n, i) => {
      ...
      return F(), ue("div", Ou, [
        l.value.type === V(Ye).Image ? (F(), ue("div", Hu, [
          de(s, ae({
...
}), Uu = { class: "lkt-flex-row" }, Pu = { class: "lkt-flex-col-3" }, Wu = { class: "lkt-flex-column" }, $u = { class: "lkt-flex-col-9" }, qu = /* @__PURE__ */ xe({
  ...
  emits: [],
  setup(e, { emit: t }) {
    const l = e, n = K(!1), i = K([]), s = K({}), u = K(void 0), f = K(l.modelValue), o = (d) => {
      u.value = void 0, Ee(() => {
        u.value = d;
      });
    }, b = () => {
      ...
      f.value.forEach((h) => {
        let p = c(h, i.value);
        p && d.push(p);
      }), typeof l.onConfirmSelection == "function" && l.onConfirmSelection(d), Ko(l.modalName, l.modalKey);
    }, S = J(() => {
      var d;
      ...
      var d, h;
      (h = (d = l.fileBrowserConfig) == null ? void 0 : d.http) != null && h.resource && (n.value = !0, rl(l.fileBrowserConfig.http.resource, l.fileBrowserConfig.http.data).then((p) => {
        n.value = !1, i.value = p.data.map((v) => new zl(v)), i.value.length > 0 && o(i.value[0]), i.value.forEach((v, m) => {
          var _;
          let y = `unit-${m}`;
    ...
    return ie(u, (d) => {
      ...
      const p = he("lkt-menu"), v = he("lkt-accordion"), m = he("lkt-button"), y = he("lkt-table"), _ = he("lkt-item-crud"), C = he("lkt-modal");
      return F(), Y(C, {
        ...
        default: ye(() => [
          we("div", Uu, [
            we("div", Pu, [
              (F(!0), ue(He, null, vt(i.value, (w, z) => (F(), Y(v, ae({ ref_for: !0 }, {
                modelValue: z === 0,
                title: w.name,
                toggleMode: V(qo).Display,
                type: i.value.length === 1 ? V(el).Always : V(el).Auto
              }), {
                default: ye(() => [
                  we("div", Wu, [
                    de(p, ae({ ref_for: !0 }, {
            ...
            we("div", $u, [
              u.value ? (F(), Y(v, Me(ae({ key: 0 }, {
                ...
                default: ye(() => {
                  var w, z;
                  return [
                    [V(Ye).Directory, V(Ye).StorageUnit].includes(u.value.type) ? (F(), Y(y, ae({
                      key: 0,
                    ...
                    ]), 1040, ["modelValue"])) : (F(), Y(_, ae({
                      key: 1,
                      modelValue: u.value,
                      "onUpdate:modelValue": h[2] || (h[2] = (T) => u.value = T)
                    }, {
                      view: V(Zo).Inline,
                      mode: u.value.id ? V(Bl).Update : V(Bl).Create,
                      editing: !1,
...
}), tc = (e, t) => (ee.customValueSlots[e] = t, !0), ic = (e, t) => (ee.customEditSlots[e] = t, !0), lc = {
  install: (e) => {
    e.component("lkt-field") === void 0 && (e.component("lkt-field", Dt), Yo("lkt-file-browser", qu));
  }
}, nc = (e) => {
  ee.defaultEmptyValueSlot = e;
}, oc = (e, t) => {
  ee.optionSlots[e] = t;
}, ac = (e) => ee.undoText = e, sc = (e) => ee.clearText = e, rc = (e) => ee.i18nText = e, uc = (e) => ee.switchEditionOnText = e, cc = (e) => ee.switchEditionOffText = e, dc = (e) => ee.showPasswordOnText = e, fc = (e) => ee.showPasswordOffText = e, hc = (e) => ee.dateReadFormat = e, pc = (e) => ee.defaultDateReadFormat = e, mc = (e, t, l = "default") => {
  l || (l = "default"), ee.validationMessages[l] || (ee.validationMessages[l] = {}), ee.validationMessages[l][e] = t;
}, gc = (e) => (ee.validationIconSlot = e, !0), vc = (e) => (ee.validationIconOk = e, !0), bc = (e) => (ee.validationIconKo = e, !0), yc = (e) => (ee.validationIconInfo = e, !0), Cc = (e = 2, t = ".", l = ".", n = !0, i = "") => i !== "" ? (ee.langNumberFormat[i].amountOfDecimals = e, ee.langNumberFormat[i].decimalSeparator = t, ee.langNumberFormat[i].thousandsSeparator = l, ee.langNumberFormat[i].removeDecimalsIfZero = n, !0) : (ee.amountOfDecimals = e, ee.decimalSeparator = t, ee.thousandsSeparator = l, ee.removeDecimalsIfZero = n, !0), _c = (e) => {
...
export {
  ...
  Tc as Option,
  lc as default,
  sc as setFieldClearText,
  hc as setFieldDateReadFormat,
  pc as setFieldDefaultDateReadFormat,
  nc as setFieldEmptySlot,
  rc as setFieldI18nText,
  Cc as setFieldNumberFormat,
  oc as setFieldOptionSlot,
  fc as setFieldShowPasswordOffText,
  dc as setFieldShowPasswordOnText,
  cc as setFieldSwitchEditionOffText,
  uc as setFieldSwitchEditionOnText,
  ac as setFieldUndoText,
  yc as setFieldValidationIconInfo,
  bc as setFieldValidationIconKo,
  vc as setFieldValidationIconOk,
  gc as setFieldValidationIconSlot,
  mc as setFieldValidationMessage,
  wc as setModalPerItemType,
  _c as setReadTextMaxLength,
  ic as setTextEditSlot,
  tc as setTextValueSlot
};
